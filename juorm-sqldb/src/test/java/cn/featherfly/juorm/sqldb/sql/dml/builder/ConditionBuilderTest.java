...
import cn.featherfly.juorm.sqldb.sql.dml.builder.SqlConditionGroup;
import cn.featherfly.juorm.sqldb.sql.dml.builder.SqlFindBuilder;
import cn.featherfly.juorm.sqldb.sql.dml.builder.SqlQueryBuilder;
...
public class ConditionBuilderTest {
    ...
    void testtestSqlQueryBuilderSelect() {
        //
        cn.featherfly.juorm.sqldb.sql.dml.builder.QueryBuilder builder2 = new SqlQueryBuilder(Dialects.MYSQL);
