...
public class SqlDeleterJoin4Test extends AbstractDeleterTest {
    ...
    public void entityDeleteJoin4_2() {
        ...
        int result = deleter.delete(Order2.class) //
            ...
            .join(User.class).on((e1, e2, e3, e4, j) -> e1.property(Order2::getUser2) //
                .eq(j.property(User::getId))) //
            .where((e1, e2, e3, e4, e5) -> e2.eq(createUser::getUsername) //
        ...
        result = deleter.delete(Order2.class) //
            ...
            .join(User.class).on((e1, e2, e3, e4, j) -> e1.property(Order2::getUser2) //
                .eq(j.property(User::getId))) //
            .where((e1, e2, e3, e4, e5) -> e2.eq(User::getUsername, createUser.getUsername()) //
        ...
        result = deleter.delete(Order2.class) //
            ...
            .join(User.class).on((e1, e2, e3, e4, j) -> e1.property(Order2::getUser2) //
                .eq(j.property(User::getId))) //
            .where((e1, e2, e3, e4, e5) -> e2.property(User::getUsername).eq(createUser.getUsername()) //
