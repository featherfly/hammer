 ...
 * @author zhongj
 */
public class SqlDeleterJoin3Test extends AbstractDeleterTest {

    @Test
    public void entityDeleteJoin3() {
        ...
        result = deleter.delete(Order2.class) //
            ...
            .join(User.class).on((e1, e2, e3, j) -> e1.property(Order2::getUser1) //
                .eq(j.property(User::getId))) //
            .where() //
            .property((e1, e2, e3, e4) -> e2.property(User::getUsername).eq(createUser.getUsername())) //
            .and().property((e1, e2, e3, e4) -> e3.property(User::getUsername).eq(updateUser.getUsername())) //
            .and().property((e1, e2, e3, e4) -> e4.property(User::getUsername).eq(user1.getUsername())) //
            .execute();
        assertEquals(result, 1);
    ...
    @Test
    public void entityDeleteJoin3_2() {
        User createUser = assertUserExist(createUserId);
        User updateUser = assertUserExist(updateUserId);
        User user1 = assertUserExist(userId1);
        ...
        int result = deleter.delete(Order2.class) //
            ...
            .join(User.class).on((e1, e2, e3, j) -> e1.property(Order2::getUser1) //
                .eq(j.property(User::getId))) //
            .where((e1, e2, e3, e4) -> e1.eq(order::getNo) //
        ...
        result = deleter.delete(Order2.class) //
            ...
            .join(User.class).on((e1, e2, e3, j) -> e1.property(Order2::getUser1) //
                .eq(j.property(User::getId))) //
            .where((e1, e2, e3, e4) -> e1.eq(Order2::getNo, order.getNo()) //
        ...
        result = deleter.delete(Order2.class) //
            ...
            .join(User.class).on((e1, e2, e3, j) -> e1.property(Order2::getUser1) //
                .eq(j.property(User::getId))) //
            .where((e1, e2, e3, e4) -> e1.property(Order2::getNo).eq(order.getNo()) //
    ...
    @Test
    public void repositoryDeleteJoin3() {
        User createUser = assertUserExist(createUserId);
        User updateUser = assertUserExist(updateUserId);
        User user1 = assertUserExist(userId1);
        ...
        result = deleter.delete(ORDER_TABLE) //
            ...
            .join(USER_TABLE).on((e1, e2, e3, j) -> e1.field(ORDER_FIELD_USER1) //
                .eq(j.field(USER_FIELD_ID))) //
            .where() //
            .eq((r1, r2, r3, r4) -> r2.accept(createUser::getUsername)) //
            .and().eq((r1, r2, r3, r4) -> r3.accept(updateUser::getUsername)) //
            .and().eq((r1, r2, r3, r4) -> r4.accept(user1::getUsername)) //
            .execute();
        assertEquals(result, 1);
        ...
        result = deleter.delete(ORDER_TABLE) //
            ...
            .join(USER_TABLE).on((e1, e2, e3, j) -> e1.field(ORDER_FIELD_USER1) //
                .eq(j.field(USER_FIELD_ID))) //
            .where() //
            .eq((r1, r2, r3, r4) -> r2.accept(USER_FIELD_USERNAME, createUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r3.accept(USER_FIELD_USERNAME, updateUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r4.accept(USER_FIELD_USERNAME, user1.getUsername())) //
            .execute();
        assertEquals(result, 1);
        ...
        result = deleter.delete(ORDER_TABLE) //
            ...
            .join(USER_TABLE).on((e1, e2, e3, j) -> e1.field(ORDER_FIELD_USER1) //
                .eq(j.field(USER_FIELD_ID))) //
            .where() //
            .eq((r1, r2, r3, r4) -> r2.accept(User::getUsername, createUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r3.accept(User::getUsername, updateUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r4.accept(User::getUsername, user1.getUsername())) //
            .execute();
        assertEquals(result, 1);
        ...
        result = deleter.delete(ORDER_TABLE) //
            ...
            .join(USER_TABLE).on((e1, e2, e3, j) -> e1.field(ORDER_FIELD_USER1) //
                .eq(j.field(USER_FIELD_ID))) //
            .where() //
            .eq((r1, r2, r3, r4) -> r2.field(User::getUsername).value(createUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r3.field(User::getUsername).value(updateUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r4.field(User::getUsername).value(user1.getUsername())) //
            .execute();
        assertEquals(result, 1);
        ...
        result = deleter.delete(ORDER_TABLE) //
            ...
            .join(USER_TABLE).on((e1, e2, e3, j) -> e1.field(ORDER_FIELD_USER1) //
                .eq(j.field(USER_FIELD_ID))) //
            .where() //
            .eq((r1, r2, r3, r4) -> r2.field(USER_FIELD_USERNAME).value(createUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r3.field(USER_FIELD_USERNAME).value(updateUser.getUsername())) //
            .and().eq((r1, r2, r3, r4) -> r4.field(USER_FIELD_USERNAME).value(user1.getUsername())) //
            .execute();
        assertEquals(result, 1);
        ...
        result = deleter.delete(ORDER_TABLE) //
            ...
            .join(USER_TABLE).on((e1, e2, e3, j) -> e1.field(ORDER_FIELD_USER1) //
                .eq(j.field(USER_FIELD_ID))) //
            .where() //
            .field((r1, r2, r3, r4) -> r2.field(USER_FIELD_USERNAME).eq(createUser.getUsername())) //
            .and().field((r1, r2, r3, r4) -> r3.field(USER_FIELD_USERNAME).eq(updateUser.getUsername())) //
            .and().field((r1, r2, r3, r4) -> r4.field(USER_FIELD_USERNAME).eq(user1.getUsername())) //
            .execute();
        assertEquals(result, 1);
        ...
        //                        .eq(j.field(USER_FIELD_ID))) //
        //                    .where() //
        //                    .field((r1, r2, r3, r4) -> r2.field(User::getUsername).eq(createUser.getUsername()))
        //                    .and().field((r1, r2, r3, r4) -> r3.field(User::getUsername).eq(updateUser.getUsername())) //
        //                    .and().field((r1, r2, r3, r4) -> r4.field(User::getUsername).eq(user1.getUsername())) //
        //                    .and().field((r1, r2, r3, r4) -> r5.field(User::getUsername).eq(user2.getUsername())) //
    ...
    @Test
    public void repositoryDeleteJoin3_2() {
        int result = -1;
        ...
        result = deleter.delete(ORDER_TABLE) //
            ...
            .join(USER_TABLE).on((e1, e2, e3, j) -> e1.field(ORDER_FIELD_USER1) //
                .eq(j.field(USER_FIELD_ID))) //
            .where((r1, r2, r3, r4) -> r1.field(ORDER_FIELD_NO).eq(order.getNo()) //
