...
-- ----------------------------
DROP TABLE IF EXISTS "user_info2" CASCADE;
CREATE TABLE "user_info2" (
  ...
  "street" varchar(255) ,
  "street_no" int4 ,
  CONSTRAINT "user_info_pkey2" PRIMARY KEY ("id")
) ;
...
INSERT INTO "user_info" ("id", "user_id", "name", "descp", "province", "city", "district", "street", "street_no") VALUES (7, 7, 'yufei55', 'yufei55描述', '四川', '成都', '武侯', '天府三街', 99);
