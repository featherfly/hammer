...
import cn.featherfly.hammer.expression.repository.condition.ba.RepositoryBetweenExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.co.RepositoryContainsExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.eq.RepositoryEqualsExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.ew.RepositoryEndWithExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.ge.RepositoryGreatEqualsExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.gt.RepositoryGreatThanExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.in.RepositoryInExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.inn.RepositoryIsNotNullExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.isn.RepositoryIsNullExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.le.RepositoryLessEqualsExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.lk.RepositoryLikeExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.lt.RepositoryLessThanExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.nba.RepositoryNotBetweenExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.nco.RepositoryNotContainsExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.ne.RepositoryNotEqualsExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.newv.RepositoryNotEndWithExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.ni.RepositoryNotInExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.nl.RepositoryNotLikeExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.nsw.RepositoryNotStartWithExpressionBase4;
import cn.featherfly.hammer.expression.repository.condition.sw.RepositoryStartWithExpressionBase4;
...
public abstract class AbstractMulitiRepositorySqlConditionsGroupExpressionBase4<C extends GroupExpression<C, L>,
        L extends GroupEndExpression<C, L>, C4 extends ConditionConfig<C4>, S extends RepositorySqlRelation<S, B>,
        B extends SqlBuilder> extends AbstractMulitiRepositorySqlConditionsGroupExpressionBase3<C, L, C4, S, B>
...
/*, RepositoryFieldExpression<C, L>*/ {
    ...
    protected AbstractMulitiRepositorySqlConditionsGroupExpressionBase4(L parent, int index, S repositoryRelation,
        ...
        repositoryAlias4 = repositoryRelation.getRepositoryRelation(1).getRepositoryAlias();
    }
    ...
    public L eq4(String name, char value, CharPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((char) v), repositoryAlias4);
    }
    ...
    public L eq4(String name, int value, IntPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((int) v), repositoryAlias4);
    }
    ...
    public L eq4(String name, long value, LongPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((long) v), repositoryAlias4);
    }
    ...
    public L eq4(String name, double value, DoublePredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((double) v), repositoryAlias4);
    }
     ...
     */
    @Override
    public L eq4(String name, Object value) {
        return eq4(name, value, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L eq4(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public L ne4(String name, Object value) {
        return ne(name, value, getIgnoreStrategy(), repositoryAlias4);
    }
     ...
     */
    @Override
    public <R> L ne4(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L in4(String name, @SuppressWarnings("unchecked") R... values) {
        return in(name, values, getIgnoreStrategy(), repositoryAlias4);
    }
     ...
     */
    @Override
    public <R> L in4(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L ni4(String name, @SuppressWarnings("unchecked") R... values) {
        return ni(name, values, getIgnoreStrategy(), repositoryAlias4);
    }
     ...
     */
    @Override
    public <R> L ni4(String name, R value, Predicate<R> ignoreStrategy) {
