...
public class EntitySqlQueryRelation<E, R1> extends AbstractEntitySqlQueryRelation<E, E, R1>
     ...
     */
    public EntitySqlQueryRelation(EntitySqlQueryEntityProperties<E> sqlQueryEntityProperties, AliasManager aliasManager,
    ...
    public EntitySqlQueryRelation(EntitySqlQueryEntityProperties<E> sqlQueryEntityProperties, AliasManager aliasManager,
        ...
        super(sqlQueryEntityProperties, aliasManager, factory, sqlPageFactory, conditionTypeClassMapping,
                conditionTableAlias, conditionTableColumn, conditionTypeClassMapping, joinTableColumn, ignorePolicy);
    }
     ...
     */
    @Override
    public EntitySqlQueryRelation<E, R1> fetch() {
