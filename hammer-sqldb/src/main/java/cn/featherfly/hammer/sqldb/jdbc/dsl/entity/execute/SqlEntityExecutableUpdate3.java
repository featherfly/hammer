 ...
 * @param <J3> the join type 3
 */
public class SqlEntityExecutableUpdate3<E, J1, J2>
    implements SqlEntityUpdate3<E, J1, J2>, EntityExecutableUpdate3<E, J1, J2> {
     ...
     */
    public SqlEntityExecutableUpdate3(SqlEntityExecutableUpdate<E> update) {
        this.update = update;
    }
     ...
     */
    @Override
    public <R> EntityUpdateValueExpression<R, EntityExecutableUpdate3<E, J1, J2>,
    ...
    @Override
    public <R,
        O> EntityUpdateValueExpression<O, EntityExecutableUpdate3<E, J1, J2>,
            EntityExecutableConditionGroup3<E, J1, J2, UpdateConditionConfig>,
            EntityExecutableConditionGroupLogic3<E, J1, J2, UpdateConditionConfig>> property(
     ...
     */
    @Override
    public <R extends Number> EntityUpdateNumberValueExpression<R, EntityExecutableUpdate3<E, J1, J2>,
        EntityExecutableConditionGroup3<E, J1, J2, UpdateConditionConfig>,
        EntityExecutableConditionGroupLogic3<E, J1, J2, UpdateConditionConfig>> property(
    ...
    public EntityExecutableConditionGroupLogic3<E, J1, J2, UpdateConditionConfig> where(
        ...
        SqlEntityUpdateExpression3<E, J1, J2> expr = createSqlUpdateExpression();
    ...
    public <J> EntityOnExpression3<E, J1, J2, J, EntityUpdate4<E, J1, J2, J>> join(Class<J> joinType) {
        return new EntitySqlOn3<>(joinType, new SqlEntityExecutableUpdate4<>(update), update.factory, update.relation);
    }
    ...
    private SqlEntityUpdateExpression3<E, J1, J2> createSqlUpdateExpression() {
        return new SqlEntityUpdateExpression3<>(update.factory, update.relation);
    }
