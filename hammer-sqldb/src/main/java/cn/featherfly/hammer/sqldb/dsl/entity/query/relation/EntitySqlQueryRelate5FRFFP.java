...
public class EntitySqlQueryRelate5FRFFP<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5FRFFP(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FRFFP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FRFFP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
