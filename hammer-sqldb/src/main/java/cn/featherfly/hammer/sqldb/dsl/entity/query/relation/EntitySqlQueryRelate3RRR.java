...
public class EntitySqlQueryRelate3RRR<E, R1, R2, R3> extends AbstractEntitySqlQueryRelate3RRX<E, R1, R2, R3>
     ...
     */
    public EntitySqlQueryRelate3RRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched3RRF<E, R1, R2, R3> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched3RRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
}
