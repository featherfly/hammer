...
public class StartWithEntityPropertyExpressionImpl<V, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    public <R> StartWithEntityPropertyExpression<R> property(SerializableFunction<V, R> name) {
        ...
        return new StartWithEntityPropertyExpressionImpl<>(index, propertyList, expression, factory);
    }
    ...
    public <R extends Collection<RE>,
            RE> StartWithEntityPropertyExpression<RE> property(SerializableToCollectionFunction<V, R, RE> name) {
    ...
    public void value(String value, MatchStrategy matchStrategy) {
        expression.sw0(index, getPropertyMapping(value), value, matchStrategy, expression.getIgnoreStrategy());
    }
    ...
    public void value(String value, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        expression.sw0(index, getPropertyMapping(value), value, matchStrategy, ignoreStrategy);
    }
