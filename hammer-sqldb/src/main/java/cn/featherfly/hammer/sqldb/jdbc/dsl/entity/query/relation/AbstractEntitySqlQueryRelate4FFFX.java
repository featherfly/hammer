...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5FFFRP;
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5FFFRR;
...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelatedFetchedExpression5FFFRP;
...
public abstract class AbstractEntitySqlQueryRelate4FFFX<E, R1, R2, R3, R4>
    ...
    public <QR extends EntityQueryRelateExpression5FFFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>(
                (QR) new EntitySqlQueryRelate5FFFRR<>(factory, sqlPageFactory, queryRelation), factory, queryRelation,
                joinType, 0);
    }

    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5FFFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R1, R2, R3>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R1, R2, R3>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R2, R3>>,
        ...
        return (RE) new EntitySqlQueryRelate5FFFRR<>(factory, sqlPageFactory, queryRelation);
    }

    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5FFFRP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R1, R2, R3>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R1, R2, R3>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R2, R3>>,
        ...
        return (RE) new EntitySqlQueryRelate5FFFRP<>(factory, sqlPageFactory, queryRelation);
    }

    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5FFFRP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5FFFRP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5FFFRP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5FFFRP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5FFFRP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
