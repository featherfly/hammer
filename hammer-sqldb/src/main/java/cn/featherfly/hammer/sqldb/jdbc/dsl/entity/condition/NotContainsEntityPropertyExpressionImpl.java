...
public class NotContainsEntityPropertyExpressionImpl<V, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    public <R> NotContainsEntityPropertyExpression<R> property(SerializableFunction<V, R> name) {
        ...
        return new NotContainsEntityPropertyExpressionImpl<>(index, propertyList, expression, factory);
    }
    ...
    public <R extends Collection<RE>,
            RE> NotContainsEntityPropertyExpression<RE> property(SerializableToCollectionFunction<V, R, RE> name) {
    ...
    public void value(String value, MatchStrategy matchStrategy) {
        expression.nco0(index, getPropertyMapping(value), value, matchStrategy, expression.getIgnoreStrategy());
    }
    ...
    public void value(String value, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        expression.nco0(index, getPropertyMapping(value), value, matchStrategy, ignoreStrategy);
    }
