...
public class LessThanEntityPropertyExpressionImpl<V, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @param queryRelation the query relation
     */
    public LessThanEntityPropertyExpressionImpl(AtomicInteger index, List<Serializable> propertyList,
        InternalMulitiEntityCondition<L> expression, JdbcMappingFactory factory,
        EntitySqlRelation<?, ?> queryRelation) {
    ...
    public <R> CompareEntityPropertyExpression<R> property(SerializableFunction<V, R> name) {
        ...
        return new LessThanEntityPropertyExpressionImpl<>(index, propertyList, expression, factory, queryRelation);
    }
    ...
    public SetIntExpression property(SerializableToIntFunction<V> name) {
        ...
        return new SetIntExpressionImpl(v -> getPropertyMapping(v), expression.getIgnoreStrategy(),
            (value, ignore, pm) -> expression.lt(index, pm, arithmeticColumnElement.get(), value, ignore));
    }
    ...
    public SetStringExpression property(SerializableToStringFunction<V> name) {
        ...
        return new SetStringExpressionImpl(v -> getPropertyMapping(v), expression.getIgnoreStrategy(), (value, match,
            ignore, pm) -> expression.lt(index, pm, arithmeticColumnElement.get(), value, match, ignore));
    }
