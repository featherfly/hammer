 ...
 */
public abstract class AbstractSqlConditionExpression2<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractConditionExpression implements ParamedExpression {
    // TODO 后续来处理和AbstractSqlConditionExpression的关系
    /** The parent. */
    protected L parent;
     ...
     */
    protected AbstractSqlConditionExpression2(ConditionConfig<?> conditionConfig, Dialect dialect) {
