...
/**
 * The Class EntitySqlQueryRelatedFetched5RRFRF.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public class EntitySqlQueryRelatedFetched5RRFRF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple3<E, R3, R5>>
        implements EntityQueryRelatedFetched5RRFRF<E, R1, R2, R3, R4, R5> {

    /**
     * Instantiates a new entity sql query related fetched 5 RRFRF.
     *
     * @param factory                the factory
     * @param sqlPageFactory         the sql page factory
     * @param entitySqlQueryRelation the entity sql query relation
     */
    public EntitySqlQueryRelatedFetched5RRFRF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
