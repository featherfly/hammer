...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate5RRRR;
 ...
 */
public class EntitySqlQueryRelate5RRRR<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, E>
        implements EntityQueryRelate5RRRR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5RRRR(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
