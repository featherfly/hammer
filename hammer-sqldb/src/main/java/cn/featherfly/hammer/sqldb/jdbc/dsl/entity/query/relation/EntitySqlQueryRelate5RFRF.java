...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate5RFRF;
...
/**
 * The Class EntitySqlQueryRelate5RFRF.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelate5RFRF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple3<E, R2, R4>>
        implements EntityQueryRelate5RFRF<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5RFRF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
