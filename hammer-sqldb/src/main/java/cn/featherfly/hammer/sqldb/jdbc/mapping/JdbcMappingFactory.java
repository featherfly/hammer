...
import cn.featherfly.hammer.mapping.ClassNameJpaConversion;
import cn.featherfly.hammer.mapping.ClassNameUnderlineConversion;
...
import cn.featherfly.hammer.mapping.PropertyNameJpaConversion;
import cn.featherfly.hammer.mapping.PropertyNameUnderlineConversion;
...
public class JdbcMappingFactory implements MappingFactory {
    ...
    private <T> ClassMapping<T> createClassMapping(Class<T> type) {
        ...
        if (tm == null) {
            throw new SqldbHammerException("#talbe.not.exists",
        ...
        if (!findPk) {
            throw new SqldbHammerException("#id.map.not.exists",
    ...
    private void mappingFk(PropertyMapping mapping,
        ...
        if (LangUtils.isEmpty(bps)) {
            throw new SqldbHammerException(beanProperty.getType().getName()
