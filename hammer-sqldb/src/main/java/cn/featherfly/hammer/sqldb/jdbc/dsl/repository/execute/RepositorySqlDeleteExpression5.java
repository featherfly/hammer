 ...
 * @author zhongj
 */
public class RepositorySqlDeleteExpression5 extends AbstractMulitiRepositorySqlExecutableConditionsGroup5<
     ...
     */
    public RepositorySqlDeleteExpression5(RepositorySqlDeleteRelation deleteRelation) {
     ...
     */
    RepositorySqlDeleteExpression5(RepositoryExecutableConditionsGroupLogic5<DeleteConditionConfig> parent,
    ...
    protected RepositoryExecutableConditionsGroup5<DeleteConditionConfig> createGroup(
        ...
        return new RepositorySqlDeleteExpression5(parent, repositoryRelation);
    }
}
