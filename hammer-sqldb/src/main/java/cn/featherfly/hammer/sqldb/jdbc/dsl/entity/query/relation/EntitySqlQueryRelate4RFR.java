...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate4RFR;
...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5RFRR;
 ...
 */
public class EntitySqlQueryRelate4RFR<E, R1, R2, R3, R4>
        extends AbstractEntitySqlQueryFetch5<E, R1, R2, R3, R4, Tuple2<E, R2>>
        implements EntityQueryRelate4RFR<E, R1, R2, R3, R4> {

    /**
     * Instantiates a new entity sql query relate 4 RFR.
     *
     * @param factory                the factory
     * @param sqlPageFactory         the sql page factory
     * @param entitySqlQueryRelation the entity sql query relation
     */
    public EntitySqlQueryRelate4RFR(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    @Override
    public <QR extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate5RFRR<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R2>>,
    ...
    public <RE extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, QRC, QRL, QRS,
                    Tuple3<E, R2, R5>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R2, R5>>,
            R5> RE join(SerializableFunction2<R5, Tuple2<E, R2>> propertyName) {
        // IMPLSOON 后续来实现实体关系（ManyToOne、OneToOne、OneToMany）关联
        return null;
    }
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RFRR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
