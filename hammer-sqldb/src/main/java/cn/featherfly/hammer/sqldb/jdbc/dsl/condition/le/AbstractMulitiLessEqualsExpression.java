...
package cn.featherfly.hammer.sqldb.jdbc.dsl.condition.le;
...
public abstract class AbstractMulitiLessEqualsExpression<I extends InternalMulitiCondition<L>,
    ...
    public L le(int index, SerializableIntSupplier property) {
        return hold.le(new AtomicInteger(index), property, getIgnoreStrategy());
    }
    ...
    public L le(int index, SerializableIntSupplier property, IntPredicate ignoreStrategy) {
        return hold.le(new AtomicInteger(index), property, ignoreStrategy);
    }
    ...
    public L le(int index, SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return hold.le(new AtomicInteger(index), property, matchStrategy, getIgnoreStrategy());
    }
    ...
    public L le(int index, SerializableStringSupplier property, MatchStrategy matchStrategy,
            Predicate<String> ignoreStrategy) {
        return hold.le(new AtomicInteger(index), property, matchStrategy, ignoreStrategy);
    }
    ...
    public L le(int index, String name, int value) {
        return le(index, name, value, (IntPredicate) getIgnoreStrategy()::test);
    }
    ...
    public L le(int index, String name, long value) {
        return le(index, name, value, (LongPredicate) getIgnoreStrategy()::test);
    }
    ...
    public L le(int index, String name, double value) {
        return le(index, name, value, (DoublePredicate) getIgnoreStrategy()::test);
    }
