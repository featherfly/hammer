 ...
 */
public class EntitySqlQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>
    extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R2>>
    implements EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5FFRRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FFRRF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FFRRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
}
