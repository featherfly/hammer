 ...
 */
public class EntitySqlQueryRelate5RRFRR<E, R1, R2, R3, R4, R5>
    extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple2<E, R3>>
    implements EntityQueryRelate5RRFRR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5RRFRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5RRFRF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RRFRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
