...
/**
 * The Class NotEndWithEntityPropertyExpressionImpl.
 *
 * @author zhongj
 ...
 */
public class NotEndWithEntityPropertyExpressionImpl<V, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractMulitiEntityPropertyExpression<V, C, L>
        implements NotEndWithEntityPropertyExpression<V>, NotEndWithEntityPropertySetValueExpression {

    /**
     * Instantiates a new not end with entity property expression impl.
     *
     ...
     */
    @Override
    public <R> NotEndWithEntityPropertyExpression<R> property(SerializableFunction<V, R> name) {
        propertyList.add(name);
        return new NotEndWithEntityPropertyExpressionImpl<>(index, propertyList, expression, factory, queryRelation);
    }
     ...
     */
    @Override
    public NotEndWithEntityPropertySetValueExpression property(SerializableToStringFunction<V> name) {
        propertyList.add(name);
        return new NotEndWithEntityPropertyExpressionImpl<>(index, propertyList, expression, factory, queryRelation);
    }
     ...
     *
     * @param name the name
     * @return the not end with entity property set value expression
     */
    private NotEndWithEntityPropertySetValueExpression property(SerializableSupplier<String> name) {
        propertyList.add(name);
        return new NotEndWithEntityPropertyExpressionImpl<>(index, propertyList, expression, factory, queryRelation);
    }
    ...
    public <R extends Collection<RE>,
            RE> NotEndWithEntityPropertyExpression<RE> property(SerializableToCollectionFunction<V, R, RE> name) {
    ...
    public void value(String value, MatchStrategy matchStrategy) {
        expression.newv(index, getPropertyMapping(value), value, matchStrategy, expression.getIgnoreStrategy());
    }
    ...
    public void value(String value, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        expression.newv(index, getPropertyMapping(value), value, matchStrategy, ignoreStrategy);
    }
