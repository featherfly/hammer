 ...
 */
public class EntitySqlQueryRelatedFetched4RFFP<E, R1, R2, R3, R4> extends
    AbstractEntitySqlQueryRelate4RFFX<E, R1, R2, R3, R4> implements EntityQueryRelatedFetched4RFFP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4RFFP(HammerConfig hammerConfig, JdbcMappingFactory factory,
