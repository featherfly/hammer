...
public abstract class AbstractEntitySqlQueryRelate3RFX<E, R1, R2, R3> extends
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<E, R4, EntityQueryRelate4RFRR<E, R1, R2, R3, R4>,
            EntityQueryRelatedFetched4RFRF<E, R1, R2, R3, R4>> join(Class<R4> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate4RFRR<>(factory, sqlPageFactory, queryRelation),
    ...
    public <R4> EntityQueryRelate4RFRR<E, R1, R2, R3, R4> join(SerializableFunction2<R4, E> propertyName) {
        ...
        return new EntitySqlQueryRelate4RFRR<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R4> EntityQueryRelate4RFRP<E, R1, R2, R3, R4> join(SerializableFunction1<E, R4> propertyName) {
        ...
        return new EntitySqlQueryRelate4RFRP<>(factory, sqlPageFactory, queryRelation);
    }
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<R1, R4, EntityQueryRelate4RFRR<E, R1, R2, R3, R4>,
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<R2, R4, EntityQueryRelate4RFRR<E, R1, R2, R3, R4>,
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<R3, R4, EntityQueryRelate4RFRR<E, R1, R2, R3, R4>,
