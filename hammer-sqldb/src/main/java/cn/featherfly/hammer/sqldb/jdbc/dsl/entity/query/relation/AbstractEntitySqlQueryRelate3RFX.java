...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression4RFRR;
...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelatedFetchedExpression4RFRP;
 ...
 */
public abstract class AbstractEntitySqlQueryRelate3RFX<E, R1, R2, R3, RES>
     ...
     */
    protected AbstractEntitySqlQueryRelate3RFX(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    public <QR extends EntityQueryRelateExpression4RFRR<E, R1, R2, R3, R4, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate4RFRR<>(factory, sqlPageFactory, queryRelation),
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression4RFRR<E, R1, R2, R3, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R2>>,
            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R2>>,
        ...
        return (RE) new EntitySqlQueryRelate4RFRR<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression4RFRP<E, R1, R2, R3, R4, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R2>>,
            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R2>>,
        ...
        return (RE) new EntitySqlQueryRelate4RFRP<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression4RFRP<E, R1, R2, R3, E, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression4RFRP<E, R1, R2, R3, R1, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression4RFRP<E, R1, R2, R3, R2, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression4RFRP<E, R1, R2, R3, R3, RC, RL, RS, QR>,
