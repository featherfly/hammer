...
/**
 * The Class EntitySqlQueryRelatedFetched5FRRRF.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public class EntitySqlQueryRelatedFetched5FRRRF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R5>>
        implements EntityQueryRelatedFetched5FRRRF<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelatedFetched5FRRRF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
