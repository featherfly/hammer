...
public class NotEqualsEntityPropertyExpressionImpl<V, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    public <R> NotEqualsEntityPropertyExpression<R> property(SerializableFunction<V, R> name) {
        ...
        return new NotEqualsEntityPropertyExpressionImpl<>(index, propertyList, expression, factory, queryRelation);
    }
    ...
    public ConditionEntityExpressionIntPropertyExpression property(SerializableToIntFunction<V> name) {
        ...
        return new ConditionEntityExpressionIntPropertyExpressionImpl(v -> getPropertyMapping(v),
                expression.getIgnoreStrategy(), (value, ignore, pm) -> expression.ne0(index, pm, value, ignore));
    }
    ...
    public ConditionEntityExpressionStringPropertyExpression property(SerializableToStringFunction<V> name) {
        ...
        return new ConditionEntityExpressionStringPropertyExpressionImpl(v -> getPropertyMapping(v),
                ...
                (value, match, ignore, pm) -> expression.ne0(index, pm, value, match, ignore));
    }
