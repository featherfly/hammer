 ...
 */
public class EntitySqlQueryRelate5RRRRP<E, R1, R2, R3, R4, R5> extends
    AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, E> implements EntityQueryRelate5RRRRP<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5RRRRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5RRRRP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RRRRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
