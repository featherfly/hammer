 ...
 */
public class EntitySqlQueryRelatedFetched4RRFP<E, R1, R2, R3, R4> extends
    AbstractEntitySqlQueryRelate4RRFX<E, R1, R2, R3, R4> implements EntityQueryRelatedFetched4RRFP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4RRFP(HammerConfig hammerConfig, JdbcMappingFactory factory,
