...
public abstract class AbstractMulitiRepositorySqlConditionsExpressionBase<C extends ConditionExpression,
        ...
        B extends SqlBuilder> extends AbstractMulitiRepositorySqlConditionExpression<C, L, C2, S, B>
    ...
    public L eq(String name, char value, CharPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((char) v), repositoryAlias);
    }
    ...
    public L eq(String name, int value, IntPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((int) v), repositoryAlias);
    }
    ...
    public L eq(String name, long value, LongPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((long) v), repositoryAlias);
    }
    ...
    public L eq(String name, double value, DoublePredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((double) v), repositoryAlias);
    }
    ...
    public L eq(String name, Object value) {
        return eq(name, value, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L eq(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L ne(String name, R value, Predicate<R> ignoreStrategy) {
    ...
    public L in(String name, int[] values, Predicate<int[]> ignoreStrategy) {
        return in(name, (Object) values,
                (Predicate<Object>) v -> ignoreStrategy.test(ArrayUtils.unpack((Integer[]) v)));
    }
    ...
    public L in(String name, long[] values, Predicate<long[]> ignoreStrategy) {
        return in(name, (Object) values, (Predicate<Object>) v -> ignoreStrategy.test(ArrayUtils.unpack((Long[]) v)));
    }
    ...
    public L in(String name, double[] values, Predicate<double[]> ignoreStrategy) {
        return in(name, (Object) values, (Predicate<Object>) v -> ignoreStrategy.test(ArrayUtils.unpack((Double[]) v)));
    }
    ...
    public L ni(String name, long[] values, Predicate<long[]> ignoreStrategy) {
        return ni(name, (Object) values, (Predicate<Object>) v -> ignoreStrategy.test(ArrayUtils.unpack((Long[]) v)));
    }
    ...
    public L ni(String name, double[] values, Predicate<double[]> ignoreStrategy) {
        return ni(name, (Object) values, (Predicate<Object>) v -> ignoreStrategy.test(ArrayUtils.unpack((Double[]) v)));
    }
    ...
    public ObjectFieldExpression<C, L> field(String name) {
        return new ObjectFieldExpressionMulitiRepositoryImpl<>(index, name, this);
    }
