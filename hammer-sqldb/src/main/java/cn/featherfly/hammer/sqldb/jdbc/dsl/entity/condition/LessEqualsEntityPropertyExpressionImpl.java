...
public class LessEqualsEntityPropertyExpressionImpl<V, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    public <R> CompareEntityPropertyExpression<R> property(SerializableFunction<V, R> name) {
        ...
        return new LessEqualsEntityPropertyExpressionImpl<>(index, propertyList, expression, factory);
    }
    ...
    public ConditionEntityExpressionIntPropertyExpression property(SerializableToIntFunction<V> name) {
        ...
        return new ConditionEntityExpressionIntPropertyExpressionImpl(v -> getPropertyMapping(v),
                expression.getIgnoreStrategy(), (value, ignore, pm) -> expression.le0(index, pm, value, ignore));
    }
