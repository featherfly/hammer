...
public abstract class AbstractEntitySqlQueryRelate3RRX<E, R1, R2, R3>
     ...
     */
    protected AbstractEntitySqlQueryRelate3RRX(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public <J> EntityOnExpression4<E, R1, R2, R3, J, EntityQueryRelate4RRRR<E, R1, R2, R3, J>> join(Class<J> joinType) {
        return new EntitySqlOn4<>(joinType,
            new EntitySqlQueryRelate4RRRR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
