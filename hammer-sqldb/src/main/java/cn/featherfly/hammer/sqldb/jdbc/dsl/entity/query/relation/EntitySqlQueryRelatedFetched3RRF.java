...
public class EntitySqlQueryRelatedFetched3RRF<E, R1, R2, R3>
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<E, R4, EntityQueryRelate4RRFR<E, R1, R2, R3, R4>,
            EntityQueryRelatedFetched4RRFF<E, R1, R2, R3, R4>> join(Class<R4> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate4RRFR<>(factory, sqlPageFactory, queryRelation),
    ...
    public <R4> EntityQueryRelate4RRFP<E, R1, R2, R3, R4> join(SerializableFunction1<E, R4> propertyName) {
        ...
        return new EntitySqlQueryRelate4RRFP<>(factory, sqlPageFactory, queryRelation);
    }
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<R1, R4, EntityQueryRelate4RRFR<E, R1, R2, R3, R4>,
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<R2, R4, EntityQueryRelate4RRFR<E, R1, R2, R3, R4>,
     ...
     */
    @Override
    public <R4> EntityQueryRelatedExpression<R3, R4, EntityQueryRelate4RRFR<E, R1, R2, R3, R4>,
