...
public abstract class AbstractEntitySqlQueryRelate4RRRX<E, R1, R2, R3, R4> extends
     ...
     */
    protected AbstractEntitySqlQueryRelate4RRRX(HammerConfig hammerConfig, JdbcMappingFactory factory,
     ...
     */
    @Override
    public <J> EntityOnExpression5<E, R1, R2, R3, R4, J, EntityQueryRelate5RRRRR<E, R1, R2, R3, R4, J>> join(
        Class<J> joinType) {
        return new EntitySqlOn5<>(joinType,
            new EntitySqlQueryRelate5RRRRR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5RRRRR<E, R1, R2, R3, R4, R5> join(SerializableFunction2<R5, E> propertyName) {
        ...
        return new EntitySqlQueryRelate5RRRRR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5RRRRP<E, R1, R2, R3, R4, R5> join(SerializableFunction1<E, R5> propertyName) {
        ...
        return new EntitySqlQueryRelate5RRRRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
