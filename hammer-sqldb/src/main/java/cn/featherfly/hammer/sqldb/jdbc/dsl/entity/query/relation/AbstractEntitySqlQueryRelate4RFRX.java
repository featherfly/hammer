...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5RFRRP;
 ...
 */
public abstract class AbstractEntitySqlQueryRelate4RFRX<E, R1, R2, R3, R4, RES>
    ...
    public <QR extends EntityQueryRelateExpression5RFRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>(
                (QR) new EntitySqlQueryRelate5RFRRR<>(factory, sqlPageFactory, queryRelation), factory, queryRelation,
                joinType, 0);
    }

    @SuppressWarnings("unchecked")

    public <RE extends EntityQueryRelateExpression5RFRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R2>>,
        ...
        return (RE) new EntitySqlQueryRelate5RFRRR<>(factory, sqlPageFactory, queryRelation);
    }

    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R2>>,
            QR extends EntityQueryRelatedFetchedExpression5RFRRP<E, R1, R2, R3, R4, R5, RC, RL, RS>,
        ...
        return (RE) new EntitySqlQueryRelate5RFRRP<>(factory, sqlPageFactory, queryRelation);
    }

    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFRRP<E, R1, R2, R3, R4, E, RC, RL, RS>> RE join(
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFRRP<E, R1, R2, R3, R4, R1, RC, RL, RS>> RE join2(
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFRRP<E, R1, R2, R3, R4, R2, RC, RL, RS>> RE join3(
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFRRP<E, R1, R2, R3, R4, R3, RC, RL, RS>> RE join4(
    ...
    @SuppressWarnings("unchecked")
    public <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFRRP<E, R1, R2, R3, R4, R4, RC, RL, RS>> RE join5(
