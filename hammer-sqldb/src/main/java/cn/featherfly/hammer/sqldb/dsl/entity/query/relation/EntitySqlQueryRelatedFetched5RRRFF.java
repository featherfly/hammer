...
/**
 * The Class EntitySqlQueryRelatedFetched5RRRFF.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public class EntitySqlQueryRelatedFetched5RRRFF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple3<E, R4, R5>>
        implements EntityQueryRelatedFetched5RRRFF<E, R1, R2, R3, R4, R5> {

    /**
     * Instantiates a new entity sql query related fetched 5 RRRFF.
     *
     * @param factory                the factory
     * @param sqlPageFactory         the sql page factory
     * @param entitySqlQueryRelation the entity sql query relation
     */
    public EntitySqlQueryRelatedFetched5RRRFF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
