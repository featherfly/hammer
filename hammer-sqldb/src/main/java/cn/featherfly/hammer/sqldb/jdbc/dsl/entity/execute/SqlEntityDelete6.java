 ...
 */
public class SqlEntityDelete6<E1, E2, E3, E4, E5, E6> implements EntityDelete6<E1, E2, E3, E4, E5, E6> {
     ...
     */
    public SqlEntityDelete6(JdbcMappingFactory factory, EntitySqlDeleteRelation relation) {
    ...
    public EntityExecutableConditionGroupLogic6<E1, E2, E3, E4, E5, E6, DeleteConditionConfig> where(
        ...
        SqlEntityDeleteExpression6<E1, E2, E3, E4, E5, E6> sqlDeleteExpression = createSqlDeleteExpression();
        if (function != null) {
            sqlDeleteExpression
    ...
    private SqlEntityDeleteExpression6<E1, E2, E3, E4, E5, E6> createSqlDeleteExpression() {
        return new SqlEntityDeleteExpression6<>(factory, relation);
    }
}
