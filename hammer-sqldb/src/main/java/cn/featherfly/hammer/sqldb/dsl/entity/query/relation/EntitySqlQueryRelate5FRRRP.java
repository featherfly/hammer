...
public class EntitySqlQueryRelate5FRRRP<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5FRRRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FRRRP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FRRRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
