...
/**
 * The Class RepositorySqlQueryRelate4FFF.
 *
 * @author zhongj
 */
public class RepositorySqlQueryRelate4FFF extends AbstractRepositorySqlQuery5FFFF<RepositoryQueryRelatedFetched4FFFF>
    implements RepositoryQueryRelate4FFF {
     ...
     */
    public RepositorySqlQueryRelate4FFF(RepositorySqlQueryRelation queryRelation, SqlPageFactory sqlPageFactory) {
     ...
     */
    protected RepositorySqlQueryRelate4FFF(AbstractRepositorySqlQuery5<?, ?, ?, ?, ?, ?> abstractRepositorySqlQuery) {
