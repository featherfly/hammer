 ...
 */
public class DateFieldExpressionMulitiRepositoryImpl<D extends Date, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractMulitiRepositoryFieldExpression<C, L> implements DateFieldExpression<D, C, L> {
     ...
     * @param expression the expression
     */
    public DateFieldExpressionMulitiRepositoryImpl(AtomicInteger index, String name, InternalMulitiEntityCondition<L> expression) {
