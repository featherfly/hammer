...
/**
 * The Class EntitySqlQueryRelatedFetched5FFRFP.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public class EntitySqlQueryRelatedFetched5FFRFP<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R2, R4>>
        implements EntityQueryRelatedFetched5FFRFP<E, R1, R2, R3, R4, R5> {

    /**
     * Instantiates a new entity sql query related fetched 5 FFRFP.
     *
     * @param factory                the factory
     * @param sqlPageFactory         the sql page factory
     * @param entitySqlQueryRelation the entity sql query relation
     */
    public EntitySqlQueryRelatedFetched5FFRFP(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
