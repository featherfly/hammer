 ...
 */
public class EntitySqlQueryRelate3FRP<E, R1, R2, R3> extends
        AbstractEntitySqlQueryRelate3FRX<E, R1, R2, R3, Tuple2<E, R1>> implements EntityQueryRelate3FRP<E, R1, R2, R3> {
