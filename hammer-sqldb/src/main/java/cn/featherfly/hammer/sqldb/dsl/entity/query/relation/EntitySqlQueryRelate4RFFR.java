...
public class EntitySqlQueryRelate4RFFR<E, R1, R2, R3, R4> extends AbstractEntitySqlQueryRelate4RFFX<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelate4RFFR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched4RFFF<E, R1, R2, R3, R4> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched4RFFF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
