 ...
 */
public class EntitySqlQueryRelatedFetched4RRRP<E, R1, R2, R3, R4> extends
    AbstractEntitySqlQueryRelate4RRRX<E, R1, R2, R3, R4> implements EntityQueryRelatedFetched4RRRP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4RRRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
