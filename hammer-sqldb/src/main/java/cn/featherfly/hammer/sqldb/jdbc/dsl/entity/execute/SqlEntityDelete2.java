 ...
 */
public class SqlEntityDelete2<E1, E2> implements EntityDelete2<E1, E2> {
     ...
     */
    public SqlEntityDelete2(JdbcMappingFactory factory, EntitySqlDeleteRelation relation) {
    ...
    public <J> EntityOnExpression2<E1, E2, J, EntityDelete3<E1, E2, J>> join(Class<J> joinType) {
        return new EntitySqlOn2<>(joinType, new SqlEntityDelete3<>(factory, relation), factory, relation);
    }
    ...
    public EntityExecutableConditionGroupLogic2<E1, E2, DeleteConditionConfig> where(
        ...
        SqlEntityDeleteExpression2<E1, E2> sqlDeleteExpression = createSqlDeleteExpression();
        if (function != null) {
            sqlDeleteExpression
    ...
    private SqlEntityDeleteExpression2<E1, E2> createSqlDeleteExpression() {
        return new SqlEntityDeleteExpression2<>(factory, relation);
    }
}
