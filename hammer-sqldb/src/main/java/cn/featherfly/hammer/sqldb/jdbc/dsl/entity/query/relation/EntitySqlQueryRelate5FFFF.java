...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate5FFFF;
...
/**
 * The Class EntitySqlQueryRelate5FFFF.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelate5FFFF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple5<E, R1, R2, R3, R4>>
        implements EntityQueryRelate5FFFF<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5FFFF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
