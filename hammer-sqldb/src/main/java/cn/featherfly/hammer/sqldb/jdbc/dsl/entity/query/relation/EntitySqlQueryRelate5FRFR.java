...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate5FRFR;
 ...
 */
public class EntitySqlQueryRelate5FRFR<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R3>>
        implements EntityQueryRelate5FRFR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5FRFR(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    public EntityQueryRelatedFetched5FRFRF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FRFRF<>(factory, sqlPageFactory, queryRelation);
    }
