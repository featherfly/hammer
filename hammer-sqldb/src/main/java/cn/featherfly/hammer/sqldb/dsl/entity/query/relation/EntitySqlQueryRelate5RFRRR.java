 ...
 */
public class EntitySqlQueryRelate5RFRRR<E, R1, R2, R3, R4, R5>
    extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple2<E, R2>>
    implements EntityQueryRelate5RFRRR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5RFRRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5RFRRF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RFRRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
