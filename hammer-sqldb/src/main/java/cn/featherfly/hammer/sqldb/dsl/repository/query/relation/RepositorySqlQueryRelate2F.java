...
/**
 * The Class RepositorySqlQueryRelate2F.
 *
 * @author zhongj
 */
public class RepositorySqlQueryRelate2F extends AbstractRepositorySqlQuery3FF<RepositoryQueryRelatedFetched2FF>
    implements RepositoryQueryRelate2F {
     ...
     */
    public RepositorySqlQueryRelate2F(AbstractRepositorySqlQuery3FF<?> abstractRepositorySqlQuery) {
     ...
     */
    public RepositorySqlQueryRelate2F(RepositorySqlQueryRelation queryRelation, SqlPageFactory sqlPageFactory) {
