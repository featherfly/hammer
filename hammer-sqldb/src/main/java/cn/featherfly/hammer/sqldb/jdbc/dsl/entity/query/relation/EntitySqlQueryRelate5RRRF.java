...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate5RRRF;
...
/**
 * The Class EntitySqlQueryRelate5RRRF.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelate5RRRF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple2<E, R4>>
        implements EntityQueryRelate5RRRF<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5RRRF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
