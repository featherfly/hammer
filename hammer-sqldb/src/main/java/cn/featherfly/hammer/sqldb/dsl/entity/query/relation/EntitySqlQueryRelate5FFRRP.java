...
public class EntitySqlQueryRelate5FFRRP<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5FFRRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FFRRP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FFRRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
