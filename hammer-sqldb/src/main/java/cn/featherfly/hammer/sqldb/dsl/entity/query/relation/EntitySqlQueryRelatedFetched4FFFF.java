...
public class EntitySqlQueryRelatedFetched4FFFF<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelatedFetched4FFFF(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public <J> EntityOnExpression5<E, R1, R2, R3, R4, J, EntityQueryRelate5FFFFR<E, R1, R2, R3, R4, J>> join(
        ...
        return new EntitySqlOn5<>(joinType,
            new EntitySqlQueryRelate5FFFFR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5FFFFR<E, R1, R2, R3, R4, R5> join(SerializableFunction2<R5, E> propertyName) {
        ...
        return new EntitySqlQueryRelate5FFFFR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5FFFFP<E, R1, R2, R3, R4, R5> join(SerializableFunction1<E, R5> propertyName) {
        ...
        return new EntitySqlQueryRelate5FFFFP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
