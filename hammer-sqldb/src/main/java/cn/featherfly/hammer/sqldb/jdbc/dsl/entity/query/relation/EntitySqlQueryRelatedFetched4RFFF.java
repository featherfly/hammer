...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5RFFFR;
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelatedExpression;
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelatedFetchedExpression5RFFFF;
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelatedFetchedExpression5RFFFP;
...
public class EntitySqlQueryRelatedFetched4RFFF<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelatedFetched4RFFF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    @Override
    public <QR extends EntityQueryRelateExpression5RFFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>(
                (QR) new EntitySqlQueryRelate5RFFFR<>(factory, sqlPageFactory, queryRelation), factory, queryRelation,
                joinType, 0);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5RFFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R2, R3, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R2, R3, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R2, R3, R4>>,
        ...
        return (RE) new EntitySqlQueryRelate5RFFFR<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R2, R3, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R2, R3, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R2, R3, R4>>,
            QR extends EntityQueryRelatedFetchedExpression5RFFFP<E, R1, R2, R3, R4, R5, RC, RL, RS>,
        ...
        return (RE) new EntitySqlQueryRelate5RFFFP<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFFFP<E, R1, R2, R3, R4, E, RC, RL, RS>> RE join(
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFFFP<E, R1, R2, R3, R4, R1, RC, RL, RS>> RE join2(
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFFFP<E, R1, R2, R3, R4, R2, RC, RL, RS>> RE join3(
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFFFP<E, R1, R2, R3, R4, R3, RC, RL, RS>> RE join4(
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RFFFP<E, R1, R2, R3, R4, R4, RC, RL, RS>> RE join5(
