...
public class EntitySqlQueryRelatedFetched4RFFF<E, R1, R2, R3, R4>
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<E, R5, EntityQueryRelate5RFFFR<E, R1, R2, R3, R4, R5>,
            EntityQueryRelatedFetched5RFFFF<E, R1, R2, R3, R4, R5>> join(Class<R5> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate5RFFFR<>(factory, sqlPageFactory, queryRelation),
    ...
    public <R5> EntityQueryRelate5RFFFR<E, R1, R2, R3, R4, R5> join(SerializableFunction2<R5, E> propertyName) {
        ...
        return new EntitySqlQueryRelate5RFFFR<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5RFFFP<E, R1, R2, R3, R4, R5> join(SerializableFunction1<E, R5> propertyName) {
        ...
        return new EntitySqlQueryRelate5RFFFP<>(factory, sqlPageFactory, queryRelation);
    }
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R1, R5, EntityQueryRelate5RFFFR<E, R1, R2, R3, R4, R5>,
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R2, R5, EntityQueryRelate5RFFFR<E, R1, R2, R3, R4, R5>,
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R3, R5, EntityQueryRelate5RFFFR<E, R1, R2, R3, R4, R5>,
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R4, R5, EntityQueryRelate5RFFFR<E, R1, R2, R3, R4, R5>,
