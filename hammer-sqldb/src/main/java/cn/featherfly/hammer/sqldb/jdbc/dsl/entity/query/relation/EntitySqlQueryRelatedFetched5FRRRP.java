...
/**
 * The Class EntitySqlQueryRelatedFetched5FRRRP.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelatedFetched5FRRRP<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple2<E, R1>>
        implements EntityQueryRelatedFetched5FRRRP<E, R1, R2, R3, R4, R5> {

    /**
     * Instantiates a new entity sql query related fetched 5 FRRRP.
     *
     * @param factory                the factory
     * @param sqlPageFactory         the sql page factory
     * @param entitySqlQueryRelation the entity sql query relation
     */
    public EntitySqlQueryRelatedFetched5FRRRP(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
