...
public class EntitySqlQueryRelate5FFFRR<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5FFFRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FFFRF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FFFRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
