 ...
 */
public abstract class AbstractEntitySqlConditionGroupExpressionBase3<T1, T2, T3, ER extends EntitySqlRelation<ER, B>,
        B extends SqlBuilder, C extends GroupExpression<C, L>, L extends GroupEndExpression<C, L>,
        C2 extends ConditionConfig<C2>> extends AbstractEntitySqlConditionGroupExpressionBase2<T1, T2, ER, B, C, L, C2>
     ...
     */
    @Override
    public <R> L eq3(SerializableSupplier<R> property) {
        return eq(classMapping3, property, queryAlias3, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L eq3(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
        return eq(classMapping3, property, queryAlias3, ignoreStrategy);
    }
     ...
     */
    @Override
    public <R> L ne3(SerializableSupplier<R> property) {
        return ne(classMapping3, property, queryAlias3, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L ne3(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
        return ne(classMapping3, property, queryAlias3, ignoreStrategy);
    }
