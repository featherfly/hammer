...
public class EntitySqlQueryRelate5RRRFR<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5RRRFR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5RRRFF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RRRFF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
