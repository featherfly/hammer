 ...
 */
public class NumberFieldExpressionMulitiRepositoryImpl<N extends Number, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractMulitiRepositoryFieldExpression<C, L> implements NumberFieldExpression<N, C, L> {
     ...
     */
    public NumberFieldExpressionMulitiRepositoryImpl(AtomicInteger index, String name, InternalMulitiCondition<L> expression) {
