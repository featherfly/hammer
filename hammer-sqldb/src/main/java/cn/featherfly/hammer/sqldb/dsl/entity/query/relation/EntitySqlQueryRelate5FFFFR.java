...
public class EntitySqlQueryRelate5FFFFR<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5FFFFR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FFFFF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FFFFF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
