 ...
 */
public class EnumFieldExpressionMulitiRepositoryImpl<E extends Enum<E>, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractMulitiRepositoryFieldExpression<C, L> implements EnumFieldExpression<E, C, L> {
     ...
     * @param expression the expression
     */
    public EnumFieldExpressionMulitiRepositoryImpl(AtomicInteger index, String name, InternalMulitiCondition<L> expression) {
