 ...
 */
public class SqlEntityExecutableUpdate4<E, J1, J2, J3>
    implements SqlEntityUpdate4<E, J1, J2, J3>, EntityExecutableUpdate4<E, J1, J2, J3> {

    private SqlEntityExecutableUpdate<E> update;
     ...
     */
    public SqlEntityExecutableUpdate4(SqlEntityExecutableUpdate<E> update) {
        this.update = update;
    }
     ...
     */
    @Override
    public <R> EntityUpdateValueExpression<R, EntityExecutableUpdate4<E, J1, J2, J3>,
    ...
    @Override
    public <R,
        O> EntityUpdateValueExpression<O, EntityExecutableUpdate4<E, J1, J2, J3>,
            EntityExecutableConditionGroup4<E, J1, J2, J3, UpdateConditionConfig>,
            EntityExecutableConditionGroupLogic4<E, J1, J2, J3, UpdateConditionConfig>> property(
     ...
     */
    @Override
    public <R extends Number> EntityUpdateNumberValueExpression<R, EntityExecutableUpdate4<E, J1, J2, J3>,
        EntityExecutableConditionGroup4<E, J1, J2, J3, UpdateConditionConfig>,
        EntityExecutableConditionGroupLogic4<E, J1, J2, J3, UpdateConditionConfig>> property(
    ...
    public EntityExecutableConditionGroupLogic4<E, J1, J2, J3, UpdateConditionConfig> where(
        ...
        SqlEntityUpdateExpression4<E, J1, J2, J3> expr = createSqlUpdateExpression();
    ...
    public <J> EntityOnExpression4<E, J1, J2, J3, J, EntityUpdate5<E, J1, J2, J3, J>> join(Class<J> joinType) {
        return new EntitySqlOn4<>(joinType, new SqlEntityExecutableUpdate5<>(update), update.factory, update.relation);
    }
    ...
    private SqlEntityUpdateExpression4<E, J1, J2, J3> createSqlUpdateExpression() {
        return new SqlEntityUpdateExpression4<>(update.factory, update.relation);
    }
