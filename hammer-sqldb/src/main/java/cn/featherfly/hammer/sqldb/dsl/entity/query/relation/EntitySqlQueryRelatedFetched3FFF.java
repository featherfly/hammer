...
public class EntitySqlQueryRelatedFetched3FFF<E, R1, R2, R3>
     ...
     */
    public EntitySqlQueryRelatedFetched3FFF(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public <J> EntityOnExpression4<E, R1, R2, R3, J, EntityQueryRelate4FFFR<E, R1, R2, R3, J>> join(Class<J> joinType) {
        return new EntitySqlOn4<>(joinType,
            new EntitySqlQueryRelate4FFFR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R4> EntityQueryRelate4FFFR<E, R1, R2, R3, R4> join(SerializableFunction2<R4, E> propertyName) {
        ...
        return new EntitySqlQueryRelate4FFFR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R4> EntityQueryRelate4FFFP<E, R1, R2, R3, R4> join(SerializableFunction1<E, R4> propertyName) {
        ...
        return new EntitySqlQueryRelate4FFFP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
