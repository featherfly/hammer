...
/**
 * abstract muliti entity sql query conditions group expression.
 *
 * @author zhongj
 ...
 */
public abstract class AbstractMulitiEntitySqlQueryConditionsGroupExpression<E,
        ...
        AbstractMulitiEntitySqlConditionsGroupExpressionBase<E, EntitySqlQueryRelation, SqlSelectBasicBuilder, C, L,
    ...
    protected SortBuilder getRootSortBuilder() {
        return ((AbstractMulitiEntitySqlQueryConditionsGroupExpression<E, C, L>) getRoot()).sortBuilder;
    }
}
