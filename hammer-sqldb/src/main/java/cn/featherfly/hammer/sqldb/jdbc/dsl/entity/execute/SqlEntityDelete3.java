 ...
 */
public class SqlEntityDelete3<E1, E2, E3> implements EntityDelete3<E1, E2, E3> {
     ...
     */
    public SqlEntityDelete3(JdbcMappingFactory factory, EntitySqlDeleteRelation relation) {
    ...
    public <R> EntityOnExpression3<E1, E2, E3, R, EntityDelete4<E1, E2, E3, R>> join(Class<R> joinType) {
        return new EntitySqlOn3<>(joinType, new SqlEntityDelete4<>(factory, relation), factory, relation);
    }
    ...
    public EntityExecutableConditionGroupLogic3<E1, E2, E3, DeleteConditionConfig> where(
        ...
        SqlEntityDeleteExpression3<E1, E2, E3> sqlDeleteExpression = createSqlDeleteExpression();
        if (function != null) {
            sqlDeleteExpression
    ...
    private SqlEntityDeleteExpression3<E1, E2, E3> createSqlDeleteExpression() {
        return new SqlEntityDeleteExpression3<>(factory, relation);
    }
}
