 ...
 * @author zhongj
 */
public class RepositorySqlDeleteExpression3 extends AbstractMulitiRepositorySqlExecutableConditionsGroup3<
     ...
     */
    public RepositorySqlDeleteExpression3(RepositorySqlDeleteRelation deleteRelation) {
     ...
     */
    RepositorySqlDeleteExpression3(RepositoryExecutableConditionsGroupLogic3<DeleteConditionConfig> parent,
    ...
    protected RepositoryExecutableConditionsGroup3<DeleteConditionConfig> createGroup(
        ...
        return new RepositorySqlDeleteExpression3(parent, repositoryRelation);
    }
}
