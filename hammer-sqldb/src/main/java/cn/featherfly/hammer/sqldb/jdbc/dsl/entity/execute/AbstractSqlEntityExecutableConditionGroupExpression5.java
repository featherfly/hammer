 ...
 */
public abstract class AbstractSqlEntityExecutableConditionGroupExpression5<T1, T2, T3, T4, T5,
    C2 extends ExecutableConditionConfig<C2>, ER extends EntitySqlRelation<ER, B>, B extends SqlBuilder> extends
    AbstractMulitiEntitySqlExecutableConditionsGroupExpression5<T1, T2, T3, T4, T5, C2, ER, B,
        EntityExecutableConditionGroup5<T1, T2, T3, T4, T5, C2>,
        EntityExecutableConditionGroupLogic5<T1, T2, T3, T4, T5, C2>>
    implements EntityExecutableConditionGroup5<T1, T2, T3, T4, T5, C2>,
    EntityExecutableConditionGroupLogic5<T1, T2, T3, T4, T5, C2> {
     ...
     */
    protected AbstractSqlEntityExecutableConditionGroupExpression5(
        EntityExecutableConditionGroupLogic5<T1, T2, T3, T4, T5, C2> parent, JdbcMappingFactory factory,
        ER entityRelation) {
        // 删除，和更新不需要分页
