...
public class EntitySqlQueryRelate5FRFRP<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5FRFRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FRFRP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FRFRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
