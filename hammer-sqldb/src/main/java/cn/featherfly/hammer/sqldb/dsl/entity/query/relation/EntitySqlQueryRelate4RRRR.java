...
public class EntitySqlQueryRelate4RRRR<E, R1, R2, R3, R4> extends AbstractEntitySqlQueryRelate4RRRX<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelate4RRRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched4RRRF<E, R1, R2, R3, R4> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched4RRRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
}
