...
public class RepositorySqlExecutableUpdate3 implements RepositorySqlUpdate3, RepositoryExecutableUpdate3 {
     ...
     */
    @Override
    public <N extends Number> RepositorySqlExecutableUpdate3 increase(SerializableSupplier<N> property) {
     ...
     */
    @Override
    public UpdateValueExpression<Object, RepositoryExecutableUpdate3,
    ...
    @Override
    public <T,
        R> UpdateValueExpression<R, RepositoryExecutableUpdate3,
            RepositoryExecutableConditionsGroup3<UpdateConditionConfig>,
