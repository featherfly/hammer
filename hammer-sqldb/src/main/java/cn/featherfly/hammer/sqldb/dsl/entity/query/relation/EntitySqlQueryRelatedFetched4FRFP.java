 ...
 */
public class EntitySqlQueryRelatedFetched4FRFP<E, R1, R2, R3, R4> extends
    AbstractEntitySqlQueryRelate4FRFX<E, R1, R2, R3, R4> implements EntityQueryRelatedFetched4FRFP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4FRFP(HammerConfig hammerConfig, JdbcMappingFactory factory,
