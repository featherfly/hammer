...
public class EntitySqlQueryRelate5RRFFP<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5RRFFP(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    public EntityQueryRelatedFetched5RRFFP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RRFFP<>(factory, sqlPageFactory, queryRelation);
    }
