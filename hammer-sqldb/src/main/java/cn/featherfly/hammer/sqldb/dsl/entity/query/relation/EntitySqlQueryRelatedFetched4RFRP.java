 ...
 */
public class EntitySqlQueryRelatedFetched4RFRP<E, R1, R2, R3, R4> extends
    AbstractEntitySqlQueryRelate4RFRX<E, R1, R2, R3, R4> implements EntityQueryRelatedFetched4RFRP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4RFRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
