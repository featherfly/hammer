...
public class NotEndWithEntityPropertyExpressionImpl<V, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    public void value(String value, MatchStrategy matchStrategy) {
        expression.new0(index, getPropertyMapping(value), value, matchStrategy, expression.getIgnoreStrategy());
    }
    ...
    public void value(String value, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        expression.new0(index, getPropertyMapping(value), value, matchStrategy, ignoreStrategy);
    }
