...
/**
 * The Class RepositorySqlQueryRelate4F.
 *
 * @author zhongj
 */
public class RepositorySqlQueryRelate4F extends AbstractRepositorySqlQuery5FF<RepositoryQueryRelatedFetched4FF>
    implements RepositoryQueryRelate4F {
     ...
     */
    public RepositorySqlQueryRelate4F(RepositorySqlQueryRelation queryRelation, SqlPageFactory sqlPageFactory) {
     ...
     */
    protected RepositorySqlQueryRelate4F(AbstractRepositorySqlQuery5<?, ?, ?, ?, ?, ?> abstractRepositorySqlQuery) {
    ...
    protected RepositoryQueryRelatedFetched4FF createFetched() {
        return new RepositorySqlQueryRelatedFetched4FF(this);
    }
