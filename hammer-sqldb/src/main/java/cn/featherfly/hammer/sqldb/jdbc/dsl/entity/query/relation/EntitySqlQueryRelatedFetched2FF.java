...
public class EntitySqlQueryRelatedFetched2FF<E, R1, R2> extends
     ...
     */
    protected EntitySqlQueryRelatedFetched2FF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    @Override
    public <QR extends EntityQueryRelateExpression3FF<E, R1, R2, R3, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate3FF<>(factory, sqlPageFactory, queryRelation),
    ...
    //        return (RE) new EntitySqlQueryRelate3FF<>(factory, sqlPageFactory, queryRelation);
    //    }
    //
    //    /**
    //     * {@inheritDoc}
