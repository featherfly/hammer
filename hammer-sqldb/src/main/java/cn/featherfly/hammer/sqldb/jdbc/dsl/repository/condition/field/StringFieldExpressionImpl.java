...
public class StringFieldExpressionImpl<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractRepositoryFieldExpression<C, L> implements StringFieldExpression<C, L> {
    ...
    public L eq(String value, MatchStrategy matchStrategy) {
        return expression.eq(name, value, matchStrategy, expression.getIgnoreStrategy()::test);
    }
    ...
    public L ne(String value, MatchStrategy matchStrategy) {
        return expression.ne(name, value, matchStrategy, expression.getIgnoreStrategy()::test);
    }
    ...
    public L le(String value) {
        return expression.le(name, value, expression.getIgnoreStrategy()::test);
    }
    ...
    public L lt(String value) {
        return expression.lt(name, value, expression.getIgnoreStrategy()::test);
    }
    ...
    public L ge(String value) {
        return expression.ge(name, value, expression.getIgnoreStrategy()::test);
    }
    ...
    public L gt(String value) {
        return expression.gt(name, value, expression.getIgnoreStrategy()::test);
    }
    ...
    public L co(String value) {
        return expression.co(name, value, MatchStrategy.AUTO, expression.getIgnoreStrategy()::test);
    }
    ...
    public L nsw(String value, MatchStrategy matchStrategy) {
        return expression.nsw(name, value, matchStrategy, expression.getIgnoreStrategy()::test);
    }
    ...
    public L nco(String value, MatchStrategy matchStrategy) {
        return expression.nco(name, value, matchStrategy, expression.getIgnoreStrategy()::test);
    }
    ...
    public L newv(String value, MatchStrategy matchStrategy) {
        return expression.newv(name, value, matchStrategy, expression.getIgnoreStrategy()::test);
    }
    ...
    public L nl(String value, MatchStrategy matchStrategy) {
        return expression.nl(name, value, matchStrategy, expression.getIgnoreStrategy()::test);
    }
