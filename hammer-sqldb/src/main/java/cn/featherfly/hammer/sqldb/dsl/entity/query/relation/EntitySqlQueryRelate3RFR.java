...
public class EntitySqlQueryRelate3RFR<E, R1, R2, R3> extends AbstractEntitySqlQueryRelate3RFX<E, R1, R2, R3>
    ...
    /**
     * Instantiates a new entity sql query relate 3 RFR.
     *
     ...
     */
    public EntitySqlQueryRelate3RFR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched3RFF<E, R1, R2, R3> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched3RFF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
}
