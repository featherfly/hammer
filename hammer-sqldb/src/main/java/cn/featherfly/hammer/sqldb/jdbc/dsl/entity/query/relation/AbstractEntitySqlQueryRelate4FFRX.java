...
public abstract class AbstractEntitySqlQueryRelate4FFRX<E, R1, R2, R3, R4>
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<E, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
            EntityQueryRelatedFetched5FFRRF<E, R1, R2, R3, R4, R5>> join(Class<R5> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate5FFRRR<>(factory, sqlPageFactory, queryRelation),
    ...
    public <R5> EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5> join(SerializableFunction2<R5, E> propertyName) {
        ...
        return new EntitySqlQueryRelate5FFRRR<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5FFRRP<E, R1, R2, R3, R4, R5> join(SerializableFunction1<E, R5> propertyName) {
        ...
        return new EntitySqlQueryRelate5FFRRP<>(factory, sqlPageFactory, queryRelation);
    }
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R1, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
            EntityQueryRelatedFetched5FFRRF<E, R1, R2, R3, R4, R5>> join2(Class<R5> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate5FFRRR<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R2, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
            EntityQueryRelatedFetched5FFRRF<E, R1, R2, R3, R4, R5>> join3(Class<R5> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate5FFRRR<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R3, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
            EntityQueryRelatedFetched5FFRRF<E, R1, R2, R3, R4, R5>> join4(Class<R5> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate5FFRRR<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <R5> EntityQueryRelatedExpression<R4, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
            EntityQueryRelatedFetched5FFRRF<E, R1, R2, R3, R4, R5>> join5(Class<R5> joinType) {
        return new EntitySqlQueryRelated<>(new EntitySqlQueryRelate5FFRRR<>(factory, sqlPageFactory, queryRelation),
