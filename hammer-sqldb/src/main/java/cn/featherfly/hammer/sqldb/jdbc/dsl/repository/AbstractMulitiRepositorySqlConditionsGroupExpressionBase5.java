...
import cn.featherfly.hammer.expression.repository.condition.ba.RepositoryBetweenExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.co.RepositoryContainsExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.eq.RepositoryEqualsExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.ew.RepositoryEndWithExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.ge.RepositoryGreatEqualsExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.gt.RepositoryGreatThanExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.in.RepositoryInExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.inn.RepositoryIsNotNullExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.isn.RepositoryIsNullExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.le.RepositoryLessEqualsExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.lk.RepositoryLikeExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.lt.RepositoryLessThanExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.nba.RepositoryNotBetweenExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.nco.RepositoryNotContainsExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.ne.RepositoryNotEqualsExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.newv.RepositoryNotEndWithExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.ni.RepositoryNotInExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.nl.RepositoryNotLikeExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.nsw.RepositoryNotStartWithExpressionBase5;
import cn.featherfly.hammer.expression.repository.condition.sw.RepositoryStartWithExpressionBase5;
...
public abstract class AbstractMulitiRepositorySqlConditionsGroupExpressionBase5<C extends GroupExpression<C, L>,
        L extends GroupEndExpression<C, L>, C5 extends ConditionConfig<C5>, S extends RepositorySqlRelation<S, B>,
        B extends SqlBuilder> extends AbstractMulitiRepositorySqlConditionsGroupExpressionBase4<C, L, C5, S, B>
...
/*, RepositoryFieldExpression<C, L>*/ {
    ...
    protected AbstractMulitiRepositorySqlConditionsGroupExpressionBase5(L parent, int index, S repositoryRelation,
        ...
        repositoryAlias5 = repositoryRelation.getRepositoryRelation(1).getRepositoryAlias();
    }
    ...
    public L eq5(String name, char value, CharPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((char) v), repositoryAlias5);
    }
    ...
    public L eq5(String name, int value, IntPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((int) v), repositoryAlias5);
    }
    ...
    public L eq5(String name, long value, LongPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((long) v), repositoryAlias5);
    }
    ...
    public L eq5(String name, double value, DoublePredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((double) v), repositoryAlias5);
    }
     ...
     */
    @Override
    public L eq5(String name, Object value) {
        return eq5(name, value, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L eq5(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public L ne5(String name, Object value) {
        return ne(name, value, getIgnoreStrategy(), repositoryAlias5);
    }
     ...
     */
    @Override
    public <R> L ne5(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L in5(String name, @SuppressWarnings("unchecked") R... values) {
        return in(name, values, getIgnoreStrategy(), repositoryAlias5);
    }
     ...
     */
    @Override
    public <R> L in5(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L ni5(String name, @SuppressWarnings("unchecked") R... values) {
        return ni(name, values, getIgnoreStrategy(), repositoryAlias5);
    }
     ...
     */
    @Override
    public <R> L ni5(String name, R value, Predicate<R> ignoreStrategy) {
