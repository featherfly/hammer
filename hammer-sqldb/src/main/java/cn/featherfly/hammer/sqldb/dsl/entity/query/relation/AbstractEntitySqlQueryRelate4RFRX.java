...
public abstract class AbstractEntitySqlQueryRelate4RFRX<E, R1, R2, R3, R4>
     ...
     */
    protected AbstractEntitySqlQueryRelate4RFRX(HammerConfig hammerConfig, JdbcMappingFactory factory,
     ...
     */
    @Override
    public <J> EntityOnExpression5<E, R1, R2, R3, R4, J, EntityQueryRelate5RFRRR<E, R1, R2, R3, R4, J>> join(
        Class<J> joinType) {
        return new EntitySqlOn5<>(joinType,
            new EntitySqlQueryRelate5RFRRR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5RFRRR<E, R1, R2, R3, R4, R5> join(SerializableFunction2<R5, E> propertyName) {
        ...
        return new EntitySqlQueryRelate5RFRRR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5RFRRP<E, R1, R2, R3, R4, R5> join(SerializableFunction1<E, R5> propertyName) {
        ...
        return new EntitySqlQueryRelate5RFRRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
