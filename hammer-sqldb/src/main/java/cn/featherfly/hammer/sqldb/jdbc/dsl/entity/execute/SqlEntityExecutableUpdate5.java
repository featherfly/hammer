 ...
 */
public class SqlEntityExecutableUpdate5<E, J1, J2, J3, J4>
    implements SqlEntityUpdate5<E, J1, J2, J3, J4>, EntityExecutableUpdate5<E, J1, J2, J3, J4> {
     ...
     */
    public SqlEntityExecutableUpdate5(SqlEntityExecutableUpdate<E> update) {
        this.update = update;
    }
    ...
    public EntityExecutableConditionGroupLogic5<E, J1, J2, J3, J4, UpdateConditionConfig> where(
        ...
        SqlEntityUpdateExpression5<E, J1, J2, J3, J4> expr = createSqlUpdateExpression();
    ...
    public <J> EntityOnExpression5<E, J1, J2, J3, J4, J, EntityUpdate6<E, J1, J2, J3, J4, J>> join(Class<J> joinType) {
        return new EntitySqlOn5<>(joinType, new SqlEntityExecutableUpdate6<>(update), update.factory, update.relation);
    }
    ...
    private SqlEntityUpdateExpression5<E, J1, J2, J3, J4> createSqlUpdateExpression() {
        return new SqlEntityUpdateExpression5<>(update.factory, update.relation);
    }
}
