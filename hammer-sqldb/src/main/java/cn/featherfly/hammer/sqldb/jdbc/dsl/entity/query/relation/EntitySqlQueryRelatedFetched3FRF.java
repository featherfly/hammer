...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelatedFetchedExpression4FRFF;
...
public class EntitySqlQueryRelatedFetched3FRF<E, R1, R2, R3>
    ...
    //    @Override
    //    public <RE extends EntityQueryRelateExpression4FRF<E, R1, R2, R3, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
    ...
    //        return (RE) new EntitySqlQueryRelate4FRF<>(factory, sqlPageFactory, queryRelation);
    //    }
    //
    //    /**
    //     * {@inheritDoc}
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FRF<E, R1, R2, R3, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FRF<E, R1, R2, R3, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FRF<E, R1, R2, R3, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FRF<E, R1, R2, R3, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <QR extends EntityQueryRelateExpression4FRF<E, R1, R2, R3, R4, RC, RL, RS, QRF, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple3<E, R1, R3>>,
            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple3<E, R1, R3>>,
            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple3<E, R1, R3>>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate4FRF<>(factory, sqlPageFactory, queryRelation),
