 ...
 */
public class SqlEntityDelete5<E1, E2, E3, E4, E5> implements EntityDelete5<E1, E2, E3, E4, E5> {
     ...
     */
    public SqlEntityDelete5(JdbcMappingFactory factory, EntitySqlDeleteRelation relation) {
    ...
    public <
        ...
        return new EntitySqlOn5<>(joinType, new SqlEntityDelete6<>(factory, relation), factory, relation);
    }
    ...
    public EntityExecutableConditionGroupLogic5<E1, E2, E3, E4, E5, DeleteConditionConfig> where(
        ...
        SqlEntityDeleteExpression5<E1, E2, E3, E4, E5> sqlDeleteExpression = createSqlDeleteExpression();
        if (function != null) {
            sqlDeleteExpression
    ...
    private SqlEntityDeleteExpression5<E1, E2, E3, E4, E5> createSqlDeleteExpression() {
        return new SqlEntityDeleteExpression5<>(factory, relation);
    }
}
