...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate5FFFR;
...
/**
 * The Class EntitySqlQueryRelate5FFFR.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelate5FFFR<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R2, R3>>
        implements EntityQueryRelate5FFFR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5FFFR(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
