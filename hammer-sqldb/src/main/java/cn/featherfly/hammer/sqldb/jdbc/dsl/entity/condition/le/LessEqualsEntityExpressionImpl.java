 ...
 */
package cn.featherfly.hammer.sqldb.jdbc.dsl.entity.condition.le;
 ...
 */
public class LessEqualsEntityExpressionImpl<T, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractLessEqualsEntityExpression<T, C, L> implements LessEqualsEntityExpression<T> {
     ...
     */
    public LessEqualsEntityExpressionImpl(int index, MulitiLessEqualsExpression<C, L> expression,
    ...
    public <R> CompareEntityPropertyExpression<R> property(SerializableFunction<T, R> name) {
        return new LessEqualsEntityPropertyExpressionImpl<>(index, name,
                ((MulitiEntityLessEqualsExpressionImpl<C, L>) expression).getHold(), factory, queryRelation);
    }
    ...
    public SetStringExpression property(SerializableToStringFunction<T> name) {
        return new SetStringExpressionImpl(v -> null, ignoreStrategy,
                (value, match, ignore, pm) -> expression.le(index, name, value, match, ignore));
    }
