...
public abstract class AbstractRepositorySqlQuery6FF<R extends RepositoryQueryRelateExpression<R>> extends
     ...
     */
    @Override
    public RepositoryQuerySortExpression6<RepositoryQuerySortedExpression6FF,
    ...
    public LimitAwareQuery2<Map<String, Serializable>> limit(Limit limit) {
        return new RepositorySqlQueryExpression6FF(queryRelation, sqlPageFactory).limit(limit);
    }
}
