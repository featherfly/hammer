...
public abstract class AbstractRepositorySqlQuery6FF<R extends RepositoryQueryRelateExpression<R>> extends
    AbstractRepositorySqlQuery6<R, RepositoryQueryConditionsGroup6FF, RepositoryQueryConditionsGroupLogic6FF,
        RepositoryQuerySortExpression6<RepositoryQuerySortedExpression6FF, QueryLimitExecutor2>,
        RepositoryQuerySortedExpression6FF, QueryLimitExecutor2>
    implements
    RepositoryQuery6<RepositoryQueryConditionsGroup6FF, RepositoryQueryConditionsGroupLogic6FF,
        RepositoryQuerySortExpression6<RepositoryQuerySortedExpression6FF, QueryLimitExecutor2>,
        RepositoryQuerySortedExpression6FF, QueryLimitExecutor2>,
    QueryLimitExecutor2 {
     ...
     */
    @Override
    public RepositoryQuerySortExpression6<RepositoryQuerySortedExpression6FF, QueryLimitExecutor2> sort() {
    ...
    public <S1 extends RepositorySortedExpression<S1>, S2 extends RepositorySortedExpression<S2>,
        ...
        S6 extends RepositorySortedExpression<S6>> RepositoryQuerySortedExpression6FF sort(
        ...
        return new RepositorySqlQueryExpression6FF(queryRelation, sqlPageFactory).sort(repositorySortExpresions);
    }
