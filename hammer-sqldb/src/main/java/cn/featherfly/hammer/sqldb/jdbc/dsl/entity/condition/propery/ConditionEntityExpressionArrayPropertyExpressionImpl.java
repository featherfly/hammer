...
import cn.featherfly.hammer.expression.entity.condition.ConditionEntityExpressionArrayPropertyExpression;

/**
 * The Class ConditionEntityExpressionArrayPropertyExpressionImpl.
 *
 * @author zhongj
 * @param <V> the value type
 */
public class ConditionEntityExpressionArrayPropertyExpressionImpl<V>
        implements ConditionEntityExpressionArrayPropertyExpression<V> {
     ...
     */
    public ConditionEntityExpressionArrayPropertyExpressionImpl(Function<V, PropertyMapping<?>> getPropertyMapping,
