...
import cn.featherfly.hammer.expression.entity.condition.ConditionEntityExpressionPropertyExpression2;

/**
 * The Class ConditionEntityExpressionPropertyExpression2Impl.
 *
 * @author zhongj
 * @param <V> the value type
 */
public class ConditionEntityExpressionPropertyExpression2Impl<V>
        implements ConditionEntityExpressionPropertyExpression2<V> {
     ...
     */
    public ConditionEntityExpressionPropertyExpression2Impl(Function<V, PropertyMapping<?>> propertyMapping,
            Predicate<?> ignoreStrategy, FourArgusConsumer<V, V, BiPredicate<V, V>, PropertyMapping<?>> setValue) {
        super();
