...
/**
 * The Class EntitySqlQueryRelatedFetched5RFFRF.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelatedFetched5RFFRF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple4<E, R2, R3, R5>>
        implements EntityQueryRelatedFetched5RFFRF<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelatedFetched5RFFRF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
