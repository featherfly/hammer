...
public class EntitySqlQueryRelatedFetched4RRRP<E, R1, R2, R3, R4>
        ...
        implements EntityQueryRelatedFetched4RRRP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4RRRP(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
