 ...
 */
public class EntitySqlQueryRelate5RFFRR<E, R1, R2, R3, R4, R5>
    extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple3<E, R2, R3>>
    implements EntityQueryRelate5RFFRR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5RFFRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5RFFRF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RFFRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
