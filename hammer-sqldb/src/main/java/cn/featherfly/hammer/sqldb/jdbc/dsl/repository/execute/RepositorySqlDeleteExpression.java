 ...
 * @author zhongj
 */
public class RepositorySqlDeleteExpression extends AbstractMulitiRepositorySqlExecutableConditionsGroup<
     ...
     */
    public RepositorySqlDeleteExpression(RepositorySqlDeleteRelation deleteRelation) {
     ...
     */
    RepositorySqlDeleteExpression(RepositoryExecutableConditionsGroupLogic<DeleteConditionConfig> parent,
    ...
    protected RepositoryExecutableConditionsGroup<DeleteConditionConfig> createGroup(
        ...
        return new RepositorySqlDeleteExpression(parent, repositoryRelation);
    }
