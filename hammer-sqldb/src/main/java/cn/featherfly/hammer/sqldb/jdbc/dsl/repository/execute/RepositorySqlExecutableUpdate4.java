...
import cn.featherfly.hammer.sqldb.jdbc.dsl.repository.RepositorySqlOn4;
...
public class RepositorySqlExecutableUpdate4 implements RepositorySqlUpdate4, RepositoryExecutableUpdate4 {
     ...
     */
    @Override
    public UpdateValueExpression<Object, RepositoryExecutableUpdate4,
    ...
    @Override
    public <T,
        R> UpdateValueExpression<R, RepositoryExecutableUpdate4,
            RepositoryExecutableConditionsGroup4<UpdateConditionConfig>,
