...
public class AbstractEntitySqlQueryRelate4FRFX<E, R1, R2, R3, R4>
     ...
     */
    protected AbstractEntitySqlQueryRelate4FRFX(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public <J> EntityOnExpression5<E, R1, R2, R3, R4, J, EntityQueryRelate5FRFRR<E, R1, R2, R3, R4, J>> join(
        ...
        return new EntitySqlOn5<>(joinType,
            new EntitySqlQueryRelate5FRFRR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5FRFRR<E, R1, R2, R3, R4, R5> join(SerializableFunction2<R5, E> propertyName) {
        ...
        return new EntitySqlQueryRelate5FRFRR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5FRFRP<E, R1, R2, R3, R4, R5> join(SerializableFunction1<E, R5> propertyName) {
        ...
        return new EntitySqlQueryRelate5FRFRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
