...
public class EntitySqlQueryRelate4RFFP<E, R1, R2, R3, R4> extends AbstractEntitySqlQueryRelate4RFFX<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelate4RFFP(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched4RFFP<E, R1, R2, R3, R4> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched4RFFP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
}
