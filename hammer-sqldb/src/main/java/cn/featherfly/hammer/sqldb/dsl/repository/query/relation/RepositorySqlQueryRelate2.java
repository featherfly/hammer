...
/**
 * The Class RepositorySqlQueryRelate2.
 *
 * @author zhongj
 */
public class RepositorySqlQueryRelate2 extends
    AbstractRepositorySqlQuery3<RepositoryQueryRelatedFetched2F, RepositoryQueryConditionsGroup3F,
    ...
    implements RepositoryQueryRelate2 {
     ...
     */
    public RepositorySqlQueryRelate2(RepositorySqlQueryRelation queryRelation, SqlPageFactory sqlPageFactory) {
     ...
     */
    protected RepositorySqlQueryRelate2(AbstractRepositorySqlQuery3<?, ?, ?, ?, ?, ?> abstractRepositorySqlQuery) {
    ...
    protected RepositoryQueryRelatedFetched2F createFetched() {
        return new RepositorySqlQueryRelatedFetched2F(this);
    }
     ...
     */
    @Override
    public RepositoryQuerySortExpression3<RepositoryQuerySortedExpression3F,
     ...
     */
    @Override
    public RepositoryOnExpression3<RepositoryQueryRelate3> join(Repository repository) {
        return new RepositorySqlQueryOn3<>(new RepositorySqlQueryRelate3(queryRelation, sqlPageFactory), queryRelation,
            repository, relate -> ((RepositorySqlQueryRelate3) relate).setIdName());
    }
