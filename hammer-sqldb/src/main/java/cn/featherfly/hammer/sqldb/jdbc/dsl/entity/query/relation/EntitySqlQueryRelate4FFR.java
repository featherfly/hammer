...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate4FFR;
 ...
 */
public class EntitySqlQueryRelate4FFR<E, R1, R2, R3, R4>
        extends AbstractEntitySqlQueryFetch5<E, R1, R2, R3, R4, Tuple3<E, R1, R2>>
        implements EntityQueryRelate4FFR<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelate4FFR(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    @Override
    public <QR extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate5FFRR<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R2>>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
