 ...
 */
public class EntitySqlQueryRelate4RFRR<E, R1, R2, R3, R4> extends AbstractEntitySqlQueryRelate4RFRX<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelate4RFRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched4RFRF<E, R1, R2, R3, R4> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched4RFRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
}
