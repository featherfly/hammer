...
public abstract class AbstractMulitiRepositorySqlConditionsGroupExpressionBase6<C extends GroupExpression<C, L>,
        L extends GroupEndExpression<C, L>, C6 extends ConditionConfig<C6>, S extends RepositorySqlRelation<S, B>,
        B extends SqlBuilder> extends AbstractMulitiRepositorySqlConditionsGroupExpressionBase5<C, L, C6, S, B>
...
/*, RepositoryFieldExpression<C, L>*/ {
    ...
    protected AbstractMulitiRepositorySqlConditionsGroupExpressionBase6(L parent, int index, S repositoryRelation,
        ...
        repositoryAlias6 = repositoryRelation.getRepositoryRelation(1).getRepositoryAlias();
    }
    ...
    public L eq6(String name, char value, CharPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((char) v), repositoryAlias6);
    }
    ...
    public L eq6(String name, int value, IntPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((int) v), repositoryAlias6);
    }
    ...
    public L eq6(String name, long value, LongPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((long) v), repositoryAlias6);
    }
    ...
    public L eq6(String name, double value, DoublePredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((double) v), repositoryAlias6);
    }
     ...
     */
    @Override
    public L eq6(String name, Object value) {
        return eq6(name, value, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L eq6(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public L ne6(String name, Object value) {
        return ne(name, value, getIgnoreStrategy(), repositoryAlias6);
    }
     ...
     */
    @Override
    public <R> L ne6(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L in6(String name, @SuppressWarnings("unchecked") R... values) {
        return in(name, values, getIgnoreStrategy(), repositoryAlias6);
    }
     ...
     */
    @Override
    public <R> L in6(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L ni6(String name, @SuppressWarnings("unchecked") R... values) {
        return ni(name, values, getIgnoreStrategy(), repositoryAlias6);
    }
     ...
     */
    @Override
    public <R> L ni6(String name, R value, Predicate<R> ignoreStrategy) {
