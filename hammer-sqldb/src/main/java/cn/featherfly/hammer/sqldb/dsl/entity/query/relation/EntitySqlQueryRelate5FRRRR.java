 ...
 */
public class EntitySqlQueryRelate5FRRRR<E, R1, R2, R3, R4, R5>
    extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple2<E, R1>>
    implements EntityQueryRelate5FRRRR<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelate5FRRRR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5FRRRF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5FRRRF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
