...
public class EntitySqlQueryRelatedFetched3RFF<E, R1, R2, R3>
     ...
     */
    public EntitySqlQueryRelatedFetched3RFF(HammerConfig hammerConfig, JdbcMappingFactory factory,
     ...
     */
    @Override
    public <J> EntityOnExpression4<E, R1, R2, R3, J, EntityQueryRelate4RFFR<E, R1, R2, R3, J>> join(Class<J> joinType) {
        return new EntitySqlOn4<>(joinType,
            new EntitySqlQueryRelate4RFFR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R4> EntityQueryRelate4RFFR<E, R1, R2, R3, R4> join(SerializableFunction2<R4, E> propertyName) {
        ...
        return new EntitySqlQueryRelate4RFFR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R4> EntityQueryRelate4RFFP<E, R1, R2, R3, R4> join(SerializableFunction1<E, R4> propertyName) {
        ...
        return new EntitySqlQueryRelate4RFFP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
