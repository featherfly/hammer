 ...
 */
public class EntitySqlQueryRelatedFetched3RFP<E, R1, R2, R3>
        extends AbstractEntitySqlQueryFetch4<E, R1, R2, R3, Tuple2<E, R2>>
        implements EntityQueryRelatedFetched3RFP<E, R1, R2, R3> {
