...
public class EntitySqlQueryRelatedFetched4FFRF<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelatedFetched4FFRF(HammerConfig hammerConfig, JdbcMappingFactory factory,
     ...
     */
    @Override
    public <J> EntityOnExpression5<E, R1, R2, R3, R4, J, EntityQueryRelate5FFRFR<E, R1, R2, R3, R4, J>> join(
        Class<J> joinType) {
        return new EntitySqlOn5<>(joinType,
            new EntitySqlQueryRelate5FFRFR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5FFRFR<E, R1, R2, R3, R4, R5> join(SerializableFunction2<R5, E> propertyName) {
        ...
        return new EntitySqlQueryRelate5FFRFR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R5> EntityQueryRelate5FFRFP<E, R1, R2, R3, R4, R5> join(SerializableFunction1<E, R5> propertyName) {
        ...
        return new EntitySqlQueryRelate5FFRFP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
