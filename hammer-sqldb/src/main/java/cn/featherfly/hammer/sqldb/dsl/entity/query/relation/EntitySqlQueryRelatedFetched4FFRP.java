 ...
 */
public class EntitySqlQueryRelatedFetched4FFRP<E, R1, R2, R3, R4> extends
    AbstractEntitySqlQueryRelate4FFRX<E, R1, R2, R3, R4> implements EntityQueryRelatedFetched4FFRP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4FFRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
