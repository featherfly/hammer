...
public class EntitySqlQueryRelate4FRRP<E, R1, R2, R3, R4> extends AbstractEntitySqlQueryRelate4FRRX<E, R1, R2, R3, R4>
     ...
     */
    public EntitySqlQueryRelate4FRRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched4FRRP<E, R1, R2, R3, R4> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched4FRRP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
