...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate3FF;
...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression4FFR;
...
/**
 * The Class EntitySqlQueryRelate3FF.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelate3FF<E, R1, R2, R3> extends
        AbstractEntitySqlQueryFetch4<E, R1, R2, R3, Tuple3<E, R1, R2>> implements EntityQueryRelate3FF<E, R1, R2, R3> {

    /**
     * Instantiates a new entity sql query relate 3 FF.
     *
     * @param factory                the factory
     * @param sqlPageFactory         the sql page factory
     * @param entitySqlQueryRelation the entity sql query relation
     */
    public EntitySqlQueryRelate3FF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    @Override
    public <QR extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R4, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate4FFR<>(factory, sqlPageFactory, queryRelation),
    ...
    //    @SuppressWarnings("unchecked")
    //    @Override
    //    public <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
    //            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple3<E, R1, R2>>,
    //            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple3<E, R1, R2>>,
    //            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple3<E, R1, R2>>,
    ...
    //            QRL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, QRC, QRL, QRS,
    //                    Tuple4<E, R1, R2, R4>>,
    //            QRS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple4<E, R1, R2, R4>>, R4,
    ...
    //        return (RE) new EntitySqlQueryRelate4FFR<>(factory, sqlPageFactory, queryRelation);
    //    }
    //
    //    /**
    //     * {@inheritDoc}
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, E, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression4FFRF<E, R1, R2, R3, E, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, E, QRC, QRL, QRS, Tuple4<E, R1, R2, E>>,
            QRL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, E, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, E>>,
            QRS extends EntityQuerySortExpression5<E, R1, R2, R3, E, Tuple4<E, R1, R2, E>>> RE join(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression4FFRF<E, R1, R2, R3, R1, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R1, QRC, QRL, QRS, Tuple4<E, R1, R2, R1>>,
            QRL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R1, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R1>>,
            QRS extends EntityQuerySortExpression5<E, R1, R2, R3, R1, Tuple4<E, R1, R2, R1>>> RE join2(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression4FFRF<E, R1, R2, R3, R2, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R2, QRC, QRL, QRS, Tuple4<E, R1, R2, R2>>,
            QRL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R2, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R2>>,
            QRS extends EntityQuerySortExpression5<E, R1, R2, R3, R2, Tuple4<E, R1, R2, R2>>> RE join3(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression4FFRF<E, R1, R2, R3, R3, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R3, QRC, QRL, QRS, Tuple4<E, R1, R2, R3>>,
            QRL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R3, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R3>>,
            QRS extends EntityQuerySortExpression5<E, R1, R2, R3, R3, Tuple4<E, R1, R2, R3>>> RE join4(
    ...
    public EntityQueryRelatedFetched3FFF<E, R1, R2, R3> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched3FFF<>(factory, sqlPageFactory, queryRelation);
    }
