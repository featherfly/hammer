 ...
 */
public class EntitySqlQueryRelate3RFR<E, R1, R2, R3> extends
        AbstractEntitySqlQueryRelate3RFX<E, R1, R2, R3, Tuple2<E, R2>> implements EntityQueryRelate3RFR<E, R1, R2, R3> {
