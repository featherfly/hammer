 ...
 */
public class SqlEntityExecutableUpdate2<E, J1> implements SqlEntityUpdate2<E, J1>, EntityExecutableUpdate2<E, J1> {
     ...
     */
    public SqlEntityExecutableUpdate2(SqlEntityExecutableUpdate<E> update) {
        this.update = update;
    }
     ...
     */
    @Override
    public <R> EntityUpdateValueExpression<R, EntityExecutableUpdate2<E, J1>,
    ...
    @Override
    public <R,
        O> EntityUpdateValueExpression<O, EntityExecutableUpdate2<E, J1>,
            EntityExecutableConditionGroup2<E, J1, UpdateConditionConfig>,
            EntityExecutableConditionGroupLogic2<E, J1, UpdateConditionConfig>> property(
     ...
     */
    @Override
    public <R extends Number> EntityUpdateNumberValueExpression<R, EntityExecutableUpdate2<E, J1>,
        EntityExecutableConditionGroup2<E, J1, UpdateConditionConfig>,
        EntityExecutableConditionGroupLogic2<E, J1, UpdateConditionConfig>> property(
    ...
    public EntityExecutableConditionGroupLogic2<E, J1, UpdateConditionConfig> where(
        ...
        SqlEntityUpdateExpression2<E, J1> expr = createSqlUpdateExpression();
    ...
    public <J> EntityOnExpression2<E, J1, J, EntityUpdate3<E, J1, J>> join(Class<J> joinType) {
        return new EntitySqlOn2<>(joinType, new SqlEntityExecutableUpdate3<>(update), update.factory, update.relation);
    }
    ...
    private SqlEntityUpdateExpression2<E, J1> createSqlUpdateExpression() {
        return new SqlEntityUpdateExpression2<>(update.factory, update.relation);
    }
