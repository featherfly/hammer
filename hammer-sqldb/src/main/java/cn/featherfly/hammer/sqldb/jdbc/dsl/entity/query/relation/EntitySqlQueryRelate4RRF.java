...
import cn.featherfly.hammer.dsl.entity.query.relation.EntityQueryRelate4RRF;
...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5RRFR;
...
/**
 * The Class EntitySqlQueryRelate4RRF.
 *
 * @author zhongj
 ...
 */
public class EntitySqlQueryRelate4RRF<E, R1, R2, R3, R4>
        extends AbstractEntitySqlQueryFetch5<E, R1, R2, R3, R4, Tuple2<E, R3>>
        implements EntityQueryRelate4RRF<E, R1, R2, R3, R4> {

    /**
     * Instantiates a new entity sql query relate 4 RRF.
     *
     * @param factory                the factory
     * @param sqlPageFactory         the sql page factory
     * @param entitySqlQueryRelation the entity sql query relation
     */
    public EntitySqlQueryRelate4RRF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
     ...
     */
    @Override
    public EntityQueryRelatedFetched4RRFF<E, R1, R2, R3, R4> fetch() {
        queryRelation.fetch(4);
        return new EntitySqlQueryRelatedFetched4RRFF<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    @Override
    public <QR extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate5RRFR<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R3>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R3>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R3>>,
    ...
    public <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, QRC, QRL, QRS,
                    Tuple3<E, R3, R5>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R3, R5>>,
            R5> RE join(SerializableFunction2<R5, Tuple2<E, R3>> propertyName) {
        // IMPLSOON 后续来实现实体关系（ManyToOne、OneToOne、OneToMany）关联
        return null;
    }
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RRFRF<E, R1, R2, R3, R4, E, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, E, QRC, QRL, QRS, Tuple3<E, R3, E>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, E, QRC, QRL, QRS,
                    Tuple3<E, R3, E>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, E, Tuple3<E, R3, E>>> RE join(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RRFRF<E, R1, R2, R3, R4, R1, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R1, QRC, QRL, QRS, Tuple3<E, R3, R1>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R1, QRC, QRL, QRS,
                    Tuple3<E, R3, R1>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R1, Tuple3<E, R3, R1>>> RE join2(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RRFRF<E, R1, R2, R3, R4, R2, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R2, QRC, QRL, QRS, Tuple3<E, R3, R2>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R2, QRC, QRL, QRS,
                    Tuple3<E, R3, R2>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R2, Tuple3<E, R3, R2>>> RE join3(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RRFRF<E, R1, R2, R3, R4, R3, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R3, QRC, QRL, QRS, Tuple3<E, R3, R3>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R3, QRC, QRL, QRS,
                    Tuple3<E, R3, R3>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R3, Tuple3<E, R3, R3>>> RE join4(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5RRFRF<E, R1, R2, R3, R4, R4, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R4, QRC, QRL, QRS, Tuple3<E, R3, R4>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R4, QRC, QRL, QRS,
                    Tuple3<E, R3, R4>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R4, Tuple3<E, R3, R4>>> RE join5(
