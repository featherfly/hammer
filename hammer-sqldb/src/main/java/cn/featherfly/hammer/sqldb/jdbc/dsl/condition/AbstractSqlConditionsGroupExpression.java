...
public abstract class AbstractSqlConditionsGroupExpression<C extends ConditionsGroupExpression<C, L>,
        L extends ConditionsGroupLogicExpression<C, L>, C2 extends ConditionConfig<C2>>
        extends AbstractSqlConditionExpression2<C, L> implements ConditionsGroupExpression<C, L>,
        ConditionsGroupLogicExpression<C, L>, ConditionConfigureExpression<C, C2> {
