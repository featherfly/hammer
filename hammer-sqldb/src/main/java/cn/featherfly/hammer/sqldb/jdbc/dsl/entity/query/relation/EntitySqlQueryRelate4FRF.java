...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5FRFR;
...
public class EntitySqlQueryRelate4FRF<E, R1, R2, R3, R4>
    ...
    @Override
    public <QR extends EntityQueryRelateExpression5FRFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate5FRFR<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R3>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R3>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R3>>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
