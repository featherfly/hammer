...
public abstract class AbstractMulitiRepositorySqlConditionsGroupExpressionBase2<C extends GroupExpression<C, L>,
        ...
        B extends SqlBuilder> extends AbstractMulitiRepositorySqlConditionsGroupExpressionBase<C, L, C2, S, B>
...
/*, RepositoryFieldExpression<C, L>*/ {
    ...
    public L eq2(String name, char value, CharPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((char) v), repositoryAlias2);
    }
    ...
    public L eq2(String name, int value, IntPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((int) v), repositoryAlias2);
    }
    ...
    public L eq2(String name, long value, LongPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((long) v), repositoryAlias2);
    }
    ...
    public L eq2(String name, double value, DoublePredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((double) v), repositoryAlias2);
    }
     ...
     */
    @Override
    public L eq2(String name, Object value) {
        return eq2(name, value, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L eq2(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public L ne2(String name, Object value) {
        return ne(name, value, getIgnoreStrategy(), repositoryAlias2);
    }
     ...
     */
    @Override
    public <R> L ne2(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L in2(String name, @SuppressWarnings("unchecked") R... values) {
        return in(name, values, getIgnoreStrategy(), repositoryAlias2);
    }
     ...
     */
    @Override
    public <R> L in2(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L ni2(String name, @SuppressWarnings("unchecked") R... values) {
        return ni(name, values, getIgnoreStrategy(), repositoryAlias2);
    }
     ...
     */
    @Override
    public <R> L ni2(String name, R value, Predicate<R> ignoreStrategy) {
