...
public class EntitySqlQueryRelate5RFRRP<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5RFRRP(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    public EntityQueryRelatedFetched5RFRRP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RFRRP<>(factory, sqlPageFactory, queryRelation);
    }
