...
public abstract class AbstractEntitySqlQueryRelate4RRFX<E, R1, R2, R3, R4>
     ...
     */
    protected AbstractEntitySqlQueryRelate4RRFX(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    public <J> EntityOnExpression5<E, R1, R2, R3, R4, J, EntityQueryRelate5RRFRR<E, R1, R2, R3, R4, J>> join(
        Class<J> joinType) {
        return new EntitySqlOn5<>(joinType, new EntitySqlQueryRelate5RRFRR<>(factory, sqlPageFactory, queryRelation),
