...
public class EntitySqlQueryRelatedFetched3FRF<E, R1, R2, R3>
     ...
     */
    public EntitySqlQueryRelatedFetched3FRF(HammerConfig hammerConfig, JdbcMappingFactory factory,
     ...
     */
    @Override
    public <J> EntityOnExpression4<E, R1, R2, R3, J, EntityQueryRelate4FRFR<E, R1, R2, R3, J>> join(Class<J> joinType) {
        return new EntitySqlOn4<>(joinType,
            new EntitySqlQueryRelate4FRFR<>(hammerConfig, factory, sqlPageFactory, queryRelation), factory,
            queryRelation);
    }
    ...
    public <R4> EntityQueryRelate4FRFR<E, R1, R2, R3, R4> join(SerializableFunction2<R4, E> propertyName) {
        ...
        return new EntitySqlQueryRelate4FRFR<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
    ...
    public <R4> EntityQueryRelate4FRFP<E, R1, R2, R3, R4> join(SerializableFunction1<E, R4> propertyName) {
        ...
        return new EntitySqlQueryRelate4FRFP<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
