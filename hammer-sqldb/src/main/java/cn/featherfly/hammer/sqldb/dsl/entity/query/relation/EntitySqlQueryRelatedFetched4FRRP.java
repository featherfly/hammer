 ...
 */
public class EntitySqlQueryRelatedFetched4FRRP<E, R1, R2, R3, R4> extends
    AbstractEntitySqlQueryRelate4FRRX<E, R1, R2, R3, R4> implements EntityQueryRelatedFetched4FRRP<E, R1, R2, R3, R4> {
     ...
     */
    public EntitySqlQueryRelatedFetched4FRRP(HammerConfig hammerConfig, JdbcMappingFactory factory,
