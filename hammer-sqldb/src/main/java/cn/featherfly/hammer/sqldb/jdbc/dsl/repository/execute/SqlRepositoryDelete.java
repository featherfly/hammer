 ...
 * @author zhongj
 */
public class SqlRepositoryDelete implements RepositoryDelete {
     ...
     */
    public SqlRepositoryDelete(Jdbc jdbc, String tableName, DatabaseMetadata metadata, DeleteConfig deleteConfig) {
     ...
     * @param deleteConfig the delete config
     */
    public SqlRepositoryDelete(Jdbc jdbc, String tableName, AliasManager aliasManager, DatabaseMetadata metadata,
     ...
     * @param deleteConfig the delete config
     */
    public SqlRepositoryDelete(Jdbc jdbc, Repository repository, DatabaseMetadata metadata, DeleteConfig deleteConfig) {
     ...
     * @param deleteConfig the delete config
     */
    public SqlRepositoryDelete(Jdbc jdbc, Repository repository, AliasManager aliasManager, DatabaseMetadata metadata,
            DeleteConfig deleteConfig) {
     ...
     * @param deleteConfig the delete config
     */
    public SqlRepositoryDelete(Jdbc jdbc, AliasRepository repository, DatabaseMetadata metadata,
            DeleteConfig deleteConfig) {
        this(jdbc, repository, null, metadata, deleteConfig);
    }
     ...
     * @param deleteConfig the delete config
     */
    public SqlRepositoryDelete(Jdbc jdbc, AliasRepository repository, AliasManager aliasManager,
    ...
    public ExecutableConditionGroupLogic<DeleteConditionConfig> where(
            Function<RepositoryFieldExpression<?, ?>, LogicExpression<?, ?>> filterable) {
