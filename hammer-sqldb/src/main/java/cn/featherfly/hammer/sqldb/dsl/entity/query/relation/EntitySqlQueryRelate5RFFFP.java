...
public class EntitySqlQueryRelate5RFFFP<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5RFFFP(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
    ...
    public EntityQueryRelatedFetched5RFFFP<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RFFFP<>(factory, sqlPageFactory, queryRelation);
    }
