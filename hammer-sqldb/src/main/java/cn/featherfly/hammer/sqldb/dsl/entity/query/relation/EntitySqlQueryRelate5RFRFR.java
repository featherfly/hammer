...
public class EntitySqlQueryRelate5RFRFR<E, R1, R2, R3, R4, R5>
     ...
     */
    public EntitySqlQueryRelate5RFRFR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5RFRFF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RFRFF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
