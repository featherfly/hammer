...
/**
 * The Class EntitySqlQueryRelate5RFFFR.
 *
 * @author zhongj
 * @param <E> query type
 ...
 */
public class EntitySqlQueryRelate5RFFFR<E, R1, R2, R3, R4, R5>
    extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple4<E, R2, R3, R4>>
    implements EntityQueryRelate5RFFFR<E, R1, R2, R3, R4, R5> {

    /**
     * Instantiates a new entity sql query relate 5 RFFFR.
     *
     ...
     */
    public EntitySqlQueryRelate5RFFFR(HammerConfig hammerConfig, JdbcMappingFactory factory,
    ...
    public EntityQueryRelatedFetched5RFFFF<E, R1, R2, R3, R4, R5> fetch() {
        ...
        return new EntitySqlQueryRelatedFetched5RFFFF<>(hammerConfig, factory, sqlPageFactory, queryRelation);
    }
