...
/**
 * The Class EntitySqlQueryRelatedFetched5RRRRF.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public class EntitySqlQueryRelatedFetched5RRRRF<E, R1, R2, R3, R4, R5>
        extends AbstractEntitySqlQueryFetch6<E, R1, R2, R3, R4, R5, Tuple2<E, R5>>
        implements EntityQueryRelatedFetched5RRRRF<E, R1, R2, R3, R4, R5> {
     ...
     */
    public EntitySqlQueryRelatedFetched5RRRRF(JdbcMappingFactory factory, SqlPageFactory sqlPageFactory,
