 ...
 */
public abstract class AbstractRepositorySqlQueryFetch<Q, Q2> extends AbstractRepositorySqlQuery<QueryLimitExecutor>
        implements RepositoryQueryFetchFieldExpression<Q, Q2> {

    protected final RepositorySqlQueryRelation repositoryRelation;
     ...
     */
    protected AbstractRepositorySqlQueryFetch(AbstractRepositorySqlQueryFetch<?, ?> repositorySqlQueryFetch) {
        super(repositorySqlQueryFetch);
        repositoryRelation = repositorySqlQueryFetch.repositoryRelation;
    }
