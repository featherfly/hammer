...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelatedFetchedExpression5FRFFF;
...
public class EntitySqlQueryRelatedFetched4FRFF<E, R1, R2, R3, R4>
    ...
    @Override
    public <QR extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>((QR) new EntitySqlQueryRelate5FRFF<>(factory, sqlPageFactory, queryRelation),
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R1, R3, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R1, R3, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R3, R4>>,
    ...
    public <RE extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R5>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple5<E, R1, R3, R4, R5>>,
            R5> RE join(SerializableFunction2<R5, Tuple4<E, R1, R3, R4>> propertyName) {
        // YUFEI_TODO Auto-generated method stub
        return null;
    }
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FRFFF<E, R1, R2, R3, R4, E, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, E, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, E>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, E, Tuple5<E, R1, R3, R4, E>>> RE join(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FRFFF<E, R1, R2, R3, R4, R1, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R1, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R1>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R1, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R1>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R1, Tuple5<E, R1, R3, R4, R1>>> RE join2(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FRFFF<E, R1, R2, R3, R4, R2, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R2, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R2>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R2, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R2>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R2, Tuple5<E, R1, R3, R4, R2>>> RE join3(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FRFFF<E, R1, R2, R3, R4, R3, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R3, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R3>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R3, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R3>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R3, Tuple5<E, R1, R3, R4, R3>>> RE join4(
     ...
     */
    @Override
    public <RE extends EntityQueryRelateExpression5FRFF<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FRFFF<E, R1, R2, R3, R4, R4, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R4, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R4>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R4, QRC, QRL, QRS,
                    Tuple5<E, R1, R3, R4, R4>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R4, Tuple5<E, R1, R3, R4, R4>>> RE join5(
