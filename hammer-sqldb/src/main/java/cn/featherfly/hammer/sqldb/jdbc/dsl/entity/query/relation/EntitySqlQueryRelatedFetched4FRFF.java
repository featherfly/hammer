...
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5FRFFP;
import cn.featherfly.hammer.expression.entity.query.relation.EntityQueryRelateExpression5FRFFR;
...
public class EntitySqlQueryRelatedFetched4FRFF<E, R1, R2, R3, R4>
    ...
    @Override
    public <QR extends EntityQueryRelateExpression5FRFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
        ...
        return new EntitySqlQueryRelated<>(
                (QR) new EntitySqlQueryRelate5FRFFR<>(factory, sqlPageFactory, queryRelation), factory, queryRelation,
                joinType, 0);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5FRFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R1, R3, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R1, R3, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R3, R4>>,
        ...
        return (RE) new EntitySqlQueryRelate5FRFFR<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5FRFFP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R1, R3, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R1, R3, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R3, R4>>,
        ...
        return (RE) new EntitySqlQueryRelate5FRFFP<>(factory, sqlPageFactory, queryRelation);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5FRFFP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5FRFFP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5FRFFP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5FRFFP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
    ...
    @SuppressWarnings("unchecked")
    @Override
    public <RE extends EntityQueryRelateExpression5FRFFP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
