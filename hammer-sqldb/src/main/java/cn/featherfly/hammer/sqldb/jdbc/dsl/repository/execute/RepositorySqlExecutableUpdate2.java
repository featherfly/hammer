...
import cn.featherfly.hammer.sqldb.jdbc.dsl.repository.RepositorySqlOn2;
...
public class RepositorySqlExecutableUpdate2 implements RepositorySqlUpdate2, RepositoryExecutableUpdate2 {
     ...
     */
    @Override
    public <N extends Number> RepositorySqlExecutableUpdate2 increase(SerializableSupplier<N> property) {
     ...
     */
    @Override
    public UpdateValueExpression<Object, RepositoryExecutableUpdate2,
    ...
    @Override
    public <T,
        R> UpdateValueExpression<R, RepositoryExecutableUpdate2,
            RepositoryExecutableConditionsGroup2<UpdateConditionConfig>,
