...
import cn.featherfly.hammer.expression.repository.condition.ba.RepositoryBetweenExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.co.RepositoryContainsExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.eq.RepositoryEqualsExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.ew.RepositoryEndWithExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.ge.RepositoryGreatEqualsExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.gt.RepositoryGreatThanExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.in.RepositoryInExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.inn.RepositoryIsNotNullExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.isn.RepositoryIsNullExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.le.RepositoryLessEqualsExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.lk.RepositoryLikeExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.lt.RepositoryLessThanExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.nba.RepositoryNotBetweenExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.nco.RepositoryNotContainsExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.ne.RepositoryNotEqualsExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.newv.RepositoryNotEndWithExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.ni.RepositoryNotInExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.nl.RepositoryNotLikeExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.nsw.RepositoryNotStartWithExpressionBase3;
import cn.featherfly.hammer.expression.repository.condition.sw.RepositoryStartWithExpressionBase3;
...
public abstract class AbstractMulitiRepositorySqlConditionsGroupExpressionBase3<C extends GroupExpression<C, L>,
        L extends GroupEndExpression<C, L>, C3 extends ConditionConfig<C3>, S extends RepositorySqlRelation<S, B>,
        B extends SqlBuilder> extends AbstractMulitiRepositorySqlConditionsGroupExpressionBase2<C, L, C3, S, B>
...
/*, RepositoryFieldExpression<C, L>*/ {
    ...
    protected AbstractMulitiRepositorySqlConditionsGroupExpressionBase3(L parent, int index, S repositoryRelation,
        ...
        repositoryAlias3 = repositoryRelation.getRepositoryRelation(1).getRepositoryAlias();
    }
    ...
    public L eq3(String name, char value, CharPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((char) v), repositoryAlias3);
    }
    ...
    public L eq3(String name, int value, IntPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((int) v), repositoryAlias3);
    }
    ...
    public L eq3(String name, long value, LongPredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((long) v), repositoryAlias3);
    }
    ...
    public L eq3(String name, double value, DoublePredicate ignoreStrategy) {
        return eq(name, value, v -> ignoreStrategy.test((double) v), repositoryAlias3);
    }
     ...
     */
    @Override
    public L eq3(String name, Object value) {
        return eq3(name, value, getIgnoreStrategy());
    }
     ...
     */
    @Override
    public <R> L eq3(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public L ne3(String name, Object value) {
        return ne(name, value, getIgnoreStrategy(), repositoryAlias3);
    }
     ...
     */
    @Override
    public <R> L ne3(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L in3(String name, @SuppressWarnings("unchecked") R... values) {
        return in(name, values, getIgnoreStrategy(), repositoryAlias3);
    }
     ...
     */
    @Override
    public <R> L in3(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <R> L ni3(String name, @SuppressWarnings("unchecked") R... values) {
        return ni(name, values, getIgnoreStrategy(), repositoryAlias3);
    }
     ...
     */
    @Override
    public <R> L ni3(String name, R value, Predicate<R> ignoreStrategy) {
