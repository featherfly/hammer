...
/**
 * The Class AbstractNotBetweenRepositoryExpression.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public abstract class AbstractNotBetweenRepositoryExpression<C extends ConditionExpression,
    L extends LogicExpression<C, L>>
    extends AbstractRepositoryIndexableConditionExpression<MulitiNotBetweenExpression<C, L>>
    implements NotBetweenRepositoryExpression {

    /**
     * Instantiates a new abstract not between repository expression.
     *
     * @param index          the index
     * @param expression     the expression
     * @param ignoreStrategy the ignore strategy
     */
    protected AbstractNotBetweenRepositoryExpression(int index, MulitiNotBetweenExpression<C, L> expression,
