 ...
 */
public abstract class AbstractInRepositoryExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends AbstractRepositoryIndexableConditionExpression<MulitiInExpression<C, L>> implements InRepositoryExpression {
     ...
     */
    protected AbstractInRepositoryExpression(int index, MulitiInExpression<C, L> expression,
