...
public class SetIntExpression2Impl implements SetIntExpression2 {
    ...
    private FoConsumer<Integer, Integer, BiPredicate<Integer, Integer>, PropertyMapping<?>> setValue;
    ...
    public SetIntExpression2Impl(Function<Integer, PropertyMapping<?>> propertyMapping, Predicate<?> ignoreStrategy,
            FoConsumer<Integer, Integer, BiPredicate<Integer, Integer>, PropertyMapping<?>> setValue) {
        super();
