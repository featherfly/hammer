 ...
 * @author zhongj
 */
public class AggregatedAliasedDistinctedFieldImpl extends AbstractFetchField<AggregateFunction>
        implements AggregatedAliasedDistinctedField {
     ...
     */
    public AggregatedAliasedDistinctedFieldImpl(int index, BiConsumer<Integer, QueryableField> consumer,
