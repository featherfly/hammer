...
/**
 * The Class AbstractGreatEqualsRepositoryExpression.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public abstract class AbstractGreatEqualsRepositoryExpression<C extends ConditionExpression,
    L extends LogicExpression<C, L>>
    extends AbstractRepositoryIndexableConditionExpression<MulitiGreatEqualsExpression<C, L>>
    implements GreatEqualsRepositoryExpression {
    ...
    public void accept(String name, String value, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        expression.ge(index, name, value, matchStrategy, ignoreStrategy);
    }
    ...
    public SetIntExpression fieldAsInt(final String name) {
        return new SetIntExpressionImpl(ignoreStrategy, (value, ignore) -> expression.ge(index, name, value, ignore));
    }
    ...
    public SetLongExpression fieldAsLong(String name) {
        return new SetLongExpressionImpl(ignoreStrategy, (value, ignore) -> expression.ge(index, name, value, ignore));
    }
    ...
    public SetDoubleExpression fieldAsDouble(String name) {
        return new SetDoubleExpressionImpl(ignoreStrategy,
            (value, ignore) -> expression.ge(index, name, value, ignore));
    }
    ...
    public SetLocalDateTimeExpression fieldAsLocalDateTime(String name) {
        return new SetLocalDateTimeExpressionImpl(ignoreStrategy, (value, ignore) -> accept(name, value, ignore));
    }
    ...
    public SetStringExpression fieldAsString(String name) {
        return new SetStringExpressionImpl(ignoreStrategy,
            (value, match, ignore) -> expression.ge(index, name, value, match, ignore));
    }
}
