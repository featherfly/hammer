 ...
 * @author zhongj
 */
public class NamedFieldImpl extends AbstractFetchField<Function> implements NamedField {
     ...
     * @param name     the name
     */
    public NamedFieldImpl(int index, BiConsumer<Integer, QueryableField> consumer, String name) {
