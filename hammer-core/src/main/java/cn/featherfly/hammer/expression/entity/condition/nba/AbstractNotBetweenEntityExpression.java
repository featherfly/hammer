...
public abstract class AbstractNotBetweenEntityExpression<T, C extends ConditionExpression,
        ...
        extends AbstractEntityIndexableConditionExpression<MulitiNotBetweenExpression<C, L>>
     ...
     */
    protected AbstractNotBetweenEntityExpression(int index, MulitiNotBetweenExpression<C, L> expression,
