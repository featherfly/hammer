...
public abstract class AbstractEqualsEntityExpression<E, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractEntityIndexableConditionExpression<MulitiEqualsExpression<C, L>>
     ...
     */
    protected AbstractEqualsEntityExpression(int index, MulitiEqualsExpression<C, L> expression,
