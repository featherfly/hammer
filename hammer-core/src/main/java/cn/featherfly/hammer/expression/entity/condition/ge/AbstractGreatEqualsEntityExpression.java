 ...
 */
public abstract class AbstractGreatEqualsEntityExpression<T, C extends ConditionExpression,
        L extends LogicExpression<C, L>>
        extends AbstractEntityIndexableConditionExpression<MulitiGreatEqualsExpression<C, L>>
        implements GreatEqualsEntityExpression<T> {
     ...
     */
    protected AbstractGreatEqualsEntityExpression(int index, MulitiGreatEqualsExpression<C, L> expression,
    ...
    public void accept(SerializableToStringFunction<T> name, String value, MatchStrategy matchStrategy) {
        expression.ge(index, name, value, matchStrategy);
    }
    ...
    public void accept(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        expression.ge(index, property, matchStrategy);
    }
