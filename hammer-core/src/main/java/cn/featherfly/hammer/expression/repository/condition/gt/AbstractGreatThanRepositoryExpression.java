...
/**
 * The Class AbstractGreatThanRepositoryExpression.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public abstract class AbstractGreatThanRepositoryExpression<C extends ConditionExpression,
    L extends LogicExpression<C, L>>
    extends AbstractRepositoryIndexableConditionExpression<MulitiGreatThanExpression<C, L>>
    implements GreatThanRepositoryExpression {
    ...
    public SetIntExpression fieldAsInt(final String name) {
        return new SetIntExpressionImpl(ignoreStrategy, (value, ignore) -> expression.gt(index, name, value, ignore));
    }
    ...
    public SetLongExpression fieldAsLong(String name) {
        return new SetLongExpressionImpl(ignoreStrategy, (value, ignore) -> expression.gt(index, name, value, ignore));
    }
    ...
    public SetDoubleExpression fieldAsDouble(String name) {
        return new SetDoubleExpressionImpl(ignoreStrategy,
            (value, ignore) -> expression.gt(index, name, value, ignore));
    }
    ...
    public SetStringExpression fieldAsString(String name) {
        return new SetStringExpressionImpl(ignoreStrategy,
            (value, match, ignore) -> expression.gt(index, name, value, match, ignore));
    }
