...
public abstract class AbstractIsNotNullEntityExpression<E, C extends ConditionExpression,
        ...
        extends AbstractEntityIndexableConditionExpression<MulitiIsNotNullExpression<C, L>>
     ...
     */
    protected AbstractIsNotNullEntityExpression(int index, MulitiIsNotNullExpression<C, L> expression,
