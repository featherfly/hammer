...
/**
 * The Class AbstractLessThanRepositoryExpression.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public abstract class AbstractLessThanRepositoryExpression<C extends ConditionExpression,
    L extends LogicExpression<C, L>>
    extends AbstractRepositoryIndexableConditionExpression<MulitiLessThanExpression<C, L>>
    implements LessThanRepositoryExpression {

    /**
     * Instantiates a new abstract less than repository expression.
     *
     * @param index the index
     * @param expression the expression
     * @param ignoreStrategy the ignore strategy
     */
    protected AbstractLessThanRepositoryExpression(int index, MulitiLessThanExpression<C, L> expression,
    ...
    public void accept(SerializableIntSupplier property, int value, IntPredicate ignoreStrategy) {
        expression.lt(index, property, value, ignoreStrategy);
    }
    ...
    public void accept(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        expression.lt(index, property, value, matchStrategy, ignoreStrategy);
    }
    ...
    public SetIntExpression fieldAsInt(final String name) {
        return new SetIntExpressionImpl(ignoreStrategy, (value, ignore) -> expression.lt(index, name, value, ignore));
    }
    ...
    public SetLongExpression fieldAsLong(String name) {
        return new SetLongExpressionImpl(ignoreStrategy, (value, ignore) -> expression.lt(index, name, value, ignore));
    }
    ...
    public SetDoubleExpression fieldAsDouble(String name) {
        return new SetDoubleExpressionImpl(ignoreStrategy,
            (value, ignore) -> expression.lt(index, name, value, ignore));
    }
    ...
    public SetStringExpression fieldAsString(String name) {
        return new SetStringExpressionImpl(ignoreStrategy,
            (value, match, ignore) -> expression.lt(index, name, value, match, ignore));
    }
}
