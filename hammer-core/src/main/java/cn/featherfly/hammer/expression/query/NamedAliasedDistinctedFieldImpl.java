 ...
 * @author zhongj
 */
public class NamedAliasedDistinctedFieldImpl extends AbstractFetchField<Function>
        implements NamedAliasedDistinctedField {
     ...
     */
    public NamedAliasedDistinctedFieldImpl(int index, BiConsumer<Integer, QueryableField> consumer, String name,
