 ...
 */
public class PrefixedBeanMapper4Impl<E1 extends ExecutionExecutorEx<E2>, E2, T1, T2, T3, T4>
     ...
     */
    public PrefixedBeanMapper4Impl(E1 executor, E2 execution, Map<String, Serializable> params, Class<T1> type1,
     ...
     */
    @Override
    public AutoCloseableIterable<Tuple4<T1, T2, T3, T4>> each() {
        if (params instanceof Map) {
     ...
     */
    @Override
    public AutoCloseableIterable<Tuple4<T1, T2, T3, T4>> each(int offset, int limit) {
        if (params instanceof Map) {
