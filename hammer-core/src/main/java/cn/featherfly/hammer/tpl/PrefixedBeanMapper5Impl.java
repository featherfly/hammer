 ...
 */
public class PrefixedBeanMapper5Impl<E1 extends ExecutionExecutorEx<E2>, E2, T1, T2, T3, T4, T5>
    extends AbstractPrefixEntityMapper<E1, E2, Object, Tuple5<String, String, String, String, String>>
    implements PrefixedBeanMapper5<T1, T2, T3, T4, T5> {
     ...
     */
    public PrefixedBeanMapper5Impl(E1 executor, E2 execution, Map<String, Serializable> params, Class<T1> type1,
     ...
     * @param type5 the type 5
     */
    public PrefixedBeanMapper5Impl(E1 executor, E2 execution, Object[] params, Class<T1> type1, Class<T2> type2,
     ...
     */
    @Override
    public AutoCloseableIterable<Tuple5<T1, T2, T3, T4, T5>> each() {
        if (params instanceof Map) {
     ...
     */
    @Override
    public AutoCloseableIterable<Tuple5<T1, T2, T3, T4, T5>> each(int offset, int limit) {
        if (params instanceof Map) {
    ...
    public <T6> PrefixedBeanMapper6<T1, T2, T3, T4, T5, T6> map(String prefix, Class<T6> type) {
        if (params instanceof Map) {
            return new PrefixedBeanMapper6Impl<>(executor, execution, getParamsMap(), type1, type2, type3, type4, type5,
                type,
                Tuples.of(prefixes.get0(), prefixes.get1(), prefixes.get2(), prefixes.get3(), prefixes.get4(), prefix));
        } else {
            return new PrefixedBeanMapper6Impl<>(executor, execution, getParams(), type1, type2, type3, type4, type5,
                type,
                Tuples.of(prefixes.get0(), prefixes.get1(), prefixes.get2(), prefixes.get3(), prefixes.get4(), prefix));
        }
    }
