...
public class PrefixedBeanMapper6Impl<E1 extends ExecutionExecutorEx<E2>, E2, T1, T2, T3, T4, T5, T6>
     ...
     */
    public PrefixedBeanMapper6Impl(E1 executor, E2 execution, Map<String, Serializable> params, Class<T1> type1,
     ...
     * @param type6 the type 6
     */
    public PrefixedBeanMapper6Impl(E1 executor, E2 execution, Object[] params, Class<T1> type1, Class<T2> type2,
