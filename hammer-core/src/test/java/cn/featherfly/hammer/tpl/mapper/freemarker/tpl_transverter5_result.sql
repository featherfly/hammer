...
<@where>
<@and if=birthday?? && birthday?length gt 0 name="birthday"> DATE_FORMAT(birthday,'%Y-%M-%D') = :birthday</@and>
<@or if=birthday?? && birthday?length gt 0 name="birthday">DATE_FORMAT(birthday,"%Y-%M-%D") = :birthday</@or>
<@or if=name?? && name?length gt 0 name="name">name like :name</@or>
