...
public class TMapperImpl extends BasedTplHammer implements TMapper {
     ...
     */
    public int count() {
        return hammer.intValue(new TplExecuteIdFileImpl("count", "TMapper"), new ChainMapImpl<String, Object>());
    }
    ...
    public List<User> findUsers(String name, Page page) {
        return hammer.list(new TplExecuteIdFileImpl("findUsers", "namespace"), User.class,
                new ChainMapImpl<String, Object>(), page);
    }

    public void update() {
        hammer.execute(new TplExecuteIdFileImpl("update", "namespace"), new ChainMapImpl<String, Object>());
    }
    ...
    public Map<String, Object> getMap() {
        return hammer.single(new TplExecuteIdFileImpl("getMap", "namesapce"), new ChainMapImpl<String, Object>());
    }

    public Map<String, Object> getMap(String username, String password, Integer age) {
        return hammer.single(new TplExecuteIdFileImpl("getMap_3", "namesapce"), new ChainMapImpl<String, Object>()
    ...
    public String getName() {
        return hammer.string(new TplExecuteIdFileImpl("getName", "namesapce"), new ChainMapImpl<String, Object>());
    }
    ...
    public int getInt() {
        return hammer.intValue(new TplExecuteIdFileImpl("getInt", "namesapce"), new ChainMapImpl<String, Object>());
    }
    ...
    public long getLong() {
        return hammer.longValue(new TplExecuteIdFileImpl("getLong", "namesapce"), new ChainMapImpl<String, Object>());
    }
    ...
    public double getDouble() {
        return hammer.doubleValue(new TplExecuteIdFileImpl("getLong", "namesapce"), new ChainMapImpl<String, Object>());
    }
    ...
    public List<Map<String, Object>> findMapList() {
        return hammer.list(new TplExecuteIdFileImpl("findMapList", "namesapce"), new ChainMapImpl<String, Object>());
    }
    ...
    public PaginationResults<User> findUserLimit(int offset, int limit) {
        return hammer.pagination(new TplExecuteIdFileImpl("findUserLimit", "namesapce"), User.class,
                new ChainMapImpl<String, Object>(), offset, limit);
    }
