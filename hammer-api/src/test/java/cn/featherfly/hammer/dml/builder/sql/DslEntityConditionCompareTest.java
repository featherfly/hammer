...
public class DslEntityConditionCompareTest {
    ...
    public void testEntityQueryJoinConditionGe() {
        ...
        query.find(UserInfo.class).join(User::getUserInfo).where().ge(es -> es.get0().property(UserInfo::getUser)
                .property(User::getUserInfo).property(UserInfo::getId).value(1)).list();
    ...
    public void testEntityQueryJoinConditionGt() {
        ...
        query.find(UserInfo.class).join(User::getUserInfo).where().gt(es -> es.get0().property(UserInfo::getUser)
                .property(User::getUserInfo).property(UserInfo::getId).value(1)).list();
    ...
    public void testEntityQueryJoinConditionLe() {
        ...
        query.find(UserInfo.class).join(User::getUserInfo).where().le(es -> es.get0().property(UserInfo::getUser)
                .property(User::getUserInfo).property(UserInfo::getId).value(1)).list();
    ...
    public void testEntityQueryJoinConditionLt() {
        ...
        query.find(UserInfo.class).join(User::getUserInfo).where().lt(es -> es.get0().property(UserInfo::getUser)
                .property(User::getUserInfo).property(UserInfo::getId).value(1)).list();
