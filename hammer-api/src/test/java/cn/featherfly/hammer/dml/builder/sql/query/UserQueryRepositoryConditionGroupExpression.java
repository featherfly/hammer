...
public class UserQueryRepositoryConditionGroupExpression implements
     ...
     */
    @Override
    public UserQueryRepositoryConditionGroupExpression in(String name, Object... values) {
     ...
     */
    @Override
    public <R> UserQueryRepositoryConditionGroupExpression in(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public UserQueryRepositoryConditionGroupExpression ni(String name, Object... values) {
     ...
     */
    @Override
    public <R> UserQueryRepositoryConditionGroupExpression ni(String name, R value, Predicate<R> ignoreStrategy) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression in(SerializableToIntFunction<T> name, int... values) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression in(SerializableToLongFunction<T> name, long... values) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression in(SerializableToDoubleFunction<T> name, double... values) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression in(SerializableToStringFunction<T> name, String[] values,
            MatchStrategy matchStrategy) {
     ...
     */
    @Override
    public <T, R> UserQueryRepositoryConditionGroupExpression in(SerializableFunction<T, R> name,
     ...
     */
    @Override
    public <T, R> UserQueryRepositoryConditionGroupExpression in(SerializableFunction<T, R> name, R[] value,
            Predicate<R[]> ignoreStrategy) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression ni(SerializableToIntFunction<T> name, int... values) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression ni(SerializableToLongFunction<T> name, long... values) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression ni(SerializableToDoubleFunction<T> name, double... values) {
     ...
     */
    @Override
    public <T> UserQueryRepositoryConditionGroupExpression ni(SerializableToStringFunction<T> name, String[] values,
            MatchStrategy matchStrategy) {
     ...
     */
    @Override
    public <T, R> UserQueryRepositoryConditionGroupExpression ni(SerializableFunction<T, R> name,
            @SuppressWarnings("unchecked") R... value) {
     ...
     */
    @Override
    public <T, R> UserQueryRepositoryConditionGroupExpression ni(SerializableFunction<T, R> name, R[] value,
            Predicate<R[]> ignoreStrategy) {
