...
public interface GreatThanSupplierExpression6<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends GreatThanSupplierExpression5<C, L> {
    /**
     * great than. 大于.
     *
     ...
     * @return LogicExpression
     */
    <E extends Enum<E>> L gt6(SerializableEnumSupplier<E> property, Predicate<E> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <N extends Number> L gt6(SerializableNumberSupplier<N> property);
    ...
    default <N extends Number> L gt6(SerializableNumberSupplier<N> property, IgnoreStrategy ignoreStrategy) {
        return gt6(property, (Predicate<N>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    <N extends Number> L gt6(SerializableNumberSupplier<N> property, Predicate<N> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <D extends Date> L gt6(SerializableDateSupplier<D> property);
    ...
    default <D extends Date> L gt6(SerializableDateSupplier<D> property, IgnoreStrategy ignoreStrategy) {
        return gt6(property, (Predicate<D>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    <D extends Date> L gt6(SerializableDateSupplier<D> property, Predicate<D> ignoreStrategy);
    ...
    default L gt6(SerializableLocalTimeSupplier property, IgnoreStrategy ignoreStrategy) {
        return gt6(property, (Predicate<LocalTime>) ignoreStrategy::test);
    }
    ...
    default L gt6(SerializableLocalDateSupplier property, IgnoreStrategy ignoreStrategy) {
        return gt6(property, (Predicate<LocalDate>) ignoreStrategy::test);
    }
    ...
    default L gt6(SerializableLocalDateTimeSupplier property, IgnoreStrategy ignoreStrategy) {
        return gt6(property, (Predicate<LocalDateTime>) ignoreStrategy::test);
    }
    ...
    default L gt6(SerializableStringSupplier property) {
        return gt6(property, MatchStrategy.AUTO);
    }
    ...
    default L gt6(SerializableStringSupplier property, IgnoreStrategy ignoreStrategy) {
        return gt6(property, MatchStrategy.AUTO, ignoreStrategy);
    }
    ...
    default L gt6(SerializableStringSupplier property, MatchStrategy matchStrategy, IgnoreStrategy ignoreStrategy) {
        return gt6(property, matchStrategy, (Predicate<String>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    L gt6(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
}