 ...
 */
public interface EntityQueryRelatedFetchedExpression1P<E, R1,
        ...
        S extends EntityQuerySortExpression2<E, R1, E>> extends EntityQueryRelateExpression1XBase<E, R1, C, L, S> {
}
