...
public interface EntityNotEqualsExpressionBase6<E, E2, E3, E4, E5, E6, C extends ConditionExpression,
    ...
    default <R> L ne6(SerializableFunction<E6, R> name, R value) {
        return ne6(name, value, QueryPolicy.AUTO);
    }
    ...
    default <R> L ne6(SerializableFunction<E6, R> name, R value, Predicate<R> ignoreStrategy) {
        return ne6(name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    <R> L ne6(SerializableFunction<E6, R> name, R value, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L ne6(SerializableFunction<E6, R> name, R value, QueryPolicy queryPolicy, Predicate<R> ignoreStrategy);
    ...
    default <R> L ne6(SerializableSupplier6<R> property) {
        return ne6(property, QueryPolicy.AUTO);
    }
    ...
    default <R> L ne6(SerializableSupplier6<R> property, Predicate<R> ignoreStrategy) {
        return ne6(property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    <R> L ne6(SerializableSupplier6<R> property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L ne6(SerializableSupplier6<R> property, QueryPolicy queryPolicy, Predicate<R> ignoreStrategy);
