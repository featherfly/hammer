...
public interface EntityStartWithExpressionBase5<E, E2, E3, E4, E5, C extends ConditionExpression,
    ...
    default L sw5(SerializableFunction<E5, String> name, String value) {
        return sw5(name, value, QueryPolicy.AUTO);
    }
    ...
    default L sw5(SerializableFunction<E5, String> name, String value, Predicate<String> ignoreStrategy) {
        return sw5(name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L sw5(SerializableFunction<E5, String> name, String value, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    default L sw5(StringSupplier property) {
        return sw5(property, QueryPolicy.AUTO);
    }
     ...
     * @return LogicExpression
     */
    default L sw5(StringSupplier property, Predicate<String> ignoreStrategy) {
        return sw5(property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L sw5(StringSupplier property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L sw5(StringSupplier property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
