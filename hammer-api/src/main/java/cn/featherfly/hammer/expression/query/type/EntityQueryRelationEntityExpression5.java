 ...
 */
public interface EntityQueryRelationEntityExpression5<E, R1, R2, R3, R4, R5,
        ...
        extends EntityWhereExpression<E, C, L>, EntityQueryRelationExpression5<E, R1, R2, R3, R4, R5, Q, C, L> {
