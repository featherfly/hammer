...
public interface EqualsExpression5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends EqualsExpression4<C, L>, EqualsSupplierExpression5<C, L> {
    /**
     * equals. 等于.
     *
     ...
     * @return LogicExpression
     */
    L eq5(String name, Object value);
     ...
     * @return LogicExpression
     */
    default <R> L eq5(String name, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L eq5(String name, R value, Predicate<R> ignoreStrategy);
    // ----------------------------------------------------------------------------------------------------------------
     ...
     * @return LogicExpression
     */
    default L eq5(Field field, Object value) {
        return eq5(field.name(), value);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq5(Field field, R value, IgnoreStrategy ignoreStrategy) {
        return eq5(field.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq5(Field field, R value, Predicate<R> ignoreStrategy) {
        return eq5(field.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L eq5(AliasField field, Object value) {
        return eq5(field.getAliasOrName(), value);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq5(AliasField field, R value, IgnoreStrategy ignoreStrategy) {
        return eq5(field.getAliasOrName(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq5(AliasField field, R value, Predicate<R> ignoreStrategy) {
        return eq5(field.getAliasOrName(), value, ignoreStrategy);
    }
}