...
public interface RepositoryNotBetweenExpression3<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L nba(Consumer<Tuple3<NotBetweenRepositoryExpression, NotBetweenRepositoryExpression,
     ...
     * @return the LogicExpression
     */
    L nba(ThreeArgusConsumer<NotBetweenRepositoryExpression, NotBetweenRepositoryExpression,
        NotBetweenRepositoryExpression> notBetweenExpressions);
}