...
public interface MulitiEntityLikeExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default <E> L lk(int index, SerializableFunction<E, String> name, String value) {
        return lk(index, name, value, QueryPolicy.AUTO);
    }
    ...
    default <E> L lk(int index, SerializableFunction<E, String> name, String value, Predicate<String> ignoreStrategy) {
        return lk(index, name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return the l
     */
    <E> L lk(int index, SerializableFunction<E, String> name, String value, QueryPolicy queryPolicy);
    ...
    default L lk(int index, SerializableSupplier<String> property) {
        return lk(index, property, QueryPolicy.AUTO);
    }
    ...
    default L lk(int index, SerializableSupplier<String> property, Predicate<String> ignoreStrategy) {
        return lk(index, property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return the l
     */
    L lk(int index, SerializableSupplier<String> property, QueryPolicy queryPolicy);
     ...
     * @return the l
     */
    L lk(int index, SerializableSupplier<String> property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
