...
//import cn.featherfly.hammer.expression.EntityConditionGroupLogicExpression6;
//
///**
// * The Interface TypeQueryWithExpression5.
// *
// * @author zhongj
...
// */
//public interface EntityQueryRelationExpression5<E, R1, R2, R3, R4, R5,
//        C extends EntityConditionGroupExpression6<E, R1, R2, R3, R4, R5, C, L>,
//        L extends EntityConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, C, L>, R>
//        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, R> {
//
//    //    /**
//    //     * relate to.
//    //     *
...
//    //     */
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate(SerializableFunction<E, R6> propertyName) {
...
//    //     * @return TypeQueryWithOnExpression
//    //     */
//    //    <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate(SerializableFunction2<R6, E> propertyName) {
//    //        return join(propertyName);
//    //    }
//    //
//    //    /**
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate1(SerializableFunction<R1, R6> propertyName) {
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate1(SerializableFunction2<R6, R1> propertyName) {
//    //        return join1(propertyName);
//    //    }
//    //
//    //    /**
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate2(SerializableFunction<R2, R6> propertyName) {
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate2(SerializableFunction2<R6, R2> propertyName) {
//    //        return join2(propertyName);
//    //    }
//    //
//    //    /**
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate3(SerializableFunction<R3, R6> propertyName) {
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate3(SerializableFunction2<R6, R3> propertyName) {
//    //        return join3(propertyName);
//    //    }
//    //
//    //    /**
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate4(SerializableFunction<R4, R6> propertyName) {
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate4(SerializableFunction2<R6, R4> propertyName) {
//    //        return join4(propertyName);
//    //    }
//    //
//    //    /**
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate5(SerializableFunction<R5, R6> propertyName) {
...
//    //    default <RE extends EntityQueryRelationEntityExpression6<E, R1, R2, R3, R4, R5, R6, Q, QR, C, L>,
//    //            QR extends EntityQueryRelationExpression6<E, R1, R2, R3, R4, R5, R6, Q, C, L>,
//    //            R6> RE relate5(SerializableFunction2<R6, R5> propertyName) {
//    //        return join5(propertyName);
//    //    }
//    //
//    //    /**
