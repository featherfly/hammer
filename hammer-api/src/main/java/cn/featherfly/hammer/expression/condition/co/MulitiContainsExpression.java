...
public interface MulitiContainsExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L co(int index, SerializableSupplier<String> property, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L co(int index, SerializableSupplier<String> property, MatchStrategy matchStrategy,
            IgnoreStrategy ignoreStrategy) {
