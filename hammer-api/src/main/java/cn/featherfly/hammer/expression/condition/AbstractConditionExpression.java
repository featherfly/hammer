 ...
 */
public class AbstractConditionExpression<E extends MulitiConditionExpression> {
     ...
     */
    protected AbstractConditionExpression(int index, E expression, Predicate<?> ignoreStrategy) {
        super();
        this.index = index;
