...
public interface EntityEqualsExpressionBase2<E, E2, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default <R> L eq2(SerializableFunction<E2, R> name, R value) {
        return eq2(name, value, QueryPolicy.AUTO);
    }
    ...
    default <R> L eq2(SerializableFunction<E2, R> name, R value, Predicate<R> ignoreStrategy) {
        return eq2(name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    <R> L eq2(SerializableFunction<E2, R> name, R value, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L eq2(SerializableFunction<E2, R> name, R value, QueryPolicy queryPolicy, Predicate<R> ignoreStrategy);
    ...
    default <R> L eq2(SerializableSupplier2<R> property) {
        return eq2(property, QueryPolicy.AUTO);
    }
    ...
    default <R> L eq2(SerializableSupplier2<R> property, Predicate<R> ignoreStrategy) {
        return eq2(property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    <R> L eq2(SerializableSupplier2<R> property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L eq2(SerializableSupplier2<R> property, QueryPolicy queryPolicy, Predicate<R> ignoreStrategy);
