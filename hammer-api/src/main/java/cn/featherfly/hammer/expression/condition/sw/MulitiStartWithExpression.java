...
public interface MulitiStartWithExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L sw(int index, SerializableStringSupplier property) {
     ...
     * @return LogicExpression
     */
    L sw(int index, SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    default L sw(int index, SerializableStringSupplier property, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L sw(int index, SerializableStringSupplier property, Predicate<String> ignoreStrategy) {
        return sw(index, property, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L sw(int index, SerializableStringSupplier property, MatchStrategy matchStrategy,
        IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    L sw(int index, SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
}