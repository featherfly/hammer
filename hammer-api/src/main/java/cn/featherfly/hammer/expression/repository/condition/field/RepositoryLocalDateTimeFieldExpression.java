...
/**
 * RepositoryLocalDateTimeFieldExpression.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public interface RepositoryLocalDateTimeFieldExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends LocalDateTimeFieldExpression<C, L>, FieldAware<RepositoryAwareField<AliasRepository>> {
