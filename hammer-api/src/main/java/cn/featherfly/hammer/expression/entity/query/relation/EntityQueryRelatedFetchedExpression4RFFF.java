...
public interface EntityQueryRelatedFetchedExpression4RFFF<E, R1, R2, R3, R4,
     ...
     * @return EntityQueryRelateExpression5RFFFR
     */
    <QR extends EntityQueryRelateExpression5RFFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RFFFR
     */
    <RE extends EntityQueryRelateExpression5RFFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R2, R3, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R2, R3, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R2, R3, R4>>,
     ...
     * @param <R5>         the generic type
     * @param propertyName find type object property name
     * @return EntityQueryRelateExpression5RFFFP
     */
    <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple4<E, R2, R3, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS,
                    Tuple4<E, R2, R3, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R2, R3, R4>>,
     ...
     * @return EntityQueryRelateExpression5RFFFP
     */
    <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFFFP
     */
    <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFFFP
     */
    <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFFFP
     */
    <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFFFP
     */
    <RE extends EntityQueryRelateExpression5RFFFP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
