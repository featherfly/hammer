...
public interface EntityGreatThanExpressoin<E, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L gt(Consumer<EntityGreatThanExpressoin<E, C, L>> consumer);
     ...
     * @return LogicExpression
     */
    <N extends Number> L gt(SerializableFunction<E, N> name, N value, Predicate<N> ignorePolicy);
     ...
     * @return LogicExpression
     */
    <D extends Date> L gt(SerializableFunction<E, D> name, D value, Predicate<D> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(SerializableFunction<E, LocalTime> name, LocalTime value, Predicate<LocalTime> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(SerializableFunction<E, LocalDate> name, LocalDate value, Predicate<LocalDate> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(SerializableFunction<E, LocalDateTime> name, LocalDateTime value, Predicate<LocalDateTime> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(SerializableFunction<E, String> name, String value, Predicate<String> ignorePolicy);
     ...
     * @return LogicExpression
     */
    <R extends Number> L gt(NumberSupplier<R> property, Predicate<R> ignorePolicy);
     ...
     * @return LogicExpression
     */
    <R extends Date> L gt(DateSupplier<R> property, Predicate<R> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(LocalDateSupplier property, Predicate<LocalDate> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(LocalTimeSupplier property, Predicate<LocalTime> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(LocalDateTimeSupplier property, Predicate<LocalDateTime> ignorePolicy);
     ...
     * @return LogicExpression
     */
    L gt(StringSupplier property, Predicate<String> ignorePolicy);
