...
public interface RepositoryLikeExpressionBase6<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L lk6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return lk6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L lk6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return lk6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}