...
public interface RepositoryLessThanExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    @Override
    default L lt3(SerializableIntSupplier property, int value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt3(SerializableIntSupplier property, int value, IntPredicate ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt3(SerializableLongSupplier property, long value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt3(SerializableLongSupplier property, long value, LongPredicate ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt3(SerializableDoubleSupplier property, double value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt3(SerializableDoubleSupplier property, double value, DoublePredicate ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default <E extends Enum<E>> L lt3(SerializableEnumSupplier<E> property, E value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <E extends Enum<E>> L lt3(SerializableEnumSupplier<E> property, E value, Predicate<E> ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default <N extends Number> L lt3(SerializableNumberSupplier<N> property, N value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <N extends Number> L lt3(SerializableNumberSupplier<N> property, N value, Predicate<N> ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default <D extends Date> L lt3(SerializableDateSupplier<D> property, D value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <D extends Date> L lt3(SerializableDateSupplier<D> property, D value, Predicate<D> ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt3(SerializableLocalTimeSupplier property, LocalTime value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt3(SerializableLocalTimeSupplier property, LocalTime value, Predicate<LocalTime> ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt3(SerializableLocalDateSupplier property, LocalDate value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt3(SerializableLocalDateSupplier property, LocalDate value, Predicate<LocalDate> ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt3(SerializableLocalDateTimeSupplier property, LocalDateTime value) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value);
    }
    ...
    default L lt3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }
    ...
    default L lt3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return lt3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}