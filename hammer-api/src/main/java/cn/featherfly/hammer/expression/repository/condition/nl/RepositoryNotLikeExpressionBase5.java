...
public interface RepositoryNotLikeExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryNotLikeExpressionBase4<C, L>, NotLikeExpression5<C, L> {
    ...
    @Override
    default L nl5(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return nl5(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }

    @Override
    default L nl5(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return nl5(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
