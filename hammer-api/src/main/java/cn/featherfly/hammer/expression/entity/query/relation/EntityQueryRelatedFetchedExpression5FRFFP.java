...
/**
 * The Interface EntityQueryRelatedFetchedExpression5FRFFP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression5FRFFP<E, R1, R2, R3, R4, R5,
        ...
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple4<E, R1, R3, R4>> {
    // 目前就实现5次关联（join）
}
