...
public interface RepositoryLessThanExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    @Override
    default L lt2(SerializableIntSupplier property, int value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt2(SerializableIntSupplier property, int value, IntPredicate ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt2(SerializableLongSupplier property, long value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt2(SerializableLongSupplier property, long value, LongPredicate ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt2(SerializableDoubleSupplier property, double value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt2(SerializableDoubleSupplier property, double value, DoublePredicate ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default <E extends Enum<E>> L lt2(SerializableEnumSupplier<E> property, E value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <E extends Enum<E>> L lt2(SerializableEnumSupplier<E> property, E value, Predicate<E> ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default <N extends Number> L lt2(SerializableNumberSupplier<N> property, N value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <N extends Number> L lt2(SerializableNumberSupplier<N> property, N value, Predicate<N> ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default <D extends Date> L lt2(SerializableDateSupplier<D> property, D value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <D extends Date> L lt2(SerializableDateSupplier<D> property, D value, Predicate<D> ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt2(SerializableLocalTimeSupplier property, LocalTime value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt2(SerializableLocalTimeSupplier property, LocalTime value, Predicate<LocalTime> ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt2(SerializableLocalDateSupplier property, LocalDate value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L lt2(SerializableLocalDateSupplier property, LocalDate value, Predicate<LocalDate> ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L lt2(SerializableLocalDateTimeSupplier property, LocalDateTime value) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value);
    }
    ...
    default L lt2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }
    ...
    default L lt2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return lt2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}