 ...
 */
public interface RepositoryQueryWhereExpression5<C extends RepositoryQueryConditionsGroupExpression5<C, L, S, S2, Q>,
    ...
    Q extends LimitAwareQuery0<Map<String, Serializable>>> extends RepositoryWhereExpression5<C, L> {
