...
public interface NotEqualsExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default <R> L ne(String name, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L ne(String name, R value, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    default <R> L ne(Field field, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <R> L ne(AliasField field, R value, IgnoreStrategy ignoreStrategy) {
