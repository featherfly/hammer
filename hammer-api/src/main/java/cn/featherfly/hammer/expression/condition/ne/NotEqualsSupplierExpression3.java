...
public interface NotEqualsSupplierExpression3<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default <R> L ne3(SerializableSupplier<R> propertyValue, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy);
}