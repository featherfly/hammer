...
public abstract class AbstractNotLikeEntityExpression<E, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractConditionEntityExpression<MulitiEntityNotLikeExpression<C, L>>
     ...
     */
    protected AbstractNotLikeEntityExpression(int index, MulitiEntityNotLikeExpression<C, L> expression,
