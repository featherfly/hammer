...
public abstract class AbstractContainsEntityExpression<E, C extends ConditionExpression,
        L extends LogicExpression<C, L>> extends AbstractConditionEntityExpression<MulitiEntityContainsExpression<C, L>>
     ...
     */
    protected AbstractContainsEntityExpression(int index, MulitiEntityContainsExpression<C, L> expression,
