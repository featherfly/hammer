...
public interface EntityNotEqualsExpression2<E, E2, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    //     * @return LogicExpression
    //     */
    //    <R extends Serializable> L ne(Function<Tuple2<QueryEntityRepository<E>, QueryEntityRepository<E2>>, QueryEntityRepository<E>> entities,
    ...
    //     * @return LogicExpression
    //     */
    //    <R extends Serializable> L ne(Function<Tuple2<QueryEntityRepository<E>, QueryEntityRepository<E2>>, QueryEntityRepository<E2>> entities,
