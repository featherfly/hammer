...
public interface EntityGreatEqualsExpressionBase4<T, T2, T3, T4, C extends ConditionExpression,
     ...
     */
    L ge4(SerializableToIntFunction<T4> name, int value);
     ...
     * @return LogicExpression
     */
    L ge4(SerializableToIntFunction<T4> name, int value, IntPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ge4(SerializableToLongFunction<T4> name, long value);
     ...
     * @return LogicExpression
     */
    L ge4(SerializableToLongFunction<T4> name, long value, LongPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ge4(SerializableToDoubleFunction<T4> name, double value);
     ...
     * @return LogicExpression
     */
    L ge4(SerializableToDoubleFunction<T4> name, double value, DoublePredicate ignoreStrategy);
