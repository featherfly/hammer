...
public interface MulitiLikeExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L lk(int index, SerializableSupplier<String> property, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L lk(int index, SerializableSupplier<String> property, MatchStrategy matchStrategy,
            IgnoreStrategy ignoreStrategy) {
