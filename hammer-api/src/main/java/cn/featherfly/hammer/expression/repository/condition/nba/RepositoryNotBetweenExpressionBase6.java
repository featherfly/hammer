...
public interface RepositoryNotBetweenExpressionBase6<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    NotBetweenSupplierExpression6<C, L> {
    ...
    default <N extends Number> L nba6(SerializableNumberSupplier<N> property, N min, N max) {
        return nba6(LambdaUtils.getLambdaPropertyName(property), min, max);
    }

    @Override
    default <N extends Number> L nba6(SerializableNumberSupplier<N> property, N min, N max,
        BiPredicate<N, N> ignoreStrategy) {
        return nba6(LambdaUtils.getLambdaPropertyName(property), min, max, ignoreStrategy);
    }

    @Override
    default <D extends Date> L nba6(SerializableDateSupplier<D> property, D min, D max) {
        return nba6(LambdaUtils.getLambdaPropertyName(property), min, max);
    }
    ...
    @Override
    default L nba6(SerializableStringSupplier property, String min, String max) {
        return nba6(LambdaUtils.getLambdaPropertyName(property), min, max);
    }
