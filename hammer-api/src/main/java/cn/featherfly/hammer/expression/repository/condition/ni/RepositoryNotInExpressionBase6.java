...
public interface RepositoryNotInExpressionBase6<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryNotInExpressionBase5<C, L>, NotInExpression6<C, L> {
    ...
    default <T, R> L ni6(SerializableFunction<T, R> name, R... values) {
        return ni6(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L ni6(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L ni6(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return ni6(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L ni6(SerializableSupplier<R> property) {
        return ni6(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
     ...
     */
    @Override
    default <R> L ni6(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
        return ni6(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L ni6(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return ni6(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L ni6(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return ni6(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}