...
/**
 * The Interface EntityQueryRelatedFetchedExpression5RRFRP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression5RRFRP<E, R1, R2, R3, R4, R5,
        ...
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple2<E, R3>> {
    // 目前就实现5次关联（join）
}
