...
public interface RepositoryGreatThanExpressionBase6<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryGreatThanExpressionBase5<C, L>, GreatThanExpression6<C, L> {
    /**
     * great than. 大于.
     *
    ...
    default L gt6(SerializableIntSupplier property) {
        return gt6(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
    ...
    default L gt6(SerializableIntSupplier property, IntPredicate ignoreStrategy) {
        return gt6(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L gt6(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return gt6(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L gt6(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return gt6(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}