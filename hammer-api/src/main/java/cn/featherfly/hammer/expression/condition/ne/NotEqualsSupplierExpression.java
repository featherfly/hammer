...
public interface NotEqualsSupplierExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default <R> L ne(SerializableSupplier<R> propertyValue, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L ne(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy);
}