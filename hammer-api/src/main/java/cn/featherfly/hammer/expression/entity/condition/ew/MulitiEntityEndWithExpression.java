...
public interface MulitiEntityEndWithExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default <E> L ew(int index, SerializableFunction<E, String> name, String value) {
        return ew(index, name, value, QueryPolicy.AUTO);
    }
    ...
    default <E> L ew(int index, SerializableFunction<E, String> name, String value, Predicate<String> ignoreStrategy) {
        return ew(index, name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return the l
     */
    <E> L ew(int index, SerializableFunction<E, String> name, String value, QueryPolicy queryPolicy);
    ...
    default L ew(int index, SerializableSupplier<String> property) {
        return ew(index, property, QueryPolicy.AUTO);
    }
    ...
    default L ew(int index, SerializableSupplier<String> property, Predicate<String> ignoreStrategy) {
        return ew(index, property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return the l
     */
    L ew(int index, SerializableSupplier<String> property, QueryPolicy queryPolicy);
     ...
     * @return the l
     */
    L ew(int index, SerializableSupplier<String> property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
