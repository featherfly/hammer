...
public interface EntityNotEndWithExpressionBase3<E, E2, E3, C extends ConditionExpression,
        L extends LogicExpression<C, L>> extends EntityNotEndWithExpressionBase2<E, E2, C, L> {
     ...
     * @return LogicExpression
     */
    default L new3(SerializableStringSupplier property) {
        return new3(property, MatchStrategy.AUTO);
    }
     ...
     * @return LogicExpression
     */
    default L new3(SerializableStringSupplier property, Predicate<String> ignoreStrategy) {
        return new3(property, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L new3(SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    L new3(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
