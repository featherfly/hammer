...
public interface EntityQueryRelateExpression5FFFF<E, R1, R2, R3, R4, R5,
        ...
        FL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, FC, FL, FS,
                Tuple6<E, R1, R2, R3, R4, R5>>,
        FS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple6<E, R1, R2, R3, R4, R5>>> extends
        EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple5<E, R1, R2, R3, R4>>, EntityQueryRelate<F> {
    // TODO 加入join方法
}
