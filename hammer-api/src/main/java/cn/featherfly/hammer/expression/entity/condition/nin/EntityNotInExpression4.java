...
public interface EntityNotInExpression4<E, E2, E3, E4, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L nin(Consumer<Tuple4<NotInEntityExpression<E>, NotInEntityExpression<E2>, NotInEntityExpression<E3>,
     ...
     * @return the LogicExpression
     */
    L nin(FourArgusConsumer<NotInEntityExpression<E>, NotInEntityExpression<E2>, NotInEntityExpression<E3>,
            NotInEntityExpression<E4>> notInEntityExpressions);
}