...
public interface RepositoryQueryConditionsGroupLogicExpression3<
    ...
    Q extends LimitAwareQuery0<Map<String, Serializable>>> extends RepositoryConditionsGroupLogicExpression3<C, L>,
    RepositoryQueryable3<S, S2, Q>, QueryOneExecutor<Map<String, Serializable>>, QueryMapperSetter0 {
}
