...
public interface EntityNotEndWithExpressionBase6<E, E2, E3, E4, E5, E6, C extends ConditionExpression,
        ...
        extends EntityNotEndWithExpressionBase5<E, E2, E3, E4, E5, C, L>, NotEndWithSupplierExpression6<C, L> {
     ...
     * @return LogicExpression
     */
    default L new6(SerializableFunction<E6, String> name, String value, IgnoreStrategy ignoreStrategy) {
        return new6(name, value, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L new6(SerializableFunction<E6, String> name, String value, MatchStrategy matchStrategy,
