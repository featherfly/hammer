...
public interface RepositoryBetweenExpression5<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L ba(Consumer<Tuple5<BetweenRepositoryExpression, BetweenRepositoryExpression, BetweenRepositoryExpression,
     ...
     * @return the LogicExpression
     */
    L ba(FiveArgusConsumer<BetweenRepositoryExpression, BetweenRepositoryExpression, BetweenRepositoryExpression,
        BetweenRepositoryExpression, BetweenRepositoryExpression> betweenExpressions);
}