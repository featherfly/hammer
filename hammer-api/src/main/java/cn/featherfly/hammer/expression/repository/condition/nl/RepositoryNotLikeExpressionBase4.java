...
public interface RepositoryNotLikeExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryNotLikeExpressionBase3<C, L>, NotLikeExpression4<C, L> {
    ...
    @Override
    default L nl4(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return nl4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }

    @Override
    default L nl4(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return nl4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
