...
public interface RepositoryEndWithExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryEndWithExpressionBase3<C, L>, EndWithExpression4<C, L>, EndWithSupplierExpression4<C, L> {
    ...
    default L ew4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return ew4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L ew4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return ew4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}