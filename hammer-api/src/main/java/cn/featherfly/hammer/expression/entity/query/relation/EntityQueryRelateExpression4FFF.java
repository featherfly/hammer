...
public interface EntityQueryRelateExpression4FFF<E, R1, R2, R3, R4,
        ...
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, Tuple4<E, R1, R2, R3>>, QueryRelate<F> {
     ...
     */
    <QR extends EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
    ...
    //     * @return EntityQueryRelateExpression5FFFR
    //     */
    //    <RE extends EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
    ...
    //            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, QRC, QRL, QRS,
    //                    Tuple5<E, R1, R2, R3, R5>>,
    //            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple5<E, R1, R2, R3, R5>>, R5,
     ...
     * @return EntityQueryRelateExpression5FFFR
     */
    <RE extends EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5FFFR
     */
    <RE extends EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5FFFR
     */
    <RE extends EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5FFFR
     */
    <RE extends EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5FFFR
     */
    <RE extends EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
