...
public interface RepositoryStartWithExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L sw4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return sw4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L sw4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return sw4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}