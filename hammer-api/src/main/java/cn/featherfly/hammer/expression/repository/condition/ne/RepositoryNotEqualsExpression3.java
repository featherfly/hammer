...
public interface RepositoryNotEqualsExpression3<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L ne(Consumer<Tuple3<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression,
     ...
     * @return the LogicExpression
     */
    L ne(ThreeArgusConsumer<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression,
            EqualsNotRepositoryExpression> equalsRepositoryExpressions);
}