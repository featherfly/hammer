 ...
 */
public interface EntityQueryRelationEntityExpression4<E, R1, R2, R3, R4,
        ...
        extends EntityWhereExpression<E, C, L>, EntityQueryRelationExpression4<E, R1, R2, R3, R4, Q, C, L> {
