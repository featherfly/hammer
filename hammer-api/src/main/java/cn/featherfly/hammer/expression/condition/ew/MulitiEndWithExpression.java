...
public interface MulitiEndWithExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L ew(int index, SerializableStringSupplier property) {
     ...
     * @return LogicExpression
     */
    L ew(int index, SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    default L ew(int index, SerializableStringSupplier property, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L ew(int index, SerializableStringSupplier property, Predicate<String> ignoreStrategy) {
        return ew(index, property, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L ew(int index, SerializableStringSupplier property, MatchStrategy matchStrategy,
        IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    L ew(int index, SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
}