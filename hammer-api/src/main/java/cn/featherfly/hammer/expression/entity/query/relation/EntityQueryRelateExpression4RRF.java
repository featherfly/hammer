...
/**
 * The Interface EntityQueryRelateExpression4RFF.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression4RRF<E, R1, R2, R3, R4,
        ...
        F extends EntityQueryRelatedFetchedExpression4RRFF<E, R1, R2, R3, R4, FC, FL, FS>,
        FC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, FC, FL, FS, Tuple3<E, R3, R4>>,
        FL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, FC, FL, FS, Tuple3<E, R3, R4>>,
        FS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple3<E, R3, R4>>>
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, Tuple2<E, R3>>, QueryRelate<F> {
     ...
     */
    <QR extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRFR
     */
    <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R3>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R3>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R3>>,
     ...
     * @return EntityQueryRelateExpression5RRFR
     */
    <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRFR
     */
    <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRFR
     */
    <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRFR
     */
    <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRFR
     */
    <RE extends EntityQueryRelateExpression5RRFR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
