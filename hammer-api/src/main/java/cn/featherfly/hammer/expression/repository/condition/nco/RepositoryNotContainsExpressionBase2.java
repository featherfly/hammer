...
public interface RepositoryNotContainsExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryNotContainsExpression<C, L>, NotContainsExpression2<C, L>, NotContainsSupplierExpression2<C, L> {
    ...
    default L nco2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return nco2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L nco2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return nco2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}