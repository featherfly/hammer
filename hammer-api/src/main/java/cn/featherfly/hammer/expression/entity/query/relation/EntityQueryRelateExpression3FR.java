...
public interface EntityQueryRelateExpression3FR<E, R1, R2, R3,
        ...
        extends EntityQueryExpression4<E, R1, R2, R3, C, L, S, Tuple2<E, R1>>, QueryRelate<F> {
     ...
     */
    <QR extends EntityQueryRelateExpression4FRR<E, R1, R2, R3, R4, RC, RL, RS, QRF, QRC, QRL, QRS>,
