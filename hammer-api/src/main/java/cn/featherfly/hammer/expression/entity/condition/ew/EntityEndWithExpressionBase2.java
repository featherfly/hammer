...
public interface EntityEndWithExpressionBase2<E, E2, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    L ew2(SerializableStringSupplier property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L ew2(SerializableStringSupplier property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
