...
public interface EntityEndWithExpressionBase2<E, E2, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L ew2(SerializableFunction<E2, String> name, String value) {
        return ew2(name, value, QueryPolicy.AUTO);
    }
    ...
    default L ew2(SerializableFunction<E2, String> name, String value, Predicate<String> ignoreStrategy) {
        return ew2(name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L ew2(SerializableFunction<E2, String> name, String value, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    default L ew2(StringSupplier property) {
        return ew2(property, QueryPolicy.AUTO);
    }
     ...
     * @return LogicExpression
     */
    default L ew2(StringSupplier property, Predicate<String> ignoreStrategy) {
        return ew2(property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L ew2(StringSupplier property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L ew2(StringSupplier property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
