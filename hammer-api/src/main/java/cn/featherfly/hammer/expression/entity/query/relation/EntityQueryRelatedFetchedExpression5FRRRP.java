...
/**
 * The Interface EntityQueryRelatedFetchedExpression5FRRRP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression5FRRRP<E, R1, R2, R3, R4, R5,
        ...
        extends EntityQueryRelateExpression5FRRRXBase<E, R1, R2, R3, R4, R5, C, L, S> {
}
