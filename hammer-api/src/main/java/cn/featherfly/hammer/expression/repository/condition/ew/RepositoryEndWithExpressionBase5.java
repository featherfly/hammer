...
public interface RepositoryEndWithExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L ew5(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return ew5(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L ew5(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return ew5(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}