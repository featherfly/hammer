...
public interface RepositoryContainsExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L co4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return co4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L co4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return co4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}