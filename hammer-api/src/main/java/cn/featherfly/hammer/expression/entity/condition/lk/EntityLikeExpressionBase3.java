...
public interface EntityLikeExpressionBase3<E, E2, E3, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L lk3(StringSupplier property) {
     ...
     * @return LogicExpression
     */
    default L lk3(StringSupplier property, Predicate<String> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    L lk3(StringSupplier property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L lk3(StringSupplier property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
