...
public interface EqualsSupplierExpression5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends EqualsSupplierExpression4<C, L> {
    /**
     * equals. 等于.
     *
     ...
     * @return LogicExpression
     */
    <R> L eq5(SerializableSupplier<R> propertyValue);
     ...
     * @return LogicExpression
     */
    default <R> L eq5(SerializableSupplier<R> propertyValue, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L eq5(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy);
}