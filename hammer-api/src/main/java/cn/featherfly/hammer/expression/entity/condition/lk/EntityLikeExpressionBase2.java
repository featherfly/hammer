...
public interface EntityLikeExpressionBase2<E, E2, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L lk2(SerializableFunction<E2, String> name, String value) {
        return lk2(name, value, QueryPolicy.AUTO);
    }
    ...
    default L lk2(SerializableFunction<E2, String> name, String value, Predicate<String> ignoreStrategy) {
        return lk2(name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L lk2(SerializableFunction<E2, String> name, String value, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    default L lk2(StringSupplier property) {
        return lk2(property, QueryPolicy.AUTO);
    }
     ...
     * @return LogicExpression
     */
    default L lk2(StringSupplier property, Predicate<String> ignoreStrategy) {
        return lk2(property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L lk2(StringSupplier property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L lk2(StringSupplier property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
