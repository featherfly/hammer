...
/**
 * The Interface EntityQueryRelatedFetchedExpression5FFRRP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression5FFRRP<E, R1, R2, R3, R4, R5,
        ...
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple3<E, R1, R2>> {
    // 目前就实现5次关联（join）
}
