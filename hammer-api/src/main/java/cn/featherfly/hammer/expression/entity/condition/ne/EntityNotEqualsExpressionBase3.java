...
public interface EntityNotEqualsExpressionBase3<E, E2, E3, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableFunction<E3, R> name, R value, MatchStrategy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableFunction<E3, R> name, R value, MatchStrategy queryPolicy, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableSupplier3<R> property, MatchStrategy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableSupplier3<R> property, MatchStrategy queryPolicy, Predicate<R> ignoreStrategy);
