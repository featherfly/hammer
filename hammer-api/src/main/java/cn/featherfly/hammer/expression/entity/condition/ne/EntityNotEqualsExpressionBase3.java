...
public interface EntityNotEqualsExpressionBase3<E, E2, E3, C extends ConditionExpression,
    ...
    default <R> L ne3(SerializableFunction<E3, R> name, R value) {
        return ne3(name, value, QueryPolicy.AUTO);
    }
    ...
    default <R> L ne3(SerializableFunction<E3, R> name, R value, Predicate<R> ignoreStrategy) {
        return ne3(name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableFunction<E3, R> name, R value, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableFunction<E3, R> name, R value, QueryPolicy queryPolicy, Predicate<R> ignoreStrategy);
    ...
    default <R> L ne3(SerializableSupplier3<R> property) {
        return ne3(property, QueryPolicy.AUTO);
    }
    ...
    default <R> L ne3(SerializableSupplier3<R> property, Predicate<R> ignoreStrategy) {
        return ne3(property, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableSupplier3<R> property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    <R> L ne3(SerializableSupplier3<R> property, QueryPolicy queryPolicy, Predicate<R> ignoreStrategy);
