...
public interface RepositoryStartWithExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L sw3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return sw3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L sw3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return sw3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}