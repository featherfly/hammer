...
public interface EntityNotInExpression2<E, E2, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L ni(Consumer<Tuple2<NotInEntityExpression<E>, NotInEntityExpression<E2>>> notInEntityExpressions);
     ...
     * @return the LogicExpression
     */
    L ni(BiConsumer<NotInEntityExpression<E>, NotInEntityExpression<E2>> notInEntityExpressions);
}