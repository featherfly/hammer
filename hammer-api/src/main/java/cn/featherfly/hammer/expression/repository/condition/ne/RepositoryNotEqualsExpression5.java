...
public interface RepositoryNotEqualsExpression5<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L ne(Consumer<Tuple5<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression, EqualsNotRepositoryExpression,
            EqualsNotRepositoryExpression, EqualsNotRepositoryExpression>> equalsRepositoryExpressions);
     ...
     * @return the LogicExpression
     */
    L ne(FiveArgusConsumer<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression, EqualsNotRepositoryExpression,
            EqualsNotRepositoryExpression, EqualsNotRepositoryExpression> equalsRepositoryExpressions);
}