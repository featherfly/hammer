 ...
 */
public interface EntityQueryRelateExpression4RFRXBase<E, R1, R2, R3, R4,
        ...
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, Tuple2<E, R2>> {
     ...
     * @return EntityQueryRelateExpression5RFRRR
     */
     ...
     * @param <R5>         the generic type
     * @param propertyName find type object property name
     * @return EntityQueryRelateExpression5RFRRP
     */
    <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R2>>,
     ...
     * @return EntityQueryRelateExpression5RFRRP
     */
    <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFRRP
     */
    <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFRRP
     */
    <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFRRP
     */
    <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RFRRP
     */
    <RE extends EntityQueryRelateExpression5RFRRP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
