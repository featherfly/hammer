...
public interface RepositoryNotContainsExpressionBase6<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L nco6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return nco6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L nco6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return nco6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}