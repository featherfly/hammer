...
public interface EntityNotContainsExpressionBase2<E, E2, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends EntityNotContainsExpression<E, C, L> {
     ...
     * @return LogicExpression
     */
    default L nco2(SerializableStringSupplier property) {
        return nco2(property, MatchStrategy.AUTO);
    }
     ...
     * @return LogicExpression
     */
    default L nco2(SerializableStringSupplier property, Predicate<String> ignoreStrategy) {
        return nco2(property, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L nco2(SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    L nco2(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
