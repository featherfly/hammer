...
/**
 * The Interface EntityQueryRelateExpression5FRFFP.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression5FRFFP<E, R1, R2, R3, R4, R5,
        ...
        F extends EntityQueryRelatedFetchedExpression5FRFFP<E, R1, R2, R3, R4, R5, C, L, S>>
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple4<E, R1, R3, R4>>, QueryRelate<F> {
    // 目前就实现5次关联（join）
}
