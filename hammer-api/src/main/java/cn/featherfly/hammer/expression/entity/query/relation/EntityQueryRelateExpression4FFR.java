...
/**
 * The Interface EntityQueryRelateExpression4FFR.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression4FFR<E, R1, R2, R3, R4,
        C extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, C, L, S, Tuple3<E, R1, R2>>,
        L extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, C, L, S, Tuple3<E, R1, R2>>,
        S extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple3<E, R1, R2>>,
        F extends EntityQueryRelatedFetchedExpression4FFRF<E, R1, R2, R3, R4, FC, FL, FS>,
        FC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, FC, FL, FS, Tuple4<E, R1, R2, R4>>,
        FL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, FC, FL, FS, Tuple4<E, R1, R2, R4>>,
        FS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple4<E, R1, R2, R4>>>
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, Tuple3<E, R1, R2>>, QueryRelate<F> {
     ...
     * @return EntityQueryRelateExpression5FFRR
     */
    <QR extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5FFRR
     */
    <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R2>>,
    ...
    <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R5>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R2, R5>>,
            R5> RE join(SerializableFunction2<R5, Tuple3<E, R1, R2>> propertyName);
     ...
     * @return EntityQueryRelateExpression5FFRR
     */
    <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FFRRF<E, R1, R2, R3, R4, E, QRC, QRL, QRS>,
            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, E, QRC, QRL, QRS, Tuple4<E, R1, R2, E>>,
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, E, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, E>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, E, Tuple4<E, R1, R2, E>>> RE join(
     ...
     * @return EntityQueryRelateExpression5FFRR
     */
    <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FFRRF<E, R1, R2, R3, R4, R1, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R1, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R1>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R1, Tuple4<E, R1, R2, R1>>> RE join2(
     ...
     * @return EntityQueryRelateExpression5FFRR
     */
    <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FFRRF<E, R1, R2, R3, R4, R2, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R2, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R2>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R2, Tuple4<E, R1, R2, R2>>> RE join3(
     ...
     * @return EntityQueryRelateExpression5FFRR
     */
    <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FFRRF<E, R1, R2, R3, R4, R3, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R3, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R3>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R3, Tuple4<E, R1, R2, R3>>> RE join4(
     ...
     * @return EntityQueryRelateExpression5FFRR
     */
    <RE extends EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
            ...
            QR extends EntityQueryRelatedFetchedExpression5FFRRF<E, R1, R2, R3, R4, R4, QRC, QRL, QRS>,
            ...
            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R4, QRC, QRL, QRS,
                    Tuple4<E, R1, R2, R4>>,
            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R4, Tuple4<E, R1, R2, R4>>> RE join5(
