...
public interface EntityLessEqualsExpressionBase6<T, T2, T3, T4, T5, T6, C extends ConditionExpression,
     ...
     */
    L le6(SerializableToIntFunction<T6> name, int value);
     ...
     * @return LogicExpression
     */
    L le6(SerializableToIntFunction<T6> name, int value, IntPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L le6(SerializableToLongFunction<T6> name, long value);
     ...
     * @return LogicExpression
     */
    L le6(SerializableToLongFunction<T6> name, long value, LongPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L le6(SerializableToDoubleFunction<T6> name, double value);
     ...
     * @return LogicExpression
     */
    L le6(SerializableToDoubleFunction<T6> name, double value, DoublePredicate ignoreStrategy);
