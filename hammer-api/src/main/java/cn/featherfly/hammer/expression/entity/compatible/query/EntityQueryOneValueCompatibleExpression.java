...
public interface EntityQueryOneValueCompatibleExpression<E, V,
    ...
    S extends EntityQueryValueSortExpression<E, V>, T extends EntityQueryOneValueCompatibleExpression<E, V, C, L, S, T>>
    extends EntityQueryValueWhereExpression<E, V, C, L, S>, EntityQueryListExecutor<E>, QueryValueExecutor,
