 ...
 */
public interface EntityWhereCompatibleExpression<E1, C extends EntityConditionGroupCompatibleExpression<E1, C, L>,
    L extends EntityConditionGroupLogicCompatibleExpression<E1, C, L>> extends WhereExpression<C> {
    /**
