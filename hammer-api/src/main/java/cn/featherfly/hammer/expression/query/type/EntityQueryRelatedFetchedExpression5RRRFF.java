...
/**
 * The Interface EntityQueryRelatedFetchedExpression5RRRFF.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression5RRRFF<E, R1, R2, R3, R4, R5,
        C extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple3<E, R4, R5>>,
