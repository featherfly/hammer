...
/**
 * The Interface EntityQueryRelateExpression5RRFRP.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression5RRFRP<E, R1, R2, R3, R4, R5,
        ...
        F extends EntityQueryRelatedFetchedExpression5RRFRP<E, R1, R2, R3, R4, R5, C, L, S>>
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple2<E, R3>>, QueryRelate<F> {
    // 目前就实现5次关联（join）
}
