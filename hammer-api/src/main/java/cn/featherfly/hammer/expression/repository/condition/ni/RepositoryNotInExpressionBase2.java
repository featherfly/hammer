...
public interface RepositoryNotInExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryNotInExpression<C, L>, NotInExpression2<C, L> {
    ...
    default <T, R> L ni2(SerializableFunction<T, R> name, R... values) {
        return ni2(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L ni2(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L ni2(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return ni2(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L ni2(SerializableSupplier<R> property) {
     ...
     */
    @Override
    default <R> L ni2(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
