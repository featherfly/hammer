...
public interface EndWithExpression4<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L ew4(String name, String value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L ew4(String name, String value, Predicate<String> ignoreStrategy) {
        return ew4(name, value, MatchStrategy.AUTO, ignoreStrategy);
    }
