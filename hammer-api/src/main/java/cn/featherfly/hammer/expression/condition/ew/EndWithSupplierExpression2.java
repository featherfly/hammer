...
public interface EndWithSupplierExpression2<C extends ConditionExpression, L extends LogicExpression<C, L>> {
    ...
    default L ew2(SerializableStringSupplier propertyValue) {
        return ew2(propertyValue, MatchStrategy.AUTO);
    }
    ...
    default L ew2(SerializableStringSupplier propertyValue, IgnoreStrategy ignoreStrategy) {
        return ew2(propertyValue, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L ew2(SerializableStringSupplier propertyValue, MatchStrategy matchStrategy);
    ...
    default L ew2(SerializableStringSupplier propertyValue, MatchStrategy matchStrategy,
        ...
        return ew2(propertyValue, matchStrategy, (Predicate<String>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    L ew2(SerializableStringSupplier propertyValue, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
}