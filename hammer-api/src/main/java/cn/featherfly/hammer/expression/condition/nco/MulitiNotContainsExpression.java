...
public interface MulitiNotContainsExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L nco(int index, SerializableStringSupplier property) {
     ...
     * @return LogicExpression
     */
    L nco(int index, SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    default L nco(int index, SerializableStringSupplier property, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L nco(int index, SerializableStringSupplier property, Predicate<String> ignoreStrategy) {
        return nco(index, property, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L nco(int index, SerializableStringSupplier property, MatchStrategy matchStrategy,
        IgnoreStrategy ignoreStrategy) {
