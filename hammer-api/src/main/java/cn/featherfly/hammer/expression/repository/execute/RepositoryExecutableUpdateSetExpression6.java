...
/**
 * repository executable update set expression6.
 *
 * @author zhongj
 ...
 */
public interface RepositoryExecutableUpdateSetExpression6<U extends RepositoryExecutableUpdateSetExpression6<U, C, L>,
    ...
    extends RepositoryWhereExpression6<C, L>, RepositoryUpdateSetExpression<U, C, L>, Executor {
}
