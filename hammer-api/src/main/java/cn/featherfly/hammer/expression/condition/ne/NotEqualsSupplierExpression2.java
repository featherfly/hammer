...
public interface NotEqualsSupplierExpression2<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default <R> L ne2(SerializableSupplier<R> propertyValue, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L ne2(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy);
}