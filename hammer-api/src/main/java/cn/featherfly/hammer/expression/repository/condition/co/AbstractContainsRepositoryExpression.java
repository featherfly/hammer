...
public abstract class AbstractContainsRepositoryExpression<C extends ConditionExpression,
        ...
        extends AbstractConditionEntityExpression<MulitiRepositoryContainsExpression<C, L>>
     ...
     */
    protected AbstractContainsRepositoryExpression(int index, MulitiRepositoryContainsExpression<C, L> expression,
