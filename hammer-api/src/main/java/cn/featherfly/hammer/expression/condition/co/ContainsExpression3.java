...
public interface ContainsExpression3<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L co3(Field name, String value) {
        return co3(name.name(), value);
    }
     ...
     * @return LogicExpression
     */
    default L co3(Field name, String value, IgnoreStrategy ignoreStrategy) {
        return co3(name.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L co3(Field name, String value, Predicate<String> ignoreStrategy) {
        return co3(name.name(), value, ignoreStrategy);
    }
