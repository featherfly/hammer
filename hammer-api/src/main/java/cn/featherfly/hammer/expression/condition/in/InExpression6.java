...
public interface InExpression6<C extends ConditionExpression, L extends LogicExpression<C, L>> {
     ...
     * @return LogicExpression
     */
    default L in6(String name, int value, IntPredicate ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L in6(String name, long value, LongPredicate ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    L in6(String name, long[] values, Predicate<long[]> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L in6(String name, double... values);
     ...
     * @return LogicExpression
     */
    default L in6(String name, double value, DoublePredicate ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L in6(String name, String... values) {
     ...
     * @return LogicExpression
     */
    L in6(String name, String[] values, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    default L in6(String name, String value, Predicate<String> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L in6(String name, String value, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L in6(String name, String[] values, Predicate<String[]> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    L in6(String name, String[] values, MatchStrategy matchStrategy, Predicate<String[]> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L in6(Field field, R value) {
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L in6(Field field, @SuppressWarnings("unchecked") R... values) {
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L in6(Field field, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L in6(String name, R value) {
     ...
     * @return LogicExpression
     */
    <R extends Serializable> L in6(String name, @SuppressWarnings("unchecked") R... values);
     ...
     * @return LogicExpression
     */
    <R extends Serializable> L in6(String name, R value, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L in6(AliasField field, R value) {
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L in6(AliasField field, @SuppressWarnings("unchecked") R... values) {
        return in6(field.getAliasOrName(), values);
    }
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L in6(AliasField field, R value, Predicate<R> ignoreStrategy) {
        return in6(field.getAliasOrName(), value, ignoreStrategy);
    }
}