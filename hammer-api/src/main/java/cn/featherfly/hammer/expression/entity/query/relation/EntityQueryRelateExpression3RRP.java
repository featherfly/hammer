 ...
 */
public interface EntityQueryRelateExpression3RRP<E, R1, R2, R3,
        ...
        F extends EntityQueryRelatedFetchedExpression3RRP<E, R1, R2, R3, C, L, S>>
        extends EntityQueryRelateExpression3RRXBase<E, R1, R2, R3, C, L, S>, QueryRelate<F> {
