...
/**
 * not contains supplier expression6.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public interface NotContainsSupplierExpression6<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends NotContainsSupplierExpression5<C, L> {
