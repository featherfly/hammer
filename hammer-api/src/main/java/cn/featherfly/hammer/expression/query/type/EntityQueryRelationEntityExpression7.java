 ...
 */
public interface EntityQueryRelationEntityExpression7<E, R1, R2, R3, R4, R5, R6, R7,
        ...
        extends EntityWhereExpression<E, C, L>, EntityQueryRelationExpression7<E, R1, R2, R3, R4, R5, R6, R7, Q, C, L> {
