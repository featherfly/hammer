...
/**
 * RepositorySerializableFieldExpression.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public interface RepositorySerializableFieldExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends SerializableFieldExpression<C, L>, FieldAware<RepositoryAwareField<AliasRepository>> {
