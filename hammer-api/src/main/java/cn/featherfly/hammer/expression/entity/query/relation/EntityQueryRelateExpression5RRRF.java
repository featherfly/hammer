...
/**
 * The Interface EntityQueryRelateExpression5RRRF.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, R5,
        ...
        F extends EntityQueryRelatedFetchedExpression5RRRFF<E, R1, R2, R3, R4, R5, FC, FL, FS>,
        FC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, FC, FL, FS, Tuple3<E, R4, R5>>,
        FL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, FC, FL, FS, Tuple3<E, R4, R5>>,
        FS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R4, R5>>>
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple2<E, R4>>, EntityQueryRelate<F> {
    // TODO 加入join方法
}
