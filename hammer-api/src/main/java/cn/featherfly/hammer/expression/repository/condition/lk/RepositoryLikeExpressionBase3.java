...
public interface RepositoryLikeExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryLikeExpressionBase2<C, L>, LikeExpression3<C, L>, LikeSupplierExpression3<C, L> {
    ...
    default L lk3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return lk3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L lk3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return lk3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}