...
public interface NotInExpression6<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default <R> L ni6(Field field, R value) {
     ...
     * @return LogicExpression
     */
    default <R> L ni6(Field field, @SuppressWarnings("unchecked") R... values) {
     ...
     * @return LogicExpression
     */
    default <R> L ni6(Field field, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <R> L ni6(String name, R value) {
     ...
     * @return LogicExpression
     */
    <R> L ni6(String name, @SuppressWarnings("unchecked") R... values);
     ...
     * @return LogicExpression
     */
    <R> L ni6(String name, R value, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    default <R> L ni6(AliasField field, R value) {
     ...
     * @return LogicExpression
     */
    default <R> L ni6(AliasField field, @SuppressWarnings("unchecked") R... values) {
        return ni6(field.getAliasOrName(), values);
    }
     ...
     * @return LogicExpression
     */
    default <R> L ni6(AliasField field, R value, Predicate<R> ignoreStrategy) {
        return ni6(field.getAliasOrName(), value, ignoreStrategy);
    }
}