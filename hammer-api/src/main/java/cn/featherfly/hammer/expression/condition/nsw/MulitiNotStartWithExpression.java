...
public interface MulitiNotStartWithExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    default L nsw(int index, SerializableStringSupplier property) {
     ...
     * @return LogicExpression
     */
    L nsw(int index, SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    default L nsw(int index, SerializableStringSupplier property, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L nsw(int index, SerializableStringSupplier property, Predicate<String> ignoreStrategy) {
        return nsw(index, property, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L nsw(int index, SerializableStringSupplier property, MatchStrategy matchStrategy,
        IgnoreStrategy ignoreStrategy) {
