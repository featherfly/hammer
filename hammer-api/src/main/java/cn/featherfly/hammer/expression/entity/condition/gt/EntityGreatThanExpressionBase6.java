...
public interface EntityGreatThanExpressionBase6<E, E2, E3, E4, E5, E6, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    <R extends Date> L gt6(DateSupplier<R> property);
     ...
     * @return LogicExpression
     */
    <R extends Date> L gt6(DateSupplier<R> property, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <R extends Number> L gt6(NumberSupplier<R> property);
     ...
     * @return LogicExpression
     */
    <R extends Number> L gt6(NumberSupplier<R> property, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt6(LocalDateSupplier property);
     ...
     * @return LogicExpression
     */
    L gt6(LocalDateSupplier property, Predicate<LocalDate> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt6(LocalTimeSupplier property);
     ...
     * @return LogicExpression
     */
    L gt6(LocalTimeSupplier property, Predicate<LocalTime> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt6(LocalDateTimeSupplier property);
     ...
     * @return LogicExpression
     */
    L gt6(LocalDateTimeSupplier property, Predicate<LocalDateTime> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt6(StringSupplier property, Predicate<String> ignoreStrategy);
    ...
    //     * @return LogicExpression
    //     */
    //    <R, N extends Number> L gt6(SerializableSupplier<R> repository, ReturnNumberFunction<R, N> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <R, D extends Date> L gt6(SerializableSupplier<R> repository, ReturnDateFunction<R, D> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt6(SerializableSupplier<T> repository, ReturnLocalTimeFunction<T> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt6(SerializableSupplier<T> repository, ReturnLocalDateFunction<T> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt6(SerializableSupplier<T> repository, ReturnLocalDateTimeFunction<T> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt6(SerializableSupplier<T> repository, ReturnStringFunction<T> property);
}