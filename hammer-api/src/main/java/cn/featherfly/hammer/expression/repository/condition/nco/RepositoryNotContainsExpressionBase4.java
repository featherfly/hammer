...
public interface RepositoryNotContainsExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends ContainsExpression4<C, L>, RepositoryNotContainsExpressionBase3<C, L> {
     ...
     * @return LogicExpression
     */
    <T> L nco4(SerializableToStringFunction<T> name, String value, MatchStrategy matchStrategy);
    ...
    default L nco4(SerializableStringSupplier propertyValue) {
        return nco4(propertyValue, MatchStrategy.AUTO);
    }
    ...
    default L nco4(SerializableStringSupplier propertyValue, IgnoreStrategy ignoreStrategy) {
        return nco4(propertyValue, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L nco4(SerializableStringSupplier propertyValue, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    L nco4(SerializableStringSupplier propertyValue, MatchStrategy matchStrategy, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L nco4(SerializableStringSupplier propertyValue, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
}