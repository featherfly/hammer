...
public interface RepositoryNotContainsExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L nco4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return nco4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L nco4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return nco4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}