...
/**
 * The Interface EntityQueryRelatedFetchedExpression4FRRP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression4RFFP<E, R1, R2, R3, R4,
        ...
        extends EntityQueryRelateExpression4RFFXBase<E, R1, R2, R3, R4, C, L, S> {
