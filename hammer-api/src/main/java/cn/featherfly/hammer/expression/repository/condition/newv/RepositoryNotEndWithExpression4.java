...
public interface RepositoryNotEndWithExpression4<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L newv(Consumer<Tuple4<NotEndWithRepositoryExpression, NotEndWithRepositoryExpression,
     ...
     * @return the LogicExpression
     */
    L newv(FourArgusConsumer<NotEndWithRepositoryExpression, NotEndWithRepositoryExpression,
        NotEndWithRepositoryExpression, NotEndWithRepositoryExpression> notEndWithExpressions);
}