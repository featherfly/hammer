...
public interface NotBetweenExpression3<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends NotBetweenExpression2<C, L> {
     ...
     * @return LogicExpression
     */
    <N extends Number> L nba3(String name, N min, N max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <D extends Date> L nba3(String name, D min, D max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L nba3(String name, LocalTime min, LocalTime max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L nba3(String name, LocalDate min, LocalDate max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L nba3(String name, LocalDateTime min, LocalDateTime max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L nba3(String name, String min, String max, IgnoreStrategy ignoreStrategy);
