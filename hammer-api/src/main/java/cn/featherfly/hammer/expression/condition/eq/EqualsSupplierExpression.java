...
public interface EqualsSupplierExpression<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    <R> L eq(SerializableSupplier<R> propertyValue);
     ...
     * @return LogicExpression
     */
    default <R> L eq(SerializableSupplier<R> propertyValue, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L eq(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy);
}