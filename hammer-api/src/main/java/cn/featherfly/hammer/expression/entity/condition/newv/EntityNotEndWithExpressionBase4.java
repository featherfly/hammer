...
public interface EntityNotEndWithExpressionBase4<E, E2, E3, E4, C extends ConditionExpression,
        L extends LogicExpression<C, L>> extends EntityNotEndWithExpressionBase3<E, E2, E3, C, L> {
     ...
     * @return LogicExpression
     */
    default L new4(SerializableStringSupplier property) {
        return new4(property, MatchStrategy.AUTO);
    }
     ...
     * @return LogicExpression
     */
    default L new4(SerializableStringSupplier property, Predicate<String> ignoreStrategy) {
        return new4(property, MatchStrategy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L new4(SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    L new4(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
