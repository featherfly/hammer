...
public interface GreatThanSupplierExpression3<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends GreatThanSupplierExpression2<C, L> {
    /**
     * great than. 大于.
     *
     ...
     * @return LogicExpression
     */
    <N extends Number> L gt3(SerializableNumberSupplier<N> property);
    ...
    default <N extends Number> L gt3(SerializableNumberSupplier<N> property, IgnoreStrategy ignoreStrategy) {
        return gt3(property, (Predicate<N>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    <N extends Number> L gt3(SerializableNumberSupplier<N> property, Predicate<N> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <D extends Date> L gt3(SerializableDateSupplier<D> property);
    ...
    default <D extends Date> L gt3(SerializableDateSupplier<D> property, IgnoreStrategy ignoreStrategy) {
        return gt3(property, (Predicate<D>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    <D extends Date> L gt3(SerializableDateSupplier<D> property, Predicate<D> ignoreStrategy);
    ...
    default L gt3(SerializableLocalTimeSupplier property, IgnoreStrategy ignoreStrategy) {
        return gt3(property, (Predicate<LocalTime>) ignoreStrategy::test);
    }
    ...
    default L gt3(SerializableLocalDateSupplier property, IgnoreStrategy ignoreStrategy) {
        return gt3(property, (Predicate<LocalDate>) ignoreStrategy::test);
    }
    ...
    default L gt3(SerializableLocalDateTimeSupplier property, IgnoreStrategy ignoreStrategy) {
        return gt3(property, (Predicate<LocalDateTime>) ignoreStrategy::test);
    }
    ...
    default L gt3(SerializableStringSupplier property, MatchStrategy matchStrategy, IgnoreStrategy ignoreStrategy) {
        return gt3(property, matchStrategy, (Predicate<String>) ignoreStrategy::test);
    }
