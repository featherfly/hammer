...
/**
 * not equals supplier expression5.
 *
 * @author zhongj
 * @param <C> the generic type
 * @param <L> the generic type
 */
public interface NotEqualsSupplierExpression5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends NotEqualsSupplierExpression4<C, L> {
    /**
     * not equals. 不等于.
     *
     ...
     * @return LogicExpression
     */
    default <R> L ne5(SerializableSupplier<R> propertyValue, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L ne5(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy);
}