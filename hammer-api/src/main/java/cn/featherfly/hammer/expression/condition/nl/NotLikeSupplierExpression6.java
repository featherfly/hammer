...
public interface NotLikeSupplierExpression6<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends NotLikeSupplierExpression5<C, L> {
     ...
     * @return LogicExpression
     */
    default L nl6(SerializableStringSupplier property, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default L nl6(SerializableStringSupplier property, MatchStrategy matchStrategy, IgnoreStrategy ignoreStrategy) {
        return nl6(property, matchStrategy, (Predicate<String>) ignoreStrategy::test);
    }
