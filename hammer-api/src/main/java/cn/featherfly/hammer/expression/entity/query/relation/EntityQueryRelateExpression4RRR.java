...
/**
 * The Interface EntityQueryRelateExpression5RRRR.
 *
 * @author zhongj
...
public interface EntityQueryRelateExpression4RRR<E, R1, R2, R3, R4,
        ...
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, E>, QueryRelate<F> {
     ...
     * @return EntityQueryRelateExpression5RRRR
     */
    <QR extends EntityQueryRelateExpression5RRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
    ...
    //     * @return EntityQueryRelateExpression5RRRR
    //     */
    //    <RE extends EntityQueryRelateExpression5RRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
    //            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
    //            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
    //            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, E>,
    ...
    //            QRC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, QRC, QRL, QRS, Tuple2<E, R5>>,
    //            QRL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, QRC, QRL, QRS, Tuple2<E, R5>>,
    //            QRS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R5>>, R5,
     ...
     * @return EntityQueryRelateExpression5RRRR
     */
    <RE extends EntityQueryRelateExpression5RRRR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRR
     */
    <RE extends EntityQueryRelateExpression5RRRR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRR
     */
    <RE extends EntityQueryRelateExpression5RRRR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRR
     */
    <RE extends EntityQueryRelateExpression5RRRR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRR
     */
    <RE extends EntityQueryRelateExpression5RRRR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
