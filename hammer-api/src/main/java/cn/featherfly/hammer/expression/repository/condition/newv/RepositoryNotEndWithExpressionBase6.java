...
public interface RepositoryNotEndWithExpressionBase6<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L new6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return new6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L new6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return new6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
