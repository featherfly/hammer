...
/**
 * The Interface EntityQueryRelatedFetchedExpression2RP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression2RP<E, R1, R2,
        ...
        extends EntityQueryRelateExpression2RXBase<E, R1, R2, C, L, S> {
