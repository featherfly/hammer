...
public interface GreatThanExpression3<C extends ConditionExpression, L extends LogicExpression<C, L>> {
     ...
     * @return LogicExpression
     */
    <N extends Number> L gt3(String name, N value);
     ...
     * @return LogicExpression
     */
    <N extends Number> L gt3(String name, N value, Predicate<N> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <D extends Date> L gt3(String name, D value);
     ...
     * @return LogicExpression
     */
    <D extends Date> L gt3(String name, D value, Predicate<D> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt3(String name, LocalTime value);
     ...
     * @return LogicExpression
     */
    L gt3(String name, LocalTime value, Predicate<LocalTime> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt3(String name, LocalDate value);
     ...
     * @return LogicExpression
     */
    L gt3(String name, LocalDate value, Predicate<LocalDate> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt3(String name, LocalDateTime value);
     ...
     * @return LogicExpression
     */
    L gt3(String name, LocalDateTime value, Predicate<LocalDateTime> ignoreStrategy);
