...
public interface RepositoryNotEqualsExpression2<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L ne(Consumer<Tuple2<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression>> equalsRepositoryExpressions);
     ...
     * @return the LogicExpression
     */
    L ne(BiConsumer<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression> equalsRepositoryExpressions);
}