...
/**
 * The Interface EntityQueryRelateExpression2FXBase.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression2FXBase<E, R1, R2,
     ...
     * @return EntityQueryRelateExpression3FRR
     */
    <QR extends EntityQueryRelateExpression3FRR<E, R1, R2, R3, RC, RL, RS, QRF, FC, FL, FS>,
     ...
     * @return EntityQueryRelateExpression3FRR
     */
    <RE extends EntityQueryRelateExpression3FRR<E, R1, R2, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression4<E, R1, R2, R3, RC, RL, RS, Tuple2<E, R1>>,
            RL extends EntityQueryConditionGroupLogicExpression4<E, R1, R2, R3, RC, RL, RS, Tuple2<E, R1>>,
            RS extends EntityQuerySortExpression4<E, R1, R2, R3, Tuple2<E, R1>>,
     ...
     * @param <R3>         the generic type
     * @param propertyName find type object property name
     * @return EntityQueryRelateExpression3FRP
     */
    <RE extends EntityQueryRelateExpression3FRP<E, R1, R2, R3, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression4<E, R1, R2, R3, RC, RL, RS, Tuple2<E, R1>>,
            RL extends EntityQueryConditionGroupLogicExpression4<E, R1, R2, R3, RC, RL, RS, Tuple2<E, R1>>,
            RS extends EntityQuerySortExpression4<E, R1, R2, R3, Tuple2<E, R1>>,
     ...
     * @return EntityQueryRelateExpression3FRP
     */
    <RE extends EntityQueryRelateExpression3FRP<E, R1, R2, E, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression3FRP
     */
    <RE extends EntityQueryRelateExpression3FRP<E, R1, R2, R1, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression3FRP
     */
    <RE extends EntityQueryRelateExpression3FRP<E, R1, R2, R2, RC, RL, RS, QR>,
