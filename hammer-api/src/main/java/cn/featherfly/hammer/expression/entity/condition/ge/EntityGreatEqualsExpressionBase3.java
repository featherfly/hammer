...
public interface EntityGreatEqualsExpressionBase3<T, T2, T3, C extends ConditionExpression,
     ...
     */
    L ge3(SerializableToIntFunction<T3> name, int value);
     ...
     * @return LogicExpression
     */
    L ge3(SerializableToIntFunction<T3> name, int value, IntPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ge3(SerializableToLongFunction<T3> name, long value);
     ...
     * @return LogicExpression
     */
    L ge3(SerializableToLongFunction<T3> name, long value, LongPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ge3(SerializableToDoubleFunction<T3> name, double value);
     ...
     * @return LogicExpression
     */
    L ge3(SerializableToDoubleFunction<T3> name, double value, DoublePredicate ignoreStrategy);
