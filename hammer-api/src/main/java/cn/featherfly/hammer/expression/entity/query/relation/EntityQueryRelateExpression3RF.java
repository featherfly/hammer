 ...
 */
public interface EntityQueryRelateExpression3RF<E, R1, R2, R3,
        ...
        extends EntityQueryExpression4<E, R1, R2, R3, C, L, S, Tuple2<E, R2>>, EntityQueryRelate<F> {
     ...
     */
    <QR extends EntityQueryRelateExpression4RFR<E, R1, R2, R3, R4, RC, RL, RS, QRF, QRC, QRL, QRS>,
    ...
    //     * @return EntityQueryRelateExpression4RFR
    //     */
    //    <RE extends EntityQueryRelateExpression4RFR<E, R1, R2, R3, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
    //            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R2>>,
    //            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R2>>,
    //            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R2>>,
     ...
     * @return EntityQueryRelateExpression4RFR
     */
    <RE extends EntityQueryRelateExpression4RFR<E, R1, R2, R3, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression4RFR
     */
    <RE extends EntityQueryRelateExpression4RFR<E, R1, R2, R3, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression4RFR
     */
    <RE extends EntityQueryRelateExpression4RFR<E, R1, R2, R3, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression4RFR
     */
    <RE extends EntityQueryRelateExpression4RFR<E, R1, R2, R3, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
