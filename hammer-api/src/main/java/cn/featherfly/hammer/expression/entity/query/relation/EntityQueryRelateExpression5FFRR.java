...
/**
 * The Interface EntityQueryRelateExpression5FFRR.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression5FFRR<E, R1, R2, R3, R4, R5,
        ...
        F extends EntityQueryRelatedFetchedExpression5FFRRF<E, R1, R2, R3, R4, R5, FC, FL, FS>,
        FC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, FC, FL, FS, Tuple4<E, R1, R2, R5>>,
        FL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, FC, FL, FS, Tuple4<E, R1, R2, R5>>,
        FS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple4<E, R1, R2, R5>>>
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple3<E, R1, R2>>, EntityQueryRelate<F> {
    // TODO 加入join方法
}
