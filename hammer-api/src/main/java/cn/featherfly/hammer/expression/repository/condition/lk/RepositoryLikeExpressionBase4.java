...
public interface RepositoryLikeExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryLikeExpressionBase3<C, L>, LikeExpression4<C, L>, LikeSupplierExpression4<C, L> {
    ...
    default L lk4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return lk4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L lk4(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return lk4(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}