 ...
 */
public interface EntityQueryRelateExpression4RFF<E, R1, R2, R3, R4,
        ...
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, Tuple3<E, R2, R3>>, QueryRelate<F> {
    /**
     * join.
     *
     ...
     */
    <QR extends EntityQueryRelateExpression5RFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RFFR
     */
    <RE extends EntityQueryRelateExpression5RFFR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R2, R3>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R2, R3>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R2, R3>>,
     ...
     * @return EntityQueryRelateExpression5RFFR
     */
    <RE extends EntityQueryRelateExpression5RFFR<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RFFR
     */
    <RE extends EntityQueryRelateExpression5RFFR<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RFFR
     */
    <RE extends EntityQueryRelateExpression5RFFR<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RFFR
     */
    <RE extends EntityQueryRelateExpression5RFFR<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RFFR
     */
    <RE extends EntityQueryRelateExpression5RFFR<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
