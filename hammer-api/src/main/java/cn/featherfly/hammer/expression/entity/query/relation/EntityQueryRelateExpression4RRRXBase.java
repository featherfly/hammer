 ...
 */
public interface EntityQueryRelateExpression4RRRXBase<E, R1, R2, R3, R4,
        ...
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, E> {
     ...
     * @return EntityQueryRelateExpression5RRRRR
     */
    <QR extends EntityQueryRelateExpression5RRRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRRR
     */
    <RE extends EntityQueryRelateExpression5RRRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, E>,
     ...
     * @param <R5>         the generic type
     * @param propertyName find type object property name
     * @return EntityQueryRelateExpression5RRRRP
     */
    <RE extends EntityQueryRelateExpression5RRRRP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, E>,
     ...
     * @return EntityQueryRelateExpression5RRRRP
     */
    <RE extends EntityQueryRelateExpression5RRRRP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RRRRP
     */
    <RE extends EntityQueryRelateExpression5RRRRP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RRRRP
     */
    <RE extends EntityQueryRelateExpression5RRRRP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
     ...
     * @param <R5>     the generic type
     * @param joinType the join type
     * @return EntityQueryRelateExpression5RRRRRR
     */
    <QR extends EntityQueryRelateExpression5RRRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, E>,
     ...
     * @return EntityQueryRelateExpression5RRRRP
     */
    <RE extends EntityQueryRelateExpression5RRRRP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5RRRRP
     */
    <RE extends EntityQueryRelateExpression5RRRRP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
