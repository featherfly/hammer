...
public interface RepositoryNotStartWithExpressionBase6<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L nsw6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return nsw6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L nsw6(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return nsw6(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
