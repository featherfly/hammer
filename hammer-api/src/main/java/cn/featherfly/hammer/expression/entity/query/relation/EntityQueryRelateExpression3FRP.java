...
/**
 * The Interface EntityQueryRelateExpression3FRP.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelateExpression3FRP<E, R1, R2, R3,
        ...
        F extends EntityQueryRelatedFetchedExpression3FRP<E, R1, R2, R3, C, L, S>>
        extends EntityQueryRelateExpression3FRXBase<E, R1, R2, R3, C, L, S>, QueryRelate<F> {
