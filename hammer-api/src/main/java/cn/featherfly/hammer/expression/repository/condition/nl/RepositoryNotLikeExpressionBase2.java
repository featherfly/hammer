...
public interface RepositoryNotLikeExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L nl2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return nl2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L nl2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return nl2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
