...
public interface RepositoryNotLikeExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    default <T> L nl2(SerializableToStringFunction<T> name, String value) {
     ...
     * @return LogicExpression
     */
    default <T> L nl2(SerializableToStringFunction<T> name, String value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T> L nl2(SerializableToStringFunction<T> name, String value, Predicate<String> ignoreStrategy) {
        return nl2(name, value, MatchStrategy.AUTO, ignoreStrategy);
    }
    ...
    default <T> L nl2(SerializableToStringFunction<T> name, String value, MatchStrategy matchStrategy) {
        return nl2(LambdaUtils.getLambdaPropertyName(name), value, matchStrategy);
    }
    ...
    @Override
    default L nl2(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return nl2(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }

    @Override
    default L nl2(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return nl2(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
