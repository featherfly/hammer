...
public interface EntityNotInExpression5<E, E2, E3, E4, E5, C extends ConditionExpression,
     ...
     */
    L nin(Consumer<Tuple5<NotInEntityExpression<E>, NotInEntityExpression<E2>, NotInEntityExpression<E3>,
     ...
     * @return the LogicExpression
     */
    L nin(FiveArgusConsumer<NotInEntityExpression<E>, NotInEntityExpression<E2>, NotInEntityExpression<E3>,
            NotInEntityExpression<E4>, NotInEntityExpression<E5>> notInEntityExpressions);
}