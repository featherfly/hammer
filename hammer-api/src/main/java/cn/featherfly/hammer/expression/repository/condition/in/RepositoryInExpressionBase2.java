...
public interface RepositoryInExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryInExpression<C, L>, InExpression2<C, L>, InSupplierExpression2<C, L> {
     ...
     */
    @Override
    default <R extends Serializable> L in2(SerializableSupplier<R> property, R value) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <R extends Serializable> L in2(SerializableSupplier<R> property, R value, Predicate<R> ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L in2(SerializableIntSupplier property, int value) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L in2(SerializableIntSupplier property, int value, IntPredicate ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L in2(SerializableIntSupplier property, int[] value, Predicate<int[]> ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L in2(SerializableLongSupplier property, long value) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L in2(SerializableLongSupplier property, long value, LongPredicate ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L in2(SerializableLongSupplier property, long[] value, Predicate<long[]> ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L in2(SerializableDoubleSupplier property, double value) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L in2(SerializableDoubleSupplier property, double value, DoublePredicate ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L in2(SerializableDoubleSupplier property, double[] value, Predicate<double[]> ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
    ...
    default L in2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }
    ...
    default L in2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
