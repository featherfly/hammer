...
public interface RepositoryInExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default <T, R> L in2(SerializableFunction<T, R> name, R... values) {
        return in2(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L in2(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L in2(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return in2(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L in2(SerializableSupplier<R> property) {
     ...
     */
    @Override
    default <R> L in2(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
