...
public interface NotInSupplierExpression2<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    <R extends Serializable> L ni2(SerializableSupplier<R> property);
     ...
     * @return LogicExpression
     */
    <R extends Serializable> L ni2(SerializableSupplier<R> property, Predicate<R> ignoreStrategy);
    ...
    default L ni2(SerializableStringSupplier property) {
        return ni2(property, MatchStrategy.AUTO);
    }
    ...
    default L ni2(SerializableStringSupplier property, IgnoreStrategy ignoreStrategy) {
        return ni2(property, MatchStrategy.AUTO, ignoreStrategy);
    }
    ...
    default L ni2(SerializableStringSupplier property, MatchStrategy matchStrategy, IgnoreStrategy ignoreStrategy) {
        return ni2(property, matchStrategy, (Predicate<String>) ignoreStrategy::test);
    }
