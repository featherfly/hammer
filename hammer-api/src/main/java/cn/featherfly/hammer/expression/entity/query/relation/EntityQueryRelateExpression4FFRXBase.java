 ...
 */
public interface EntityQueryRelateExpression4FFRXBase<E, R1, R2, R3, R4,
        ...
        extends EntityQueryExpression5<E, R1, R2, R3, R4, C, L, S, Tuple3<E, R1, R2>> {
     ...
     */
    <QR extends EntityQueryRelateExpression5FFRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5FRRR
     */
    <RE extends EntityQueryRelateExpression5FFRRR<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R2>>,
     ...
     * @param <R5>         the generic type
     * @param propertyName find type object property name
     * @return EntityQueryRelateExpression5FRRP
     */
    <RE extends EntityQueryRelateExpression5FFRRP<E, R1, R2, R3, R4, R5, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple3<E, R1, R2>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple3<E, R1, R2>>,
     ...
     * @return EntityQueryRelateExpression5FRRP
     */
    <RE extends EntityQueryRelateExpression5FFRRP<E, R1, R2, R3, R4, E, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5FRRP
     */
    <RE extends EntityQueryRelateExpression5FFRRP<E, R1, R2, R3, R4, R1, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5FRRP
     */
    <RE extends EntityQueryRelateExpression5FFRRP<E, R1, R2, R3, R4, R2, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5FRRP
     */
    <RE extends EntityQueryRelateExpression5FFRRP<E, R1, R2, R3, R4, R3, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression5FRRP
     */
    <RE extends EntityQueryRelateExpression5FFRRP<E, R1, R2, R3, R4, R4, RC, RL, RS, QR>,
