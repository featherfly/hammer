...
public interface RepositoryNotInExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryNotInExpressionBase3<C, L>, NotInExpression4<C, L> {
    ...
    default <T, R> L ni4(SerializableFunction<T, R> name, R... values) {
        return ni4(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L ni4(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L ni4(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return ni4(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L ni4(SerializableSupplier<R> property) {
        return ni4(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
     ...
     */
    @Override
    default <R> L ni4(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
        return ni4(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L ni4(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return ni4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L ni4(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return ni4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}