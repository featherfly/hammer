...
public interface EntityContainsExpressionBase3<E, E2, E3, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    L co3(SerializableFunction<E3, String> name, String value, MatchStrategy queryPolicy);
     ...
     * @return LogicExpression
     */
    L co3(SerializableFunction<E3, String> name, String value, MatchStrategy queryPolicy, Predicate<String> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L co3(SerializableStringSupplier property, MatchStrategy queryPolicy);
     ...
     * @return LogicExpression
     */
    L co3(SerializableStringSupplier property, MatchStrategy queryPolicy, Predicate<String> ignoreStrategy);
