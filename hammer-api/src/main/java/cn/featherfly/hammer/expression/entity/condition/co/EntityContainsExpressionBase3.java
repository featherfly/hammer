...
public interface EntityContainsExpressionBase3<E, E2, E3, C extends ConditionExpression,
    ...
    default L co3(SerializableFunction<E3, String> name, String value) {
        return co3(name, value, QueryPolicy.AUTO);
    }
    ...
    default L co3(SerializableFunction<E3, String> name, String value, Predicate<String> ignoreStrategy) {
        return co3(name, value, QueryPolicy.AUTO, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    L co3(SerializableFunction<E3, String> name, String value, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L co3(SerializableFunction<E3, String> name, String value, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
