...
public interface EntityNotInExpression6<E, E2, E3, E4, E5, E6, C extends ConditionExpression,
     ...
     */
    L nin(Consumer<Tuple6<NotInEntityExpression<E>, NotInEntityExpression<E2>, NotInEntityExpression<E3>,
     ...
     * @return the LogicExpression
     */
    L nin(SixArgusConsumer<NotInEntityExpression<E>, NotInEntityExpression<E2>, NotInEntityExpression<E3>,
            NotInEntityExpression<E4>, NotInEntityExpression<E5>, NotInEntityExpression<E6>> notInEntityExpressions);
}