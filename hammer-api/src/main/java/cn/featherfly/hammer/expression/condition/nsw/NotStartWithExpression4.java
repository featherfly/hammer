...
public interface NotStartWithExpression4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends NotStartWithExpression3<C, L> {
     ...
     * @return LogicExpression
     */
    default L nsw4(Field name, String value, IgnoreStrategy ignoreStrategy) {
        return nsw4(name.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L nsw4(Field name, String value, Predicate<String> ignoreStrategy) {
        return nsw4(name.name(), value, ignoreStrategy);
    }
