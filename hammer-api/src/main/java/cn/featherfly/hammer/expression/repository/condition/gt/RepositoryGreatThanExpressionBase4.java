...
public interface RepositoryGreatThanExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryGreatThanExpressionBase3<C, L>, GreatThanExpression4<C, L> {
    /**
     * great than. 大于.
     *
    ...
    default L gt4(SerializableIntSupplier property) {
        return gt4(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
    ...
    default L gt4(SerializableIntSupplier property, IntPredicate ignoreStrategy) {
        return gt4(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L gt4(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return gt4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L gt4(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return gt4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}