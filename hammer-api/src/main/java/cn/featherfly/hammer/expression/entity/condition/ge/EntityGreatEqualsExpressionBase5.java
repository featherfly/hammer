...
public interface EntityGreatEqualsExpressionBase5<T, T2, T3, T4, T5, C extends ConditionExpression,
     ...
     */
    L ge5(SerializableToIntFunction<T5> name, int value);
     ...
     * @return LogicExpression
     */
    L ge5(SerializableToIntFunction<T5> name, int value, IntPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ge5(SerializableToLongFunction<T5> name, long value);
     ...
     * @return LogicExpression
     */
    L ge5(SerializableToLongFunction<T5> name, long value, LongPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ge5(SerializableToDoubleFunction<T5> name, double value);
     ...
     * @return LogicExpression
     */
    L ge5(SerializableToDoubleFunction<T5> name, double value, DoublePredicate ignoreStrategy);
