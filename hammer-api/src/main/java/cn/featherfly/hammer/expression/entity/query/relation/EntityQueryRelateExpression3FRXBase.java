 ...
 */
public interface EntityQueryRelateExpression3FRXBase<E, R1, R2, R3,
        ...
        extends EntityQueryExpression4<E, R1, R2, R3, C, L, S, Tuple2<E, R1>> {
     ...
     */
    <QR extends EntityQueryRelateExpression4FRRR<E, R1, R2, R3, R4, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression4FRR
     */
    <RE extends EntityQueryRelateExpression4FRRR<E, R1, R2, R3, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R1>>,
            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R1>>,
            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R1>>,
     ...
     * @return EntityQueryRelateExpression4FRR
     */
    <RE extends EntityQueryRelateExpression4FRRP<E, R1, R2, R3, R4, RC, RL, RS, QR>,
            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R1>>,
            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple2<E, R1>>,
            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R1>>,
     ...
     * @return EntityQueryRelateExpression4FRR
     */
    <RE extends EntityQueryRelateExpression4FRRP<E, R1, R2, R3, E, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression4FRR
     */
    <RE extends EntityQueryRelateExpression4FRRP<E, R1, R2, R3, R1, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression4FRR
     */
    <RE extends EntityQueryRelateExpression4FRRP<E, R1, R2, R3, R2, RC, RL, RS, QR>,
     ...
     * @return EntityQueryRelateExpression4FRR
     */
    <RE extends EntityQueryRelateExpression4FRRP<E, R1, R2, R3, R3, RC, RL, RS, QR>,
