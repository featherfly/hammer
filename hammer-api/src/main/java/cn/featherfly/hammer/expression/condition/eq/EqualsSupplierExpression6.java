...
public interface EqualsSupplierExpression6<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    <R> L eq6(SerializableSupplier<R> propertyValue);
     ...
     * @return LogicExpression
     */
    default <R> L eq6(SerializableSupplier<R> propertyValue, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L eq6(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy);
}