...
public interface RepositoryGreatThanExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryGreatThanExpression<C, L>, GreatThanExpression2<C, L> {
    /**
     * great than. 大于.
     *
    ...
    default L gt2(SerializableIntSupplier property) {
        return gt2(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
    ...
    default L gt2(SerializableIntSupplier property, IntPredicate ignoreStrategy) {
        return gt2(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L gt2(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return gt2(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L gt2(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return gt2(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}