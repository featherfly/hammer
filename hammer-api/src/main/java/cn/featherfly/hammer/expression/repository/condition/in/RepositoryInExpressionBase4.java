...
public interface RepositoryInExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryInExpressionBase3<C, L>, InExpression4<C, L> {
    ...
    default <T, R> L in4(SerializableFunction<T, R> name, R... values) {
        return in4(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L in4(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L in4(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return in4(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L in4(SerializableSupplier<R> property) {
        return in4(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
     ...
     */
    @Override
    default <R> L in4(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
        return in4(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L in4(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return in4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L in4(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return in4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
