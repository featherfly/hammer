...
public interface EntityLessEqualsExpressionBase4<E, E2, E3, E4, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    <R extends Date> L le4(DateSupplier<R> property);
     ...
     * @return LogicExpression
     */
    <R extends Date> L le4(DateSupplier<R> property, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <R extends Number> L le4(NumberSupplier<R> property);
     ...
     * @return LogicExpression
     */
    <R extends Number> L le4(NumberSupplier<R> property, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L le4(LocalDateSupplier property);
     ...
     * @return LogicExpression
     */
    L le4(LocalDateSupplier property, Predicate<LocalDate> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L le4(LocalTimeSupplier property);
     ...
     * @return LogicExpression
     */
    L le4(LocalTimeSupplier property, Predicate<LocalTime> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L le4(LocalDateTimeSupplier property);
     ...
     * @return LogicExpression
     */
    L le4(LocalDateTimeSupplier property, Predicate<LocalDateTime> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L le4(StringSupplier property, Predicate<String> ignoreStrategy);
    ...
    //     * @return LogicExpression
    //     */
    //    <R, N extends Number> L le4(SerializableSupplier<R> repository, ReturnNumberFunction<R, N> property);
    //
    //    /**
    //     * less and equals. 小于等于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <R, D extends Date> L le4(SerializableSupplier<R> repository, ReturnDateFunction<R, D> property);
    //
    //    /**
    //     * less and equals. 小于等于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L le4(SerializableSupplier<T> repository, ReturnLocalTimeFunction<T> property);
    //
    //    /**
    //     * less and equals. 小于等于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L le4(SerializableSupplier<T> repository, ReturnLocalDateFunction<T> property);
    //
    //    /**
    //     * less and equals. 小于等于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L le4(SerializableSupplier<T> repository, ReturnLocalDateTimeFunction<T> property);
    //
    //    /**
    //     * less and equals. 小于等于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L le4(SerializableSupplier<T> repository, ReturnStringFunction<T> property);
}