...
public interface RepositoryNotEqualsExpression4<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    L ne(Consumer<Tuple4<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression, EqualsNotRepositoryExpression,
     ...
     * @return the LogicExpression
     */
    L ne(FourArgusConsumer<EqualsNotRepositoryExpression, EqualsNotRepositoryExpression, EqualsNotRepositoryExpression,
            EqualsNotRepositoryExpression> equalsRepositoryExpressions);
}