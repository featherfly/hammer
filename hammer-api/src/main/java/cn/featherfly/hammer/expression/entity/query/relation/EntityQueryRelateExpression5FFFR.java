 ...
 */
public interface EntityQueryRelateExpression5FFFR<E, R1, R2, R3, R4, R5,
        ...
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple4<E, R1, R2, R3>>, EntityQueryRelate<F> {
    // TODO 加入join方法
}
