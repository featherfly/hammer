...
public interface RepositoryNotInExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryNotInExpressionBase4<C, L>, NotInExpression5<C, L> {
    ...
    default <T, R> L ni5(SerializableFunction<T, R> name, R... values) {
        return ni5(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L ni5(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L ni5(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return ni5(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L ni5(SerializableSupplier<R> property) {
        return ni5(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
     ...
     */
    @Override
    default <R> L ni5(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
        return ni5(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L ni5(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return ni5(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L ni5(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return ni5(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}