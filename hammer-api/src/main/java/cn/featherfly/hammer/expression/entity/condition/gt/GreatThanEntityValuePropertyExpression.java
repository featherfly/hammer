...
/**
 * The Interface GreatThanEntityValuePropertyExpression.
 *
 * @author zhongj
 * @param <E> the element type
 */
public interface GreatThanEntityValuePropertyExpression<E> extends CompareEntityValuePropertyExpression<E> {
