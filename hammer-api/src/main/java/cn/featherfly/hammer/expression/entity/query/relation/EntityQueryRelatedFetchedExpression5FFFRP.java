...
/**
 * The Interface EntityQueryRelatedFetchedExpression5FFFRP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression5FFFRP<E, R1, R2, R3, R4, R5,
        ...
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple4<E, R1, R2, R3>> {
    // 目前就实现5次关联（join）
}
