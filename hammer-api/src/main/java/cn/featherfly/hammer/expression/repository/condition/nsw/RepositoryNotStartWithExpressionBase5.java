...
public interface RepositoryNotStartWithExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L nsw5(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return nsw5(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L nsw5(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return nsw5(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
