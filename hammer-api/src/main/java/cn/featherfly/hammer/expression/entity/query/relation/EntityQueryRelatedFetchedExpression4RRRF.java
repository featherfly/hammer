...
public interface EntityQueryRelatedFetchedExpression4RRRF<E, R1, R2, R3, R4,
     ...
     * @return EntityQueryRelateExpression5RRRF
     */
    <QR extends EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, R5, RC, RL, RS, QRF, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRF
     */
    <RE extends EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, R5, RC, RL, RS, QR, QRC, QRL, QRS>,
            RC extends EntityQueryConditionGroupExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R4>>,
            RL extends EntityQueryConditionGroupLogicExpression6<E, R1, R2, R3, R4, R5, RC, RL, RS, Tuple2<E, R4>>,
            RS extends EntityQuerySortExpression6<E, R1, R2, R3, R4, R5, Tuple2<E, R4>>,
     ...
     * @return EntityQueryRelateExpression5RRRF
     */
    <RE extends EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRF
     */
    <RE extends EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRF
     */
    <RE extends EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRF
     */
    <RE extends EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression5RRRF
     */
    <RE extends EntityQueryRelateExpression5RRRF<E, R1, R2, R3, R4, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
