...
public interface RepositoryNotEqualsExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    default <T> L ne5(SerializableToLongFunction<T> name, boolean value) {
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToLongFunction<T> name, char value) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value);
    }
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToLongFunction<T> name, char value, CharPredicate ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToLongFunction<T> name, int value) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value);
    }
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToLongFunction<T> name, int value, IntPredicate ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToLongFunction<T> name, long value) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value);
    }
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToLongFunction<T> name, long value, LongPredicate ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToDoubleFunction<T> name, double value) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value);
    }
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToDoubleFunction<T> name, double value, DoublePredicate ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <T, R> L ne5(SerializableFunction<T, R> name, R value, IgnoreStrategy ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToStringFunction<T> name, String value) {
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToStringFunction<T> name, String value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T> L ne5(SerializableToStringFunction<T> name, String value, Predicate<String> ignoreStrategy) {
        return ne5(name, value, MatchStrategy.AUTO, ignoreStrategy);
    }
    ...
    default <T> L ne5(SerializableToStringFunction<T> name, String value, MatchStrategy matchStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value, matchStrategy);
    }
    ...
    default L ne5(SerializableBooleanSupplier propertyValue) {
        return ne5(LambdaUtils.getLambdaPropertyName(propertyValue), propertyValue.getAsBoolean());
    }
    ...
    default L ne5(SerializableCharSupplier propertyValue) {
        return ne5(LambdaUtils.getLambdaPropertyName(propertyValue), propertyValue.get());
    }
    ...
    default L ne5(SerializableCharSupplier propertyValue, CharPredicate ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(propertyValue), propertyValue.get(), ignoreStrategy);
    }
     ...
     */
    @Override
    default <R extends Date> L ne5(SerializableDateSupplier<R> propertyValue, Predicate<R> ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(propertyValue), propertyValue.get(), ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L ne5(SerializableSupplier<R> propertyValue) {
        return ne5(LambdaUtils.getLambdaPropertyName(propertyValue), propertyValue.get());
    }
     ...
     */
    @Override
    default <R> L ne5(SerializableSupplier<R> propertyValue, Predicate<R> ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(propertyValue), propertyValue.get(), ignoreStrategy);
    }
}