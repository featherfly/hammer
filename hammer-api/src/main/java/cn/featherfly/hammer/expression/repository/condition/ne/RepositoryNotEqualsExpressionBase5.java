...
public interface RepositoryNotEqualsExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryNotEqualsExpressionBase4<C, L>, NotEqualsExpression5<C, L>,
        NotEqualsSupplierExpression5<C, L> {
     ...
     * @return LogicExpression
     */
    default <T, R extends Serializable> L ne5(SerializableFunction<T, R> name, R value, IgnoreStrategy ignoreStrategy) {
        return ne5(LambdaUtils.getLambdaPropertyName(name), value, ignoreStrategy);
    }
