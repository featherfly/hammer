...
public interface EntityNotEqualsExpressionBase4<T, T2, T3, T4, C extends ConditionExpression,
     ...
     */
    <R extends Serializable> L ne4(SerializableFunction<T4, R> name, R value);
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L ne4(SerializableFunction<T4, R> name, R value, IgnoreStrategy ignoreStrategy) {
        return ne4(name, value, ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    <R extends Serializable> L ne4(SerializableFunction<T4, R> name, R value, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    default L ne4(SerializableToStringFunction<T4> name, String value, MatchStrategy matchStrategy,
        IgnoreStrategy ignoreStrategy) {
        return ne4(name, value, matchStrategy, ignoreStrategy::test);
    }
