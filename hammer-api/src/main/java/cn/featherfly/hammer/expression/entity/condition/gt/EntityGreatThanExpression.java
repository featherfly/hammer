...
public interface EntityGreatThanExpression<E, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    L gt(SerializableToIntFunction<E> name, int value, IntPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt(SerializableToLongFunction<E> name, long value, LongPredicate ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt(SerializableToDoubleFunction<E> name, double value, DoublePredicate ignoreStrategy);
