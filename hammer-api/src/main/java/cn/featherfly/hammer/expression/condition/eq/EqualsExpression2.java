...
public interface EqualsExpression2<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    L eq2(String name, Object value);
     ...
     * @return LogicExpression
     */
    default <R> L eq2(String name, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L eq2(String name, R value, Predicate<R> ignoreStrategy);
    // ----------------------------------------------------------------------------------------------------------------
     ...
     * @return LogicExpression
     */
    default L eq2(Field field, Object value) {
        return eq2(field.name(), value);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq2(Field field, R value, IgnoreStrategy ignoreStrategy) {
        return eq2(field.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq2(Field field, R value, Predicate<R> ignoreStrategy) {
        return eq2(field.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L eq2(AliasField field, Object value) {
        return eq2(field.getAliasOrName(), value);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq2(AliasField field, R value, IgnoreStrategy ignoreStrategy) {
        return eq2(field.getAliasOrName(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <R> L eq2(AliasField field, R value, Predicate<R> ignoreStrategy) {
        return eq2(field.getAliasOrName(), value, ignoreStrategy);
    }
}