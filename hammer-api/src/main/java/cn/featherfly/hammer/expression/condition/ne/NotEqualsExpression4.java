...
public interface NotEqualsExpression4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends NotEqualsExpression3<C, L>, NotEqualsSupplierExpression4<C, L> {
    /**
     * not equals. 不等于.
     *
     * @param name  the name
     ...
     * @return LogicExpression
     */
    L ne4(String name, Object value);
     ...
     * @return LogicExpression
     */
    default <R> L ne4(String name, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R> L ne4(String name, R value, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    default L ne4(Field field, Object value) {
     ...
     * @return LogicExpression
     */
    default <R> L ne4(Field field, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <R> L ne4(Field field, R value, Predicate<R> ignoreStrategy) {
        return ne4(field.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default L ne4(AliasField field, Object value) {
     ...
     * @return LogicExpression
     */
    default <R> L ne4(AliasField field, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <R> L ne4(AliasField field, R value, Predicate<R> ignoreStrategy) {
        return ne4(field.getAliasOrName(), value, ignoreStrategy);
    }
