...
public abstract class AbstractBetweenEntityExpression<T, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractConditionEntityExpression<MulitiEntityBetweenExpression<C, L>>
     ...
     */
    protected AbstractBetweenEntityExpression(int index, MulitiEntityBetweenExpression<C, L> expression,
