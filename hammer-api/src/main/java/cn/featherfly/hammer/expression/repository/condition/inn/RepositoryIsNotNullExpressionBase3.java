...
public interface RepositoryIsNotNullExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryIsNotNullExpressionBase2<C, L>, IsNotNullExpression3<C, L>, IsNotNullSupplierExpression3<C, L> {
    ...
    @Override
    default <R> L inn3(SerializableSupplier<R> name, Boolean value) {
        return inn3(LambdaUtils.getLambdaPropertyName(name), value);
    }
}