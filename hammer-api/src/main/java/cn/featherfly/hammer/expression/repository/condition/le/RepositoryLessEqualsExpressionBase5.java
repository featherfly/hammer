...
public interface RepositoryLessEqualsExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L le5(SerializableIntSupplier property) {
        return le5(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
    ...
    default L le5(SerializableIntSupplier property, IntPredicate ignoreStrategy) {
        return le5(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L le5(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return le5(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L le5(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return le5(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}