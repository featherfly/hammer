...
public interface EqualsExpression4<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    <R extends Serializable> L eq4(String name, R value);
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L eq4(String name, R value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    <R extends Serializable> L eq4(String name, R value, Predicate<R> ignoreStrategy);
    // ----------------------------------------------------------------------------------------------------------------
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L eq4(Field field, R value) {
        return eq4(field.name(), value);
    }
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L eq4(Field field, R value, IgnoreStrategy ignoreStrategy) {
        return eq4(field.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L eq4(Field field, R value, Predicate<R> ignoreStrategy) {
        return eq4(field.name(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L eq4(AliasField field, R value) {
        return eq4(field.getAliasOrName(), value);
    }
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L eq4(AliasField field, R value, IgnoreStrategy ignoreStrategy) {
        return eq4(field.getAliasOrName(), value, ignoreStrategy);
    }
     ...
     * @return LogicExpression
     */
    default <R extends Serializable> L eq4(AliasField field, R value, Predicate<R> ignoreStrategy) {
        return eq4(field.getAliasOrName(), value, ignoreStrategy);
    }
}