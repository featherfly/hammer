...
public interface RepositoryEndWithExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryEndWithExpressionBase2<C, L>, EndWithExpression3<C, L> {
    ...
    default L ew3(SerializableStringSupplier propertyValue, MatchStrategy matchStrategy) {
        return ew3(LambdaUtils.getLambdaPropertyName(propertyValue), propertyValue.get(), matchStrategy);
    }
