...
public interface RepositoryQueryExpression<C extends RepositoryQueryConditionsGroupExpression<C, L, S>,
        ...
        extends RepositoryQueryWhereExpression<C, L, S>, Queryable<S>, QueryListExecutor, QueryConditionLimit,
        QueryCountExecutor, ConfigureExpression<RepositoryQueryExpression<C, L, S>, QueryConfig, QueryConditionConfig> {
}
