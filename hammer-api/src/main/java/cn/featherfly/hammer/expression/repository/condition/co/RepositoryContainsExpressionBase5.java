...
public interface RepositoryContainsExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryContainsExpressionBase4<C, L>, ContainsExpression5<C, L>, ContainsSupplierExpression5<C, L> {
    ...
    default L co5(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return co5(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L co5(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return co5(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}