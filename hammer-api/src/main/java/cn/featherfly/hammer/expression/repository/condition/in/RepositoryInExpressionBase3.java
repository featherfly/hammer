...
public interface RepositoryInExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default <T, R> L in3(SerializableFunction<T, R> name, R... values) {
        return in3(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L in3(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L in3(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return in3(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L in3(SerializableSupplier<R> property) {
        return in3(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
     ...
     */
    @Override
    default <R> L in3(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
        return in3(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L in3(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return in3(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L in3(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return in3(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
