...
public interface EntityContainsExpressionBase4<E, E2, E3, E4, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    default L co4(StringSupplier property) {
     ...
     * @return LogicExpression
     */
    default L co4(StringSupplier property, Predicate<String> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    L co4(StringSupplier property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L co4(StringSupplier property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
