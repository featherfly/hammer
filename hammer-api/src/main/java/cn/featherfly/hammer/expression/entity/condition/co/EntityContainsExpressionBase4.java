...
public interface EntityContainsExpressionBase4<E, E2, E3, E4, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    L co4(SerializableFunction<E4, String> name, String value, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L co4(SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    L co4(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
