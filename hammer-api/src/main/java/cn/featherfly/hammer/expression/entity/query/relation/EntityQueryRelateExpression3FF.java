 ...
 */
public interface EntityQueryRelateExpression3FF<E, R1, R2, R3,
        ...
        extends EntityQueryExpression4<E, R1, R2, R3, C, L, S, Tuple3<E, R1, R2>>, EntityQueryRelate<F> {
     ...
     */
    <QR extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R4, RC, RL, RS, QRF, QRC, QRL, QRS>,
    ...
    //     * @return EntityQueryRelateExpression4FFR
    //     */
    //    <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R4, RC, RL, RS, QR, QRC, QRL, QRS>,
    //            RC extends EntityQueryConditionGroupExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple3<E, R1, R2>>,
    //            RL extends EntityQueryConditionGroupLogicExpression5<E, R1, R2, R3, R4, RC, RL, RS, Tuple3<E, R1, R2>>,
    //            RS extends EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple3<E, R1, R2>>,
     ...
     * @return EntityQueryRelateExpression4FFR
     */
    <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, E, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression4FFR
     */
    <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R1, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression4FFR
     */
    <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R2, RC, RL, RS, QR, QRC, QRL, QRS>,
     ...
     * @return EntityQueryRelateExpression4FFR
     */
    <RE extends EntityQueryRelateExpression4FFR<E, R1, R2, R3, R3, RC, RL, RS, QR, QRC, QRL, QRS>,
