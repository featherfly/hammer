...
public interface RepositoryInExpressionBase5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryInExpressionBase4<C, L>, InExpression5<C, L> {
    ...
    default <T, R> L in5(SerializableFunction<T, R> name, R... values) {
        return in5(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L in5(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L in5(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return in5(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L in5(SerializableSupplier<R> property) {
     ...
     */
    @Override
    default <R> L in5(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
