...
public interface RepositoryLessEqualsExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L le3(SerializableIntSupplier property) {
        return le3(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
    ...
    default L le3(SerializableIntSupplier property, IntPredicate ignoreStrategy) {
        return le3(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L le3(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return le3(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L le3(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return le3(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}