...
/**
 * The Class AbstractEndWithEntityExpression.
 *
 * @author zhongj
...
public abstract class AbstractEndWithEntityExpression<E, C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends AbstractConditionEntityExpression<MulitiEntityEndWithExpression<C, L>>
     ...
     */
    protected AbstractEndWithEntityExpression(int index, MulitiEntityEndWithExpression<C, L> expression,
