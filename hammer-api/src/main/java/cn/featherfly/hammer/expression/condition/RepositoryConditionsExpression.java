...
public interface RepositoryConditionsExpression<C extends RepositoryConditionsExpression<C, L>,
        ...
        RepositoryEqualsExpression<C, L>, RepositoryGreatEqualsExpressoin<C, L>, RepositoryGreatThanExpressoin<C, L>,
        RepositoryInExpression<C, L>, RepositoryIsNotNullExpression<C, L>, RepositoryIsNullExpression<C, L>,
        RepositoryLessEqualsExpressoin<C, L>, RepositoryLessThanExpressoin<C, L>, RepositoryNotEqualsExpression<C, L>,
