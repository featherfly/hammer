...
public interface EntityEndWithExpressionBase5<E, E2, E3, E4, E5, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    default L ew5(StringSupplier property) {
     ...
     * @return LogicExpression
     */
    default L ew5(StringSupplier property, Predicate<String> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    L ew5(StringSupplier property, QueryPolicy queryPolicy);
     ...
     * @return LogicExpression
     */
    L ew5(StringSupplier property, QueryPolicy queryPolicy, Predicate<String> ignoreStrategy);
