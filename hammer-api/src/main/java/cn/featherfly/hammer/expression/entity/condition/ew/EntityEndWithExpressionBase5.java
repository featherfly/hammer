...
public interface EntityEndWithExpressionBase5<E, E2, E3, E4, E5, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    L ew5(SerializableStringSupplier property, MatchStrategy matchStrategy);
     ...
     * @return LogicExpression
     */
    L ew5(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy);
