...
public interface EntityInExpressionBase3<T, T2, T3, C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    <R> L in3(SerializableFunction<T3, R> name, R value, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <R> L in3(SerializableFunction<T3, R> name, Collection<R> value, Predicate<Collection<R>> ignoreStrategy);
