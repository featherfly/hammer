...
public interface EntityGreatThanExpressionBase4<E, E2, E3, E4, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    <R extends Date> L gt4(DateSupplier<R> property);
     ...
     * @return LogicExpression
     */
    <R extends Date> L gt4(DateSupplier<R> property, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <R extends Number> L gt4(NumberSupplier<R> property);
     ...
     * @return LogicExpression
     */
    <R extends Number> L gt4(NumberSupplier<R> property, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt4(LocalDateSupplier property);
     ...
     * @return LogicExpression
     */
    L gt4(LocalDateSupplier property, Predicate<LocalDate> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt4(LocalTimeSupplier property);
     ...
     * @return LogicExpression
     */
    L gt4(LocalTimeSupplier property, Predicate<LocalTime> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt4(LocalDateTimeSupplier property);
     ...
     * @return LogicExpression
     */
    L gt4(LocalDateTimeSupplier property, Predicate<LocalDateTime> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L gt4(StringSupplier property, Predicate<String> ignoreStrategy);
    ...
    //     * @return LogicExpression
    //     */
    //    <R, N extends Number> L gt4(SerializableSupplier<R> repository, ReturnNumberFunction<R, N> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <R, D extends Date> L gt4(SerializableSupplier<R> repository, ReturnDateFunction<R, D> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt4(SerializableSupplier<T> repository, ReturnLocalTimeFunction<T> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt4(SerializableSupplier<T> repository, ReturnLocalDateFunction<T> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt4(SerializableSupplier<T> repository, ReturnLocalDateTimeFunction<T> property);
    //
    //    /**
    //     * great than. 大于.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <T> L gt4(SerializableSupplier<T> repository, ReturnStringFunction<T> property);
}