...
public interface EntityIsNullExpression5<E, E2, E3, E4, E5, C extends ConditionExpression,
    ...
    //            V> L isn(
    //                    Function<
    //                            Tuple5<QueryEntityRepository<E>, QueryEntityRepository<E2>, QueryEntityRepository<E3>,
    //                                    QueryEntityRepository<E4>, QueryEntityRepository<E5>>,
    ...
    //            SerializableFunction5<E5, R> name) {
    //        return isn(entities, name, true);
    //    }
    //
    //    /**
    ...
    //            Function<Tuple5<QueryEntityRepository<E>, QueryEntityRepository<E2>, QueryEntityRepository<E3>,
    //                    QueryEntityRepository<E4>, QueryEntityRepository<E5>>, QueryEntityRepository<E5>> entities,
    //            SerializableFunction5<E5, R> name, Boolean value);
    //
    //    /**
    //     * is null.
    //     *
     ...
     */
    L isn(Consumer<Tuple5<IsNullEntityExpression<E>, IsNullEntityExpression<E2>, IsNullEntityExpression<E3>,
     ...
     * @return the LogicExpression
     */
    L isn(FiveArgusConsumer<IsNullEntityExpression<E>, IsNullEntityExpression<E2>, IsNullEntityExpression<E3>,
            IsNullEntityExpression<E4>, IsNullEntityExpression<E5>> isNullEntityExpressions);
}