...
public interface BetweenExpression6<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     * @return LogicExpression
     */
    <N extends Number> L ba6(String name, N min, N max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <D extends Date> L ba6(String name, D min, D max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ba6(String name, LocalTime min, LocalTime max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ba6(String name, LocalDate min, LocalDate max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ba6(String name, LocalDateTime min, LocalDateTime max, IgnoreStrategy ignoreStrategy);
     ...
     * @return LogicExpression
     */
    L ba6(String name, String min, String max, IgnoreStrategy ignoreStrategy);
