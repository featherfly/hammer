...
public interface EntityEndWithExpression3<E, E2, E3, C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    //     */
    //    default L ew(Function<Tuple3<QueryEntityRepository<E>, QueryEntityRepository<E2>, QueryEntityRepository<E3>>,
    //            QueryEntityRepository<E>> entities, SerializableFunction<E, String> name, String value) {
    //        return ew(entities, name, value, QueryPolicy.AUTO);
    //    }
    //
    //    /**
    //     * end with value. 以value结尾.
    ...
    //        return ew(entities, name, value, QueryPolicy.AUTO, ignoreStrategy);
    //    }
    //
    //    /**
    //     * end with value. 以value结尾.
    ...
    //     * @return the l
    //     */
    //    L ew(Function<Tuple3<QueryEntityRepository<E>, QueryEntityRepository<E2>, QueryEntityRepository<E3>>,
    //            QueryEntityRepository<E>> entities, SerializableFunction<E, String> name, String value,
