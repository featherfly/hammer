...
public interface RepositoryNotInExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default <T, R> L ni3(SerializableFunction<T, R> name, R... values) {
        return ni3(LambdaUtils.getLambdaPropertyName(name), values);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    default <T, R> L ni3(SerializableFunction<T, R> name, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T, R> L ni3(SerializableFunction<T, R> name, R[] values, Predicate<R[]> ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(name), values, ignoreStrategy);
    }
     ...
     */
    @Override
    default <R> L ni3(SerializableSupplier<R> property) {
     ...
     */
    @Override
    default <R> L ni3(SerializableSupplier<R> property, Predicate<R> ignoreStrategy) {
