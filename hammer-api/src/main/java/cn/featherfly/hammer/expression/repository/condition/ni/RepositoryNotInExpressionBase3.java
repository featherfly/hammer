...
public interface RepositoryNotInExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    extends RepositoryNotInExpressionBase2<C, L>, NotInExpression3<C, L>, NotInSupplierExpression3<C, L> {
     ...
     */
    @Override
    default <R extends Serializable> L ni3(SerializableSupplier<R> property, R value) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default <R extends Serializable> L ni3(SerializableSupplier<R> property, R value, Predicate<R> ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L ni3(SerializableIntSupplier property, int value) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L ni3(SerializableIntSupplier property, int value, IntPredicate ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L ni3(SerializableIntSupplier property, int[] value, Predicate<int[]> ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L ni3(SerializableLongSupplier property, long value) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L ni3(SerializableLongSupplier property, long value, LongPredicate ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L ni3(SerializableLongSupplier property, long[] value, Predicate<long[]> ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L ni3(SerializableDoubleSupplier property, double value) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value);
    }
     ...
     */
    @Override
    default L ni3(SerializableDoubleSupplier property, double value, DoublePredicate ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
     ...
     */
    @Override
    default L ni3(SerializableDoubleSupplier property, double[] value, Predicate<double[]> ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, ignoreStrategy);
    }
    ...
    default L ni3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }
    ...
    default L ni3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return ni3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
