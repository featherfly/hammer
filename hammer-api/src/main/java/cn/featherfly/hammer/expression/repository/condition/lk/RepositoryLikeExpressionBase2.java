...
public interface RepositoryLikeExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    default L lk2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return lk2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L lk2(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return lk2(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
}