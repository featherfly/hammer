...
public interface RepositoryLikeExpressionBase2<C extends ConditionExpression, L extends LogicExpression<C, L>>
     ...
     */
    default <T> L lk2(SerializableToStringFunction<T> name, String value) {
     ...
     * @return LogicExpression
     */
    default <T> L lk2(SerializableToStringFunction<T> name, String value, IgnoreStrategy ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <T> L lk2(SerializableToStringFunction<T> name, String value, Predicate<String> ignoreStrategy) {
        return lk2(name, value, MatchStrategy.AUTO, ignoreStrategy);
    }
    ...
    default <T> L lk2(SerializableToStringFunction<T> name, String value, MatchStrategy matchStrategy) {
        return lk2(LambdaUtils.getLambdaPropertyName(name), value, matchStrategy);
    }
    ...
    @Override
    default L lk2(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return lk2(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }

    @Override
    default L lk2(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return lk2(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}