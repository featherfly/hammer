...
public interface EntityNotInExpressionBase6<E, E2, E3, E4, E5, E6, C extends ConditionExpression,
    ...
    //     */
    //    L ni6(Consumer<EntityNotInExpressionBase2<E, C, L>> consumer);
     ...
     * @return LogicExpression
     */
    L ni6(SerializableToIntFunction6<E6> name, int value, Predicate<Integer> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <R> L ni6(SerializableIntSupplier property);
     ...
     * @return LogicExpression
     */
    <R> L ni6(SerializableIntSupplier property, Predicate<Integer> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <R> L ni6(SerializableLongSupplier property);
     ...
     * @return LogicExpression
     */
    <R> L ni6(SerializableLongSupplier property, Predicate<Long> ignoreStrategy);
    ...
    //     * @return LogicExpression
    //     */
    //    <R> L ni6(SerializableSupplier1<R[]> property);
    //
    //    /**
    //     * values not in. 不包含指定，sql中的not in.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <R> L ni6(SerializableSupplier1<R[]> property, Predicate<R[]> ignoreStrategy);
    //
    //    /**
    //     * values not in. 不包含指定，sql中的not in.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <R> L ni6(SerializableSupplier2<Collection<R>> property);
    //
    //    /**
    //     * values not in. 不包含指定，sql中的not in.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <R> L ni6(SerializableSupplier2<Collection<R>> property, Predicate<Collection<R>> ignoreStrategy);
    ...
    //     * @return LogicExpression
    //     */
    //    <R, V> L ni6(SerializableFunction<E6, R> repository, SerializableFunction<R, V> property, V value);
    //
    //    /**
    //     * values not in. 不包含指定，sql中的not in.
    //     *
    ...
    //     * @return LogicExpression
    //     */
    //    <R, V> L ni6(SerializableSupplier<R> repository, SerializableFunction<R, V> property);
}