...
public interface RepositoryLessThanExpressionBase4<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends RepositoryLessThanExpressionBase3<C, L>, LessThanExpression4<C, L> {
    /**
     * less than. 小于.
     *
    ...
    default L lt4(SerializableIntSupplier property) {
        return lt4(LambdaUtils.getLambdaPropertyName(property), property.get());
    }
    ...
    default L lt4(SerializableIntSupplier property, IntPredicate ignoreStrategy) {
        return lt4(LambdaUtils.getLambdaPropertyName(property), property.get(), ignoreStrategy);
    }
    ...
    default L lt4(SerializableStringSupplier property, MatchStrategy matchStrategy) {
        return lt4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy);
    }
    ...
    default L lt4(SerializableStringSupplier property, MatchStrategy matchStrategy, Predicate<String> ignoreStrategy) {
        return lt4(LambdaUtils.getLambdaPropertyName(property), property.get(), matchStrategy, ignoreStrategy);
    }
}