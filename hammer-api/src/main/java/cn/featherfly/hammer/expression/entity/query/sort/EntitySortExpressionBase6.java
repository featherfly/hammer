...
public interface EntitySortExpressionBase6<E, E2, E3, E4, E5, E6, S extends EntitySortedExpression<E, S>>
     ...
     * @return the s
     */
    default <R> S order6(SortOperator order, SerializableFunction<E6, R> names) {
        switch (order) {
            case DESC:
                return desc6(names);
            default:
     ...
     * @return the s
     */
    default S order6(SortOperator order, @SuppressWarnings("unchecked") SerializableFunction<E6, ?>... names) {
        switch (order) {
            case DESC:
                return desc6(names);
            default:
