...
/**
 * The Interface EntityQueryRelatedFetchedExpression5FRRFP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression5FRRFP<E, R1, R2, R3, R4, R5,
        ...
        extends EntityQueryExpression6<E, R1, R2, R3, R4, R5, C, L, S, Tuple3<E, R1, R4>> {
    // 目前就实现5次关联（join）
}
