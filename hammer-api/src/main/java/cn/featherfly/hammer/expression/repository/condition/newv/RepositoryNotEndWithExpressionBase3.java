...
public interface RepositoryNotEndWithExpressionBase3<C extends ConditionExpression, L extends LogicExpression<C, L>>
    ...
    NotEndWithSupplierExpression3<C, L> {
    ...
    default L new3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy) {
        return new3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy);
    }

    @Override
    default L new3(SerializableStringSupplier property, String value, MatchStrategy matchStrategy,
        Predicate<String> ignoreStrategy) {
        return new3(LambdaUtils.getLambdaPropertyName(property), value, matchStrategy, ignoreStrategy);
    }
