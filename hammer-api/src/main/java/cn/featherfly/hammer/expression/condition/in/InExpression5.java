...
public interface InExpression5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends InExpression4<C, L>, InSupplierExpression5<C, L> {
    /**
     ...
     * @return LogicExpression
     */
    default <R> L in5(Field field, R value) {
     ...
     * @return LogicExpression
     */
    default <R> L in5(Field field, @SuppressWarnings("unchecked") R... values) {
     ...
     * @return LogicExpression
     */
    default <R> L in5(Field field, R value, Predicate<R> ignoreStrategy) {
     ...
     * @return LogicExpression
     */
    default <R> L in5(String name, R value) {
     ...
     * @return LogicExpression
     */
    <R> L in5(String name, @SuppressWarnings("unchecked") R... values);
     ...
     * @return LogicExpression
     */
    <R> L in5(String name, R value, Predicate<R> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    default <R> L in5(AliasField field, R value) {
     ...
     * @return LogicExpression
     */
    default <R> L in5(AliasField field, @SuppressWarnings("unchecked") R... values) {
        return in5(field.getAliasOrName(), values);
    }
     ...
     * @return LogicExpression
     */
    default <R> L in5(AliasField field, R value, Predicate<R> ignoreStrategy) {
        return in5(field.getAliasOrName(), value, ignoreStrategy);
    }
}