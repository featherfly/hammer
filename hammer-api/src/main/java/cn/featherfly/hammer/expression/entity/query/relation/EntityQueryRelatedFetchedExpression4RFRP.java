...
/**
 * The Interface EntityQueryRelatedFetchedExpression4RFRP.
 *
 * @author zhongj
...
public interface EntityQueryRelatedFetchedExpression4RFRP<E, R1, R2, R3, R4,
        ...
        extends EntityQueryRelateExpression4RFRXBase<E, R1, R2, R3, R4, C, L, S> {
