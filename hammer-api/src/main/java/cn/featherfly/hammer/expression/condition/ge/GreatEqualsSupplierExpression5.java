...
public interface GreatEqualsSupplierExpression5<C extends ConditionExpression, L extends LogicExpression<C, L>>
        extends GreatEqualsSupplierExpression4<C, L> {
    /**
     ...
     * @return LogicExpression
     */
    <N extends Number> L ge5(SerializableNumberSupplier<N> property);
    ...
    default <N extends Number> L ge5(SerializableNumberSupplier<N> property, IgnoreStrategy ignoreStrategy) {
        return ge5(property, (Predicate<N>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    <N extends Number> L ge5(SerializableNumberSupplier<N> property, Predicate<N> ignoreStrategy);
     ...
     * @return LogicExpression
     */
    <D extends Date> L ge5(SerializableDateSupplier<D> property);
    ...
    default <D extends Date> L ge5(SerializableDateSupplier<D> property, IgnoreStrategy ignoreStrategy) {
        return ge5(property, (Predicate<D>) ignoreStrategy::test);
    }
     ...
     * @return LogicExpression
     */
    <D extends Date> L ge5(SerializableDateSupplier<D> property, Predicate<D> ignoreStrategy);
    ...
    default L ge5(SerializableLocalTimeSupplier property, IgnoreStrategy ignoreStrategy) {
        return ge5(property, (Predicate<LocalTime>) ignoreStrategy::test);
    }
    ...
    default L ge5(SerializableLocalDateSupplier property, IgnoreStrategy ignoreStrategy) {
        return ge5(property, (Predicate<LocalDate>) ignoreStrategy::test);
    }
    ...
    default L ge5(SerializableLocalDateTimeSupplier property, IgnoreStrategy ignoreStrategy) {
        return ge5(property, (Predicate<LocalDateTime>) ignoreStrategy::test);
    }
    ...
    default L ge5(SerializableStringSupplier property, MatchStrategy matchStrategy, IgnoreStrategy ignoreStrategy) {
        return ge5(property, matchStrategy, (Predicate<String>) ignoreStrategy::test);
    }
