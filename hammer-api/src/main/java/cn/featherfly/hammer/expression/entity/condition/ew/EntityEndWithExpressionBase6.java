...
public interface EntityEndWithExpressionBase6<E, E2, E3, E4, E5, E6, C extends ConditionExpression,
     ...
     * @return LogicExpression
     */
    L ew6(SerializableFunction<E6, String> name, String value, MatchStrategy queryPolicy);
     ...
     * @return LogicExpression
     */
    L ew6(SerializableStringSupplier property, MatchStrategy queryPolicy);
     ...
     * @return LogicExpression
     */
    L ew6(SerializableStringSupplier property, MatchStrategy queryPolicy, Predicate<String> ignoreStrategy);
