...
/**
 * The Interface EntityQueryRelate4RRFR.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelate4RRFR<E, R1, R2, R3, R4> extends EntityQueryRelateExpression4RRFR<E, R1, R2, R3, R4,
        EntityQueryConditionGroup5<E, R1, R2, R3, R4, Tuple2<E, R3>>,
        EntityQueryConditionGroupLogic5<E, R1, R2, R3, R4, Tuple2<E, R3>>,
        EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R3>>, EntityQueryRelatedFetched4RRFF<E, R1, R2, R3, R4>,
