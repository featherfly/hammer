 ...
 */
public interface EntityQueryRelate3FFR<E, R1, R2, R3> extends
        EntityQueryRelateExpression3FFR<E, R1, R2, R3, EntityQueryConditionGroup4<E, R1, R2, R3, Tuple3<E, R1, R2>>,
