...
/**
 * The Interface EntityQueryRelatedFetched5FFRFP.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelatedFetched5FFRFP<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelatedFetchedExpression5FFRFP<E, R1, R2, R3, R4, R5,
