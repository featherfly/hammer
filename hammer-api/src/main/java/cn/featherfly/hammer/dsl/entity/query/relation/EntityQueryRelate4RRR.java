...
/**
 * The Interface EntityQueryRelate4RRR.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelate4RRR<E, R1, R2, R3, R4> extends
        EntityQueryRelateExpression4RRR<E, R1, R2, R3, R4, EntityQueryConditionGroup5<E, R1, R2, R3, R4, E>,
