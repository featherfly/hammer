 ...
 */
public interface RepositoryOnExpression5<O> extends RepositoryOnExpression<O> {
    /**
     * on.
     *
     ...
     */
    O on(SixArgusFunction<RepositoryFieldOnlyExpression, RepositoryFieldOnlyExpression, RepositoryFieldOnlyExpression,
