 ...
 */
public interface EntityQueryRelate4FFRXBase<E, R1, R2, R3, R4> {
     ...
     */
    <R5> EntityQueryRelatedExpression<E, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
     ...
     * @retirm EntityQueryRelatedExpression
     */
    <R5> EntityQueryRelatedExpression<R1, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
     ...
     * @retirm EntityQueryRelatedExpression
     */
    <R5> EntityQueryRelatedExpression<R2, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
     ...
     * @retirm EntityQueryRelatedExpression
     */
    <R5> EntityQueryRelatedExpression<R3, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
     ...
     */
    <R5> EntityQueryRelatedExpression<R4, R5, EntityQueryRelate5FFRRR<E, R1, R2, R3, R4, R5>,
     ...
     */
    <R5> EntityQueryRelate5FFRRP<E, R1, R2, R3, R4, R5> join5(SerializableFunction1<R4, R5> propertyName);
