...
/**
 * The Interface EntityQueryRelate5RFFRR.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public interface EntityQueryRelate5RFFRR<E, R1, R2, R3, R4, R5>
        extends QueryRelateExpression<EntityQueryRelatedFetched5RFFRF<E, R1, R2, R3, R4, R5>>,
