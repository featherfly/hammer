...
/**
 * The Interface EntityQueryRelatedFetched5RFFFP.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelatedFetched5RFFFP<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelatedFetchedExpression5RFFFP<E, R1, R2, R3, R4, R5,
