...
/**
 * The Interface EntityQueryRelatedFetched5FFFFP.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelatedFetched5FFFFP<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelatedFetchedExpression5FFFFP<E, R1, R2, R3, R4, R5,
