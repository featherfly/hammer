...
/**
 * The Interface EntityQueryRelatedFetched5RRRFP.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelatedFetched5RRRFP<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelatedFetchedExpression5RRRFP<E, R1, R2, R3, R4, R5,
