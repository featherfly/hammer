 ...
 */
public interface EntityQueryRelate5FRRRP<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelateExpression5FRRRP<E, R1, R2, R3, R4, R5,
                ...
                EntityQueryRelatedFetched5FRRRP<E, R1, R2, R3, R4, R5>>,
