 ...
 */
public interface EntityQueryFetchedOnePropertyCompat<E, V>
    extends EntityQueryRelateBase<E>, EntityQueryValueCompat<E, V, EntityQueryFetchedOnePropertyCompat<E, V>>,
