 ...
 */
public interface EntityQueryRelatedFetched3FRP<E, R1, R2, R3> extends
        EntityQueryRelatedFetchedExpression3FRP<E, R1, R2, R3, EntityQueryConditionGroup4<E, R1, R2, R3, Tuple2<E, R1>>,
                EntityQueryConditionGroupLogic4<E, R1, R2, R3, Tuple2<E, R1>>,
                EntityQuerySortExpression4<E, R1, R2, R3, Tuple2<E, R1>>> {
