 ...
 */
public interface EntityQueryRelate5RRRRR<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelateExpression5RRRRR<E, R1, R2, R3, R4, R5, EntityQueryConditionGroup6<E, R1, R2, R3, R4, R5, E>,
