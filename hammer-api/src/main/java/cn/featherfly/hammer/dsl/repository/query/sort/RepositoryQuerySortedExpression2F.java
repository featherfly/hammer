 ...
 * @author zhongj
 */
public interface RepositoryQuerySortedExpression2F extends
    RepositoryQuerySortedExpression2<RepositoryQuerySortedExpression2F, LimitAwareQuery1<Map<String, Serializable>>>,
    QueryMapperSetter1 {
}
