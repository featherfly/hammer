...
public class EntityUpdateNestedValueImpl<E, T, O> implements EntityUpdateValue<E, O> {
    ...
    public EntityExecutableUpdate<E> set(
            Consumer<EntityUpdateValueExpression<E, O, EntityExecutableUpdate<E>, EntityExecutableConditionGroupExpression<E>, EntityExecutableConditionGroupLogicExpression<E>>> consumer) {
