...
public interface EntityQueryFetchCompat<E>
     ...
     * @return QueryEntityPropertiesExpression
     */
    EntityQueryFetchedPropertiesCompat<E> fetch(
     ...
     * @return the q
     */
    default <V> EntityQueryFetchedOnePropertyCompat<E, Long> count(SerializableFunction<E, V> propertyName) {
    ...
    default <V> EntityQueryFetchedOnePropertyCompat<E, Long> count(boolean distinct,
        SerializableFunction<E, V> propertyName) {
        return (EntityQueryFetchedOnePropertyCompat<E, Long>) fetch(AggregateFunction.COUNT, distinct, propertyName);
    }
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> sum(SerializableFunction<E, V> propertyName) {
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> sum(boolean distinct,
        SerializableFunction<E, V> propertyName) {
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> avg(SerializableFunction<E, V> propertyName) {
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> avg(boolean distinct,
        SerializableFunction<E, V> propertyName) {
     ...
     * @return QueryEntityPropertiesExpression
     */
    default <V> EntityQueryFetchedOnePropertyCompat<E, V> fetch(String propertyName, Class<V> propertyType) {
        return fetch(false, propertyName, propertyType);
    }
     ...
     * @return QueryEntityPropertiesExpression
     */
    <V> EntityQueryFetchedOnePropertyCompat<E, V> fetch(boolean distinct, String propertyName, Class<V> propertyType);
     ...
     * @return QueryEntityPropertiesExpression
     */
    EntityQueryFetchedPropertiesCompat<E> fetch(String... propertyNames);
     ...
     */
    default <V> EntityQueryFetchedOnePropertyCompat<E, V> fetch(AggregateFunction aggregateFunction,
        String propertyName, Class<V> propertyType) {
        return fetch(aggregateFunction, false, propertyName, propertyType);
    }
     ...
     * @return the q
     */
    default <V> EntityQueryFetchedOnePropertyCompat<E, Long> count(String propertyName) {
        return count(false, propertyName);
    }
     ...
     * @return the q
     */
    default <V> EntityQueryFetchedOnePropertyCompat<E, Long> count(boolean distinct, String propertyName) {
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> sum(String propertyName) {
        return sum(false, propertyName);
    }
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> sum(boolean distinct, String propertyName) {
        return fetch(AggregateFunction.SUM, distinct, propertyName);
    }
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> avg(String propertyName) {
        return avg(false, propertyName);
    }
     ...
     * @return the q
     */
    default <V extends Number> EntityQueryFetchedOnePropertyCompat<E, V> avg(boolean distinct, String propertyName) {
        return fetch(AggregateFunction.AVG, distinct, propertyName);
    }
