...
public interface RepositoryQueryMulitiRelate<Q extends RepositoryQueryRelateExpression<F>, F, T extends Tuple,
     ...
     * @return EntityQueryRelatedExpression
     */
    RepositoryQueryRelatedExpression<Q, F> join(Function<T2, String> repositories, String repository);
     ...
     * @return EntityQueryRelatedExpression
     */
    default RepositoryQueryRelatedExpression<Q, F> join(Function<T2, String> repositories, Repository repository) {
