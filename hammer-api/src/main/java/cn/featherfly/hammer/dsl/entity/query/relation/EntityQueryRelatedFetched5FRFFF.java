...
/**
 * The Interface EntityQueryRelatedFetched5FRFFF.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelatedFetched5FRFFF<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelatedFetchedExpression5FRFFF<E, R1, R2, R3, R4, R5,
