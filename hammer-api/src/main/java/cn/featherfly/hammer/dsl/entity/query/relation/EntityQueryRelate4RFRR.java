 ...
 */
public interface EntityQueryRelate4RFRR<E, R1, R2, R3, R4> extends EntityQueryRelateExpression4RFRR<E, R1, R2, R3, R4,
        EntityQueryConditionGroup5<E, R1, R2, R3, R4, Tuple2<E, R2>>,
        EntityQueryConditionGroupLogic5<E, R1, R2, R3, R4, Tuple2<E, R2>>,
        EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R2>>, EntityQueryRelatedFetched4RFRF<E, R1, R2, R3, R4>,
