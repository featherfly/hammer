 ...
 */
public interface EntityQueryRelate5FFRFP<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelateExpression5FFRFP<E, R1, R2, R3, R4, R5,
                ...
                EntityQueryRelatedFetched5FFRFP<E, R1, R2, R3, R4, R5>>,
