...
/**
 * The Interface EntityQueryRelate4RFF.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelate4RFF<E, R1, R2, R3, R4> extends
        EntityQueryRelateExpression4RFF<E, R1, R2, R3, R4,
                ...
                EntityQueryRelatedFetched4RFFF<E, R1, R2, R3, R4>,
                EntityQueryConditionGroup5<E, R1, R2, R3, R4, Tuple4<E, R2, R3, R4>>,
                EntityQueryConditionGroupLogic5<E, R1, R2, R3, R4, Tuple4<E, R2, R3, R4>>,
                EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple4<E, R2, R3, R4>>>,
