 ...
 */
public interface EntityQueryRelatedFetched3FFP<E, R1, R2, R3> extends
        EntityQueryRelatedFetchedExpression3FFP<E, R1, R2, R3,
                EntityQueryConditionGroup4<E, R1, R2, R3, Tuple3<E, R1, R2>>,
