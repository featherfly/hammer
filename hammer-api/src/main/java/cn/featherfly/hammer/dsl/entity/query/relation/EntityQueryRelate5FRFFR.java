...
/**
 * The Interface EntityQueryRelate5FRFFR.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public interface EntityQueryRelate5FRFFR<E, R1, R2, R3, R4, R5>
        extends QueryRelateExpression<EntityQueryRelatedFetched5FRFFF<E, R1, R2, R3, R4, R5>>,
