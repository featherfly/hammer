...
/**
 * The Interface EntityQueryRelate5RFRFR.
 *
 * @author zhongj
 * @param <E>  query type
 ...
 */
public interface EntityQueryRelate5RFRFR<E, R1, R2, R3, R4, R5>
        extends QueryRelateExpression<EntityQueryRelatedFetched5RFRFF<E, R1, R2, R3, R4, R5>>,
