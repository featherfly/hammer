 ...
 */
public interface EntityQueryRelate4FRRR<E, R1, R2, R3, R4> extends EntityQueryRelateExpression4FRRR<E, R1, R2, R3, R4,
        EntityQueryConditionGroup5<E, R1, R2, R3, R4, Tuple2<E, R1>>,
        EntityQueryConditionGroupLogic5<E, R1, R2, R3, R4, Tuple2<E, R1>>,
        EntityQuerySortExpression5<E, R1, R2, R3, R4, Tuple2<E, R1>>, EntityQueryRelatedFetched4FRRF<E, R1, R2, R3, R4>,
