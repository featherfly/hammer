 ...
 */
public interface RepositoryQuery6<C extends RepositoryQueryConditionsGroupExpression6<C, L, S, S2, Q>,
    ...
    Q extends LimitAwareQuery0<Map<String, Serializable>>> extends RepositoryQueryExpression6<C, L, S, S2, Q> {
}
