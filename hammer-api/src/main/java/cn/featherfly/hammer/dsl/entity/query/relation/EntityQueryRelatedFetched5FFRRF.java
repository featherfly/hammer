...
/**
 * The Interface EntityQueryRelatedFetched5FFRRF.
 *
 * @author zhongj
 ...
 */
public interface EntityQueryRelatedFetched5FFRRF<E, R1, R2, R3, R4, R5> extends
        EntityQueryRelatedFetchedExpression5FFRRF<E, R1, R2, R3, R4, R5,
