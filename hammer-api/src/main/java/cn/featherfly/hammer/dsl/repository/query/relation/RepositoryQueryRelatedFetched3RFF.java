...
public interface RepositoryQueryRelatedFetched3RFF
    extends RepositoryQueryRelateExpression<RepositoryQueryRelatedFetched3RFF>,
    RepositoryQueryExpression4<RepositoryQueryConditionsGroup4FFF, RepositoryQueryConditionsGroupLogic4FFF,
        RepositoryQuerySortExpression4<RepositoryQuerySortedExpression4FFF, QueryLimitExecutor3>,
        RepositoryQuerySortedExpression4FFF, QueryLimitExecutor3>,
    QueryLimitExecutor3,
    RepositoryJoin<RepositoryOnExpression4<RepositoryQueryRelate4RFFR>, RepositoryQueryRelate4RFFR> {
