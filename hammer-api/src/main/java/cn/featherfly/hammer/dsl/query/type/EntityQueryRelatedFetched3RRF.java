 ...
 */
public interface EntityQueryRelatedFetched3RRF<E, R1, R2, R3> extends
        EntityQueryRelatedFetchedExpression3RRF<E, R1, R2, R3, EntityQueryConditionGroup4<E, R1, R2, R3, Tuple2<E, R3>>,
