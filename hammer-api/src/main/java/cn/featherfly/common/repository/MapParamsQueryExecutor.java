...
public interface MapParamsQueryExecutor<E0> {
     ...
     * @return           entity
     */
    <T> T single(E0 execution, Class<T> mapType, Map<String, Object> params);
     ...
     * @return           the tuple 2
     */
    default <T1, T2> Tuple2<T1, T2> single(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
    ...
    default <T1, T2, T3> Tuple3<T1, T2, T3> single(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Map<String, Object> params) {
    ...
    <T1, T2, T3> Tuple3<T1, T2, T3> single(E0 execution, Class<T1> mapType1, Class<T2> mapType2, Class<T3> mapType3,
        Tuple3<String, String, String> prefixes, Map<String, Object> params);
    ...
    default <T1, T2, T3, T4> Tuple4<T1, T2, T3, T4> single(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Class<T4> mapType4, Map<String, Object> params) {
    ...
    default <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> single(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Class<T4> mapType4, Class<T5> mapType5, Map<String, Object> params) {
     ...
     * @return           entity
     */
    <T> T unique(E0 execution, Class<T> mapType, Map<String, Object> params);
     ...
     * @return           the tuple 2
     */
    default <T1, T2> Tuple2<T1, T2> unique(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Map<String, Object> params) {
     ...
     * @return           entity list
     */
    <T> List<T> list(E0 execution, Class<T> mapType, Map<String, Object> params);
     ...
     * @return           entity list
     */
    <T> List<T> list(E0 execution, Class<T> mapType, Map<String, Object> params, int offset, int limit);
     ...
     * @return           entity list
     */
    default <T> List<T> list(E0 execution, Class<T> mapType, Map<String, Object> params, Page page) {
     ...
     */
    default <T1, T2, T3> List<Tuple3<T1, T2, T3>> list(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Map<String, Object> params, int offset, int limit) {
     ...
     */
    default <T1, T2, T3> List<Tuple3<T1, T2, T3>> list(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Map<String, Object> params, Page page) {
        Limit limit = new Limit(page);
     ...
     */
    default <T1, T2, T3> List<Tuple3<T1, T2, T3>> list(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Tuple3<String, String, String> prefixes, Map<String, Object> params, Page page) {
        Limit limit = new Limit(page);
     ...
     */
    default <T1, T2, T3, T4> List<Tuple4<T1, T2, T3, T4>> list(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Class<T4> mapType4, Map<String, Object> params, int offset, int limit) {
        return list(execution, mapType1, mapType2, mapType3, mapType4, (Tuple4<String, String, String, String>) null,
            params, offset, limit);
    }
     ...
     */
    default <T1, T2, T3, T4> List<Tuple4<T1, T2, T3, T4>> list(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Class<T4> mapType4, Map<String, Object> params, Page page) {
        Limit limit = new Limit(page);
    ...
    default <T1, T2, T3, T4, T5> List<Tuple5<T1, T2, T3, T4, T5>> list(E0 execution, Class<T1> mapType1,
        Class<T2> mapType2, Class<T3> mapType3, Class<T4> mapType4, Class<T5> mapType5, Map<String, Object> params) {
     ...
     */
    <T> PaginationResults<T> pagination(E0 execution, Class<T> mapType, Map<String, Object> params, int offset,
        int limit);
     ...
     * @return           entity pagination
     */
    default <T> PaginationResults<T> pagination(E0 execution, Class<T> mapType, Map<String, Object> params, Page page) {
        Limit limit = new Limit(page);
    ...
    default <T1, T2, T3> PaginationResults<Tuple3<T1, T2, T3>> pagination(E0 execution, Class<T1> mapType1,
        Class<T2> mapType2, Class<T3> mapType3, Map<String, Object> params, int offset, int limit) {
     ...
     */
    default <T1, T2, T3> PaginationResults<Tuple3<T1, T2, T3>> pagination(E0 execution, Class<T1> mapType1,
        Class<T2> mapType2, Class<T3> mapType3, Map<String, Object> params, Page page) {
        Limit limit = new Limit(page);
    ...
    <T1, T2, T3> PaginationResults<Tuple3<T1, T2, T3>> pagination(E0 execution, Class<T1> mapType1, Class<T2> mapType2,
        Class<T3> mapType3, Tuple3<String, String, String> prefixes, Map<String, Object> params, int offset, int limit);
    ...
    default <T1, T2, T3, T4> PaginationResults<Tuple4<T1, T2, T3, T4>> pagination(E0 execution, Class<T1> mapType1,
        Class<T2> mapType2, Class<T3> mapType3, Class<T4> mapType4, Map<String, Object> params, int offset, int limit) {
     ...
     */
    default <T1, T2, T3, T4> PaginationResults<Tuple4<T1, T2, T3, T4>> pagination(E0 execution, Class<T1> mapType1,
        Class<T2> mapType2, Class<T3> mapType3, Class<T4> mapType4, Map<String, Object> params, Page page) {
        Limit limit = new Limit(page);
    ...
    default <T1, T2, T3, T4, T5, T6> PaginationResults<Tuple6<T1, T2, T3, T4, T5, T6>> pagination(E0 execution,
        Class<T1> mapType1, Class<T2> mapType2, Class<T3> mapType3, Class<T4> mapType4, Class<T5> mapType5,
        Class<T6> mapType6, Map<String, Object> params, int offset, int limit) {
    ...
    default <T1, T2, T3, T4, T5, T6> PaginationResults<Tuple6<T1, T2, T3, T4, T5, T6>> pagination(E0 execution,
        Class<T1> mapType1, Class<T2> mapType2, Class<T3> mapType3, Class<T4> mapType4, Class<T5> mapType5,
        Class<T6> mapType6, Map<String, Object> params, Page page) {
        Limit limit = new Limit(page);
