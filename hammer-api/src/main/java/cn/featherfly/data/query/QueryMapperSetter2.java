 ...
 * @author zhongj
 */
public interface QueryMapperSetter2 extends QueryMapperSetter0 {
     ...
     */
    default <T1, T2> QueryExecutor<Tuple2<T1, T2>> mapper(Class<T1> type1, Class<T2> type2) {
        return mapper(builder -> builder.mapper(type1, type2));
    }
