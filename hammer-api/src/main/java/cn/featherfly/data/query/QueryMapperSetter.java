 ...
 * @author zhongj
 */
public interface QueryMapperSetter extends QueryMapperSetter0 {
     ...
     */
    <T1, T2> QueryExecutor<Tuple2<T1, T2>> mapper(Class<T1> type1, Class<T2> type2);
     ...
     * @return the paramed mapped executor
     */
    <T1, T2, T3> QueryExecutor<Tuple3<T1, T2, T3>> mapper(Class<T1> type1, Class<T2> type2, Class<T3> type3);
     ...
     * @return the paramed mapped executor
     */
    <T1, T2, T3, T4> QueryExecutor<Tuple4<T1, T2, T3, T4>> mapper(Class<T1> type1, Class<T2> type2, Class<T3> type3,
        Class<T4> type4);
     ...
     * @return the paramed mapped executor
     */
    <T1, T2, T3, T4, T5> QueryExecutor<Tuple5<T1, T2, T3, T4, T5>> mapper(Class<T1> type1, Class<T2> type2,
     ...
     * @return the paramed mapped executor
     */
    <T1, T2, T3, T4, T5, T6> QueryExecutor<Tuple6<T1, T2, T3, T4, T5, T6>> mapper(Class<T1> type1, Class<T2> type2,
