...
/**
 * query mapper setter6.
 *
 * @author zhongj
 */
public interface QueryMapperSetter6 extends QueryMapperSetter0 {
     ...
     */
    default <T1, T2, T3, T4, T5, T6> QueryExecutor<Tuple6<T1, T2, T3, T4, T5, T6>> mapper(Class<T1> type1,
        Class<T2> type2, Class<T3> type3, Class<T4> type4, Class<T5> type5, Class<T6> type6) {
        return mapper(builder -> builder.mapper(type1, type2, type3, type4, type5, type6));
    }
